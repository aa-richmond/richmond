...
function getToolHostName(n) {
  var t = document.createElement("a");
  return (t.href = n), t.protocol + "//" + t.host;
}
function numberRandomiser(n, t, i) {
  return (
    (t += i > 0 ? Math.pow(10, -1 * i) : 1),
    (i = i > 0 ? Math.pow(10, i) : 1),
    Math.floor((Math.random() * (t - n) + n) * i) / i
  );
}
function scrollToTopPos(n, t) {
  n > LAST_SCROLL_TOP && (SHOW_NAV = !0);
  $("html, body").animate({ scrollTop: n }, t, "linear", function () {
    SHOW_NAV ||
      setTimeout(function () {
        SHOW_NAV = !0;
      }, 500);
...
function fadeGroupElement(n, t, i) {
  if (n < t.length) {
    let r = i.find("[data-fade-order='" + t[n] + "']");
    r.length
      ? (r.fadeTo(800, 1, function () {
          fadeGroupElement(n + 1, t, i);
        }),
        u(!1))
      : u(!0);
    function u(r) {
      i.data("fade-order") == t[n] &&
        i.fadeTo(800, 1, function () {
          r && fadeGroupElement(n + 1, t, i);
        });
    }
  }
}
function executeGroupFade(n) {
  const i = $(n),
    r = i.data("fade-order"),
    t = [];
  t.push(r);
  i.find("[data-fade-order]").each(function () {
    const n = $(this).data("fade-order");
    $.isNumeric(n) && t.indexOf(n) === -1 && t.push(n);
  });
  t.sort();
  fadeGroupElement(0, t, i);
}
function updateCarouselPagination(n, t) {
  n.find(".js-pagination").length &&
    (n.find(".js-pagination button.is-active").removeClass("is-active"),
    n.find(".js-pagination").each(function () {
      $(this).find("button").eq(t).addClass("is-active");
    }));
}
function cycleInfographic(n, t, i) {
  const u = n.find(".js-infographic-axis"),
    f = n.find(".js-infographic-content"),
    e = n.find(".js-infographic-item").length,
    h = 360 / e,
    o = Math.floor(e / 2);
  let r = i + 1 - (t + 1);
  r < 0 && r < 0 - o && (r += e);
  r > 0 && r > 0 + o && (r -= e);
  const c = parseInt(u.attr("data-degree")),
    s = c + h * r;
  u.attr("data-degree", s);
  u.stop();
  u.animate(
    { deg: s },
    {
      ...
      step: function (n) {
        ...
        $(this)
          .find(".js-infographic-cycle")
          .css({ transform: "rotate(" + n * -1 + "deg)" });
      },
      complete: function () {
        f.stop();
        f.animate({ opacity: 1 }, 200, "linear", function () {
          $(this)
            .find(".js-infographic-item")
            .eq(i)
            .find(".js-infographic-item-text")
            .slideDown(800);
          n.find(".js-infographic-item.is-active").removeClass("is-active");
          n.find(".js-infographic-item")
            .eq(i)
            .addClass("is-active b-infographic-item-font-big");
        });
      },
    },
  );
  ...
  f.animate(
    { opacity: 0 },
    {
      ...
      complete: function () {
        n.find(".js-infographic-item.b-infographic-item-width").removeClass(
          "b-infographic-item-width",
        );
        n.find(".js-infographic-item")
          .eq(i)
          .addClass("b-infographic-item-width");
        n.find(".js-infographic-item.b-infographic-item-font-big").removeClass(
          "b-infographic-item-font-big",
        );
        $(this).find(".js-infographic-item-text").hide();
        const e = "calc(100% + 15px)",
          t = {
            top: "auto",
        ...
        switch (i) {
          case 0:
            $(this).find(".js-infographic-item:nth-child(1)").css(t);
            $(this).find(".js-infographic-item:nth-child(2)").css(r);
            $(this).find(".js-infographic-item:nth-child(3)").css(u);
            $(this).find(".js-infographic-item:nth-child(4)").css(f);
            break;
          case 1:
            $(this).find(".js-infographic-item:nth-child(2)").css(t);
            $(this).find(".js-infographic-item:nth-child(3)").css(r);
            $(this).find(".js-infographic-item:nth-child(4)").css(u);
            $(this).find(".js-infographic-item:nth-child(1)").css(f);
            break;
          case 2:
            $(this).find(".js-infographic-item:nth-child(3)").css(t);
            $(this).find(".js-infographic-item:nth-child(4)").css(r);
            $(this).find(".js-infographic-item:nth-child(1)").css(u);
            $(this).find(".js-infographic-item:nth-child(2)").css(f);
            break;
          case 3:
            $(this).find(".js-infographic-item:nth-child(4)").css(t);
            $(this).find(".js-infographic-item:nth-child(1)").css(r);
            $(this).find(".js-infographic-item:nth-child(2)").css(u);
            $(this).find(".js-infographic-item:nth-child(3)").css(f);
            break;
          default:
            $(this).find(".js-infographic-item:nth-child(1)").css(t);
            $(this).find(".js-infographic-item:nth-child(2)").css(r);
...
function signpostCalcBottom(n) {
  const t = n.find(".js-signpost-item-content");
  let i = parseInt(t.css("padding-bottom"));
  return (
    t.find(".btn").length && t.find(".btn").outerHeight() > 0
      ? (i += parseInt(t.find(".btn").outerHeight()) + 5)
      : (i = 0),
    i * -1
  );
}
function animateSignpostIn(n) {
...
function animateSignpostOut(n) {
  n.removeClass("is-active");
  const t = n.find(".js-signpost-item-content"),
    i = signpostCalcBottom(n);
  t.stop();
  t.animate(
    { bottom: i },
    {
...
function animateFeaturedGridIn(n) {
  if ($(window).outerWidth() >= BREAKPOINT_XL) {
    n.addClass("is-active");
    const t = n.find(".b-featured-grid-item-content");
    t.stop();
    t.animate(
      { bottom: 0 },
      {
...
function animateFeaturedGridOut(n) {
  if ($(window).outerWidth() >= BREAKPOINT_XL) {
    n.removeClass("is-active");
    const t = n.find(".b-featured-grid-item-content");
    t.stop();
...
function updateActivePageNav(n) {
  const i = n.startsWith("#") ? n : "#" + n,
    t = $('.js-in-page-nav-item a[href="' + i + '"]').closest(
      ".js-in-page-nav-item",
    );
  t.siblings(".js-in-page-nav-item.is-active")
    .not(t)
    .each(function () {
      $(this).removeClass("is-active");
    });
  t.nextAll(".js-in-page-nav-item.is-previous").each(function () {
    $(this).removeClass("is-previous");
  });
  t.prevAll(".js-in-page-nav-item").each(function () {
    $(this).addClass("is-previous");
  });
  t.removeClass("is-previous").addClass("is-active");
}
function resetPageNav() {
  $(".js-in-page-nav-item").length &&
    $(".js-in-page-nav-item").each(function () {
      $(this).removeClass("is-active is-previous");
    });
}
function rotateMediaCarousel(n, t, i) {
  const u = n.find(".js-media-carousel-item"),
    f = u.length - 1,
    r = i ? (t == f ? 0 : t + 1) : t == 0 ? f : t - 1,
    e = r == f ? 0 : r + 1,
    o = r == 0 ? f : r - 1,
    h = e == f ? 0 : e + 1,
    c = o == 0 ? f : o - 1,
    l =
      "item-hidden item-inview item-center item-next item-prev item-next-two item-prev-two",
    a = u.eq(r),
    v = u.eq(e),
    y = u.eq(o),
    p = u.eq(h),
  ...
  f > 2 &&
    (p.addClass("item-inview item-next-two"),
    w.addClass("item-inview item-prev-two"));
  v.addClass("item-inview item-next");
  y.addClass("item-inview item-prev");
  a.addClass("item-inview item-center");
  mediaCarouselUpdateAriaHidden(n, r + 1);
  const s = n.find(".js-slick-media-carousel-text.slick-initialized");
  s.length && s.slick("slickGoTo", r);
  const b = (r < 9 ? "0" : "") + (r + 1);
  n.find(".js-media-carousel-current-slide").text(b);
}
function initMediaCarouselAria(n) {
  const t = n.find(".js-media-carousel-item"),
    i = t.length;
  t.each(function (n) {
    const t = "Slide " + (n + 1) + " of " + i + ".";
    $(this).attr("aria-label", t);
  });
  mediaCarouselUpdateAriaHidden(n, 1);
}
function mediaCarouselUpdateAriaHidden(n, t) {
  const r = n.find(".js-media-carousel-item"),
    i = r.length,
    u = t == i ? 1 : t + 1,
    f = t == 1 ? i : t - 1,
    o = i > 3 ? (u == i ? 1 : u + 1) : -1,
    ...
    e = [t, u, f],
    h = e.concat([o, s]);
  $(window).outerWidth(!0) < BREAKPOINT_XL
    ? r.each(function (n) {
        const t = $.inArray(n + 1, e) != -1 ? "false" : "true";
        $(this).attr("aria-hidden", t);
      })
    : r.each(function (n) {
        const t = $.inArray(n + 1, h) != -1 ? "false" : "true";
        $(this).attr("aria-hidden", t);
      });
}
function inPageNavMouseEvents() {
  let n = !1;
  $(".js-in-page-nav")
    .on("mouseenter", function () {
      if ($(this).hasClass("is-floating")) {
        const n = $(this),
          t = n.find(".js-in-page-nav-hide");
        n.stop();
        t.stop();
        n.animate(
          { width: 380 },
...
function navCleanseMob() {
  $(".mob-menu-open").length &&
    $(window).outerWidth() >= BREAKPOINT_XL &&
...
function navCleanseDesk() {
  $(".desk-menu-open").length &&
    $(window).outerWidth() < BREAKPOINT_XL &&
    ($(".js-nav *").stop(),
...
function navScroll() {
  ...
  const t = $(window).scrollTop(),
    ...
    r = n.outerHeight(),
    u = $(document).height(),
    f = Math.ceil(t) + Math.ceil($(window).height());
  SHOW_NAV &&
    (t > 0 && t > LAST_SCROLL_TOP
      ? n.hasClass("down") ||
        (n.addClass("down").removeClass("up"),
        i(r * -1),
        $(".js-nav-search-bar.is-active").length &&
          $(".js-nav-search-bar.is-active").slideUp(400, function () {
            $(this).removeClass("is-active").removeAttr("style");
          }),
        $(".js-application-steps").length &&
          $(".js-application-steps").fadeIn(400))
      : !n.hasClass("up") &&
        f < u &&
        (n.addClass("up").removeClass("down"),
        i(0),
        $(".js-application-steps").length &&
          $(".js-application-steps").fadeOut(400)),
    (LAST_SCROLL_TOP = t));
}
function navBackground() {
  if ($(".js-header").length) {
    var n = $(".js-nav").outerHeight(),
      t = $(".js-header").outerHeight(),
      i = t - n;
    $(window).scrollTop() > i
      ? $(".js-nav").addClass("is-solid")
      : $(".js-nav").removeClass("is-solid");
  }
}
function navMouseEvents() {
  ...
  function a(n) {
    const i = n.find(".js-nav-sublevel"),
      t = i.find(".js-nav-screen").first();
    n.find(".is-active").not(t).removeClass("is-active");
    t.addClass("is-active");
  }
  function s(t) {
    function e() {
      $(".js-nav").addClass("is-solid");
      $(".js-nav-top > .js-nav-item.is-active")
        .not(t)
        .each(function () {
          h($(this), !1);
        });
      t.addClass("is-active");
      n = i.fadeIn(u, "linear", function () {
        o(i.find(".b-nav-flyout-col"), 0);
        i.addClass("is-active").removeAttr("style");
        n = null;
    ...
    const i = t.find(".js-nav-flyout");
    (i.hasClass("is-active") && clearTimeout(f),
    n != null && n.stop().removeAttr("style"),
    t.hasClass("is-active")) ||
      ($(".js-nav").addClass("opening desk-menu-open"), (r = setTimeout(e, u)));
  }
  function h(t, e) {
    function s() {
      $(".js-nav").hasClass("opening") || $(".js-nav").removeClass("is-solid");
      t.removeClass("is-active");
      n = o.fadeOut(u, "linear", function () {
        i != null && o.find(i).length && i.stop().removeAttr("style");
        o.find(".b-nav-flyout-col").removeAttr("style");
        o.removeClass("is-active").removeAttr("style");
        a(o);
        n = null;
        !$(".js-nav").hasClass("opening") &&
          $(".js-nav").hasClass("desk-menu-open") &&
          $(".js-nav").removeClass("desk-menu-open");
      });
    }
    const o = t.find(".js-nav-flyout");
    (r != null && o.hasClass("is-active") == !1 && clearTimeout(r),
    n != null && n.stop().removeAttr("style"),
    t.hasClass("is-active")) && (e ? (f = setTimeout(s, l)) : s());
  }
  function c(n) {
    const r = n.closest(".js-nav-flyout").find(".js-nav-sublevel");
    if (
      (t != null && t.stop().removeAttr("style").removeClass("is-active"),
      n.siblings(".js-nav-item").removeClass("is-active"),
      !n.hasClass("has-subnav"))
    ) {
      const n = r.find(".js-nav-screen").first();
      if (n.hasClass("is-active")) return;
      r.find(".js-nav-screen.is-active").not(n).removeClass("is-active");
      t = r
        .find(".js-nav-screen")
        .first()
        .fadeIn(e, function () {
          $(this).addClass("is-active").removeAttr("style");
          t = null;
        });
      return;
    }
    n.addClass("is-active");
    const u = n.data("nav"),
      i = '.js-nav-screen[data-nav-screen="' + u + '"]';
  ...
  const l = 500,
    u = 0,
    e = 0;
  $("body").on("touchstart", function (n) {
    $(n.target).closest(".js-nav-top > .js-nav-item").length == 0 &&
      $(".js-nav-top > .js-nav-item.is-active").length &&
      $(".js-nav-top > .js-nav-item.is-active").each(function () {
        $(this).mouseleave();
      });
  });
  $(".js-nav").on(
    "touchstart",
    ".js-nav-top > .js-nav-item.has-subnav",
    function (n) {
      if (!$(".js-nav").hasClass("mob-menu-open")) {
        const t = $(this);
        t.hasClass("is-active") || (n.preventDefault(), s(t));
      }
    },
  );
  $("body")
    .on(
      "mouseenter",
      ".js-nav:not(.mob-menu-open) .js-nav-top > .js-nav-item.has-subnav",
      function () {
        const n = $(this);
        s(n);
      },
  ...
  $(".js-nav").on("touchstart", ".js-nav-flyout .js-nav-item", function (n) {
    if (!$(".js-nav").hasClass("mob-menu-open")) {
      const t = $(this);
      !t.hasClass("is-active") &&
        t.hasClass("has-subnav") &&
        (n.preventDefault(), c(t));
    }
  });
  $("body").on(
    "mouseenter",
    ".js-nav:not(.mob-menu-open) .js-nav-flyout .js-nav-item",
    function () {
      const n = $(this);
      c(n);
    },
...
function initPyramidCarousel(n) {
  function i(n, i, u) {
    const s = t.length - 1;
    let o = 0;
    o = i ? n : u ? (n < s ? n + 1 : 0) : n > 0 ? n - 1 : s;
    const f = t.eq(o),
      e = r.eq(o),
      c = parseInt(f.position().top) + parseInt(f.outerHeight() / 2),
      l = parseInt(e.outerHeight()),
      h = c - l / 2;
    e.css("top", h);
    r.not(e).removeClass("is-active");
    e.fadeIn(function () {
      $(this).removeAttr("style").addClass("is-active").css("top", h);
    });
    t.not(f).removeClass("is-active");
    f.addClass("is-active");
  }
  const u = n.find(".js-pyramid-carousel-next"),
    f = n.find(".js-pyramid-carousel-prev"),
    r = n.find(".js-pyramid-info"),
    t = $(".js-pyramid-item");
  u.on("click", function (n) {
    n.preventDefault();
    const t = $(".js-pyramid-item.is-active").length
      ? $(".js-pyramid-item.is-active").index()
      : 0;
    i(t, !1, !0);
  });
  ...
  n.find(".js-pyramid-item").on("click", function (n) {
    n.preventDefault();
    const t = $(this).index();
    i(t, !0);
  });
  n.find(".js-pyramid-close").on("click", function (n) {
    n.preventDefault();
    const i = $(this).closest(".js-pyramid-info");
    t.removeClass("is-active");
    i.fadeOut(function () {
...
function closeSelect(n) {
  n.find(".js-select-selected").removeClass("is-active");
  n.find(".js-select-dropdown").slideUp(400, function () {
    n.removeClass("is-active");
  });
}
function updateSelectValue(n) {
  const i = [],
    t = [],
    r = n.find(".js-select-selected");
  n.find(".js-select-option.is-active").length
    ? n.find(".js-select-option.is-active").each(function () {
        i.push($(this).data("select-value"));
        t.push($(this).text().trim());
      })
    : t.push(r.data("select-label"));
  const u = i.join(","),
    f = t.join(", ");
  r.find(".js-select-selected-label").text(f);
  n.find('input[type="hidden"]').val(u);
}
function divisionsToggle(n) {
  function e() {
    f.not(t).each(function () {
      const n = $(this);
      n.index() != 0 &&
        (n.find(".js-divisions-item-toggle").removeClass("is-active"),
        n.find(".js-divisions-item-content").slideUp(i, function () {
          n.removeClass("is-active");
          $(this).removeAttr("style");
        }));
    });
    n.toggleClass("is-active");
    u.slideToggle(i, function () {
      t.toggleClass("is-active");
      $(this).removeAttr("style");
    });
  }
  function o() {
    const e = n.hasClass("is-active");
    f.not(t).each(function () {
      const n = $(this);
      n.index() > 0 &&
        n.find(".js-divisions-item-toggle").removeClass("is-active");
      n.find(".js-divisions-item-content").fadeToggle(i, function () {
        n.removeClass("is-active");
        $(this).removeAttr("style");
      });
    });
    n.toggleClass("is-active");
    u.fadeToggle(i, function () {
      if ((t.toggleClass("is-active"), $(this).removeAttr("style"), e)) {
        const n = r.find(".js-divisions-item").eq(0);
        n.addClass("is-active");
        n.find(".js-divisions-item-content").fadeIn(i, function () {
          $(this).removeAttr("style");
        });
      }
    });
  }
  const r = n.closest(".js-divisions"),
    t = n.closest(".js-divisions-item"),
    u = t.find(".js-divisions-item-content"),
    f = r.find(".js-divisions-item.is-active"),
    i = 400;
  $(window).outerWidth() >= BREAKPOINT_MD ? o() : e();
}
function cycleFramework(n, t) {
  const i = n.find(".js-framework-item[data-framework-index='" + t + "']"),
    r = n.find(".js-framework-item.is-active");
  r.not(i).each(function () {
    $(this).removeClass("is-active");
  });
  i.fadeIn(400, function () {
    i.removeAttr("style").addClass("is-active");
    const n = (t < 9 ? "0" : "") + (t + 1);
    $(".js-framework-current-slide").text(n);
  });
}
function valueEngineClickEvents(n) {
  function a() {
    s.not(t).each(function () {
      const n = $(this);
      n.find(".js-value-engine-accordion-btn").removeClass(i);
      n.find(".js-value-engine-content").slideUp(o, function () {
        $(this).removeAttr("style");
        n.removeClass("is-active");
      });
    });
    e.toggleClass(i);
    f.slideToggle(o, function () {
      $(this).removeAttr("style");
      t.toggleClass("is-active");
    });
  }
  function v() {
    t.hasClass("is-active") ||
      (r
        .find(".js-value-engine-item.is-active")
        .not(t)
        .each(function () {
          $(this).removeClass("is-active");
          const n = "." + i;
          $(this).find(n).removeClass(i);
        }),
      t.addClass("is-active"),
      e.addClass(i));
  }
  const u = n.closest(".js-value-engine"),
    t = n.closest(".js-value-engine-item"),
    s = u.find(".js-value-engine-item.is-active"),
    f = t.find(".js-value-engine-content"),
    e = n.find(".js-value-engine-accordion-btn"),
    i = "e-control-accordion-close",
    o = 400,
    r = n.closest(".js-value-engine-section"),
    h = r.hasClass("is-active"),
    c = u.find(".js-value-engine-section"),
    l = f.html();
  $(window).outerWidth() >= BREAKPOINT_MD ? v() : a();
  h ||
    (c.not(r).each(function () {
      $(this).removeClass("is-active").addClass("is-hidden");
      $(this).find(".js-value-engine-item.is-active").removeClass("is-active");
    }),
    r.addClass("is-active"));
  r.find(".js-value-engine-reveal-content").html(l);
}
function radials(n) {
  function y(n, r, u) {
    const e = n * numberRandomiser(-0.05, 0.05, 2),
      h = f(e, i),
      c = f(n, i),
      l = f(r, i),
      o = t ? "px" : "%",
      ...
      v = (t ? r : l) + o;
    return (
      '<span class="m-radial m-radial-random" data-size="' +
      n +
      '" data-screen="' +
      i +
      '" data-margin-top="' +
  ...
  function p() {
    let t = 0.7,
      n = 1.5;
    const i = Math.floor(h / (r * n) / 7);
    return (
      (t = i > 0 ? t * i : t),
      (n = i > 0 ? n * i : n),
      numberRandomiser(t, n, 1)
    );
  }
  function f(n, t) {
    const i = r / t;
  ...
  const t = !1,
    i = $(window).outerWidth(),
    w = Math.floor(i * 0.45),
    o = $(".js-radial-random-container"),
    h = o.height(),
    r = Math.min(i, w),
    c = Math.floor(r / 2.5);
  if (
    (n &&
      ((!RADIALS_ARE_DESKTOP_SIZE && t) || (RADIALS_ARE_DESKTOP_SIZE && !t)) &&
      ((RADIALS_ARE_DESKTOP_SIZE = t),
      $(".m-radial-random").each(function () {
        const u = $(this).data("size"),
          n = $(this).data("screen"),
          e = $(this).data("margin-top"),
          i = $(this).data("left"),
          c = $(this).data("right"),
          o = $.isNumeric(i) ? i : c,
          r = t ? "px" : "%",
          ...
          l = (t ? e : f(e, n)) + r,
          h = (t ? o : f(o, n)) + r;
        $(this).css({ width: s, "padding-bottom": s, "margin-top": l });
        $.isNumeric(i) ? $(this).css("left", h) : $(this).css("right", h);
      })),
    !n)
  ) {
    RADIALS_ARE_DESKTOP_SIZE = t;
    ...
    const u = [],
      e = [];
    while (l < h) {
      const n = numberRandomiser(c, r, 0),
        i = Math.floor(n * p());
      u.push(n);
      u.push(i);
      const t = numberRandomiser(c, r, 0),
        f = Math.floor(t * p());
      e.push(t);
      e.push(f);
      l += Math.max(n + i, t + f);
    }
    let a = u[0] * numberRandomiser(0, 0.4, 1),
      v = e[0] * numberRandomiser(0, 0.4, 1);
...
function notches() {
  function n(n, t) {
    let i = "m-notch";
    i += t ? " m-notch-light" : "";
    const r = numberRandomiser(1, 3, 0);
    switch (r) {
      case 2:
        i += " m-notch-right";
        break;
    ...
    const u = '<div class="' + i + '"><span><\/span><\/div>';
    $(n).before(u);
  }
  $(
    ".m-spacing:not(.m-light):not(.m-spacing-light-bottom) + .m-spacing.m-light",
  ).each(function () {
    n($(this), !0);
  });
  $(
    ".m-spacing.m-light + .m-spacing:not(.m-light), .m-spacing.m-spacing-light-bottom + .m-spacing:not(.m-light)",
  ).each(function () {
    n($(this), !1);
  });
}
function adjustBoxHeights(n) {
  var t = n.find(".b-case-study-item-box"),
    i = 0,
    r = 0,
    u;
  t.css("min-height", "0");
  ...
  u = t.first().innerHeight() - t.first().height();
  t.css("min-height", i + u + "px");
  $(window).width() < 768 && t.css("margin-top", "-10%");
  $(window).width() >= 768 && t.css("margin-top", "-17%");
  $(window).width() >= 1200 && t.css("margin-top", "-" + i + "px");
}
function getQSValue(n) {
  n = n.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
  var i = "[\\?&]" + n + "=([^&#]*)",
    r = new RegExp(i),
...
function ajaxSearch(n, t) {
  var o, i, u, f, r, s, e;
  lastActionWasSearchFilter = !0;
  ajaxSearchProgress
    ? ajaxSearchProgress.abort()
    : ((o = $(".js-search .js-search-result-item").length),
      (i = $(".js-search-search").serialize()),
      (i = "loaded=" + o + "&" + i + "&appendItems=" + n),
      (u = ""),
      (f = ""),
      $(".js-search-result-filters .is-active").length &&
        ((u = $(".js-search-result-filters .is-active").data("type")),
        (f = $(".js-search-result-filters .is-active").data("slug")),
        (i += "&contentType=" + u)),
      (r = "?"),
      getQSFromString("query", i).trim() != "" &&
        (r += "query=" + getQSFromString("query", i).trim() + "&"),
      f != "" && (r += "type=" + f + "&"),
      (r = r.substring(0, r.length - 1)),
      (s = window.location.pathname + window.location.search),
      (e = window.location.pathname + r),
      s != e && t && window.history.pushState("", "", e),
      n == !1 &&
        $.ajax({
          type: "GET",
          url: "/umbraco/surface/search/getsearchresultsfilterstotals",
          cache: !1,
          context: this,
          traditional: !0,
          data: { query: getQSFromString("query", i).trim(), contentType: u },
          async: !1,
          success: function (n) {
            $(".js-search .js-search-result-filters").html(n);
          },
          error: function () {},
          complete: function () {},
        }),
      (ajaxSearchProgress = $.ajax({
        ...
        success: function (t) {
          n
            ? $(".js-search .js-search-result-list").append(t)
            : ($(".js-search .js-search-result-list").html(t),
              t && t.trim() != ""
                ? $(".js-search-result-no-items").hide()
                : $(".js-search-result-no-items").show());
          var i = $(
              ".js-search .js-search-result-list .js-search-result-item",
            ).length,
            t = $(".js-search-search").serialize();
          t =
            "loaded=" + i + "&" + t + "&contentType=" + u + "&appendItems=true";
          $.get("/umbraco/surface/search/getsearchresults?" + t, function (n) {
            n && n.trim() != ""
              ? $(".js-search .js-search-result-load").show()
              : $(".js-search .js-search-result-load").hide();
          });
        },
        error: function () {},
        complete: function () {
          ajaxSearchProgress = null;
        },
      })));
}
function ajaxSearchAutocomplete() {
  if (((lastActionWasSearchFilter = !1), ajaxSearchAutocompleteProgress))
    ajaxSearchAutocompleteProgress.abort();
  else {
    var n = new RegExp("(" + $(".js-search-input").val() + ")", "i");
    ajaxSearchAutocompleteProgress = $.ajax({
      url: "/umbraco/surface/search/getsearchresultsforautocomplete",
      cache: !0,
      context: this,
      traditional: !0,
      async: !1,
      success: function (t) {
        $(".js-search-input").each(function () {
          ...
          $(this)
            .autocomplete({
              appendTo: $this.closest(".js-search").find(".js-search-options"),
              source: t,
              minLength: 2,
              select: function () {
                $this.closest(".js-search").find(".js-search-form").submit();
              },
              response: function (t, i) {
                i.content.splice(5, i.content.length - 5);
                n = new RegExp("(" + $this.val() + ")", "i");
              },
            })
            ...
            return $("<li>")
              .append(
                '<a href="' +
                  i.url +
                  '">' +
                  i.value.replace(n, "<strong>$1<\/strong>") +
                  "<\/a>",
              )
              .appendTo(t);
          };
      ...
      error: function () {},
      complete: function () {
        ajaxSearchAutocompleteProgress = null;
      },
    });
  }
}
function filterSearchBasedOnUrl() {
  var t = ".js-search-filter-type > li[data-slug='" + getQSValue("type") + "']",
    i = 0,
    n;
  $(t).length && (i = $(t).index());
  n = $(".js-search-filter-type > li").eq(i);
  $(n).length &&
    !$(n).hasClass("is-active") &&
    ($(n).siblings().removeClass("is-active"), $(n).addClass("is-active"));
  ajaxSearch(!1, !1);
}
function ajaxFiltersInit(n, t) {
  function r(r, u, f) {
    var s, e, h, o;
    i
      ? i.abort()
      : ((s = n.find(".js-filters-content-item").length),
        (e = "?"),
        f == !1
          ? (n.find(".js-filters-filter").each(function () {
              $(this).find(".js-filters-filter-item.is-active").length &&
                ((e += $(this).data("value") + "="),
                $(this)
                  .find(".js-filters-filter-item.is-active")
                  .each(function () {
                    e += $(this).data("value") + "|";
                  }),
                (e = e.substring(0, e.length - 1) + "&"));
              $(this).find(".js-filters-filter-field").length &&
                $(this).find(".js-filters-filter-field").val() != "" &&
                ((e +=
                  $(this).data("value") +
                  "=" +
                  $(this).find(".js-filters-filter-field").val()),
            ...
            (o = window.location.pathname + e),
            h != o && u && window.history.pushState("", "", o))
          : ((e = window.location.search),
            n.find(".js-filters-filter").each(function () {
              var t = $(this),
                ...
                n;
              t.hasClass("e-select") &&
                (t.find(".js-filters-filter-item").each(function () {
                  $(this).removeClass("is-active");
                }),
                (i = getQSValue(t.data("value"))),
                (n = ""),
                i.length > 0 &&
                  i.split("|").forEach(function (i) {
                    var r = t.find(
                        '.js-filters-filter-item[data-value="' + i + '"]',
                      ),
                      u;
                    r.addClass("is-active");
                    u = r.text().trim();
                ...
                (n =
                  n.length > 0
                    ? n
                    : t.find(".js-select-selected").data("select-label")),
                t.find(".js-select-selected-label").text(n));
              t.hasClass("e-keyword") &&
                ((i = getQSValue(t.data("value"))),
                (n = i.length > 0 ? i : ""),
                t.find(".js-filters-filter-field").val(n));
            })),
        (i = $.ajax({
          type: "GET",
          url: t,
          ...
          context: this,
          traditional: !0,
          data: { querystring: e, appendItems: r, loaded: s },
          success: function (i) {
            if (
              (r
                ? n.find(".js-filters-content").append(i)
                : (n.find(".js-filters-content").html(i),
                  i && i.trim() != ""
                    ? n.find(".js-filters-noresults").hide()
                    : (n.find(".js-filters-loadmore").hide(),
                      n.find(".js-filters-noresults").show())),
              !n.find(".js-filters-noresults").is(":visible"))
            ) {
              var u = n.find(".js-filters-content-item").length,
                i =
                  "querystring=" +
                  encodeURIComponent(e) +
                  "&appendItems=true&loaded=" +
                  u;
              $.get(t + "?" + i, function (t) {
                n.find(".js-filters-loadmore").data("text") &&
                  n
                    .find(".js-filters-loadmore button")
                    .text(n.find(".js-filters-loadmore").data("text"));
                t && t.trim() != ""
                  ? n.find(".js-filters-loadmore").show()
                  : n.find(".js-filters-loadmore").hide();
              });
            }
          },
  ...
  var i = null;
  n.find(".js-filters-apply").on("click", function (n) {
    n.preventDefault();
    r(!1, !0, !1);
  });
  n.find(".js-filters-filter-field").on("keydown", function (n) {
    n.keyCode == 13 && (n.preventDefault(), r(!1, !0, !1));
  });
  n.find(".js-filters-loadmore").on("click", function (n) {
    n.preventDefault();
    $(this).data("text") && $(this).find("button").text("...");
    r(!0, !1, !1);
  });
...
function accessibilityFixes() {
  $("#CookiebotSessionPixel").attr("alt", "");
}
var __iframe, ajaxSearchProgress, ajaxSearchAutocompleteProgress;
!(function (n, t) {
  "use strict";
  ...
  function k(n) {
    return n.replace(ke, "ms-").replace(de, ge);
  }
  function ni() {
  ...
  function vu(n, t, i) {
    ...
    if (void 0 === i && 1 === n.nodeType)
      if (
        ((u = "data-" + t.replace(to, "-$&").toLowerCase()),
      ...
      (r =
        "undefined" != typeof n.getElementsByTagName
          ...
          : "undefined" != typeof n.querySelectorAll
            ...
            : []),
      void 0 === t || (t && s(n, t)) ? i.merge([n], r) : r
    );
  }
  function nr(n, t) {
  ...
  function du(n, t, r, u, f) {
    for (
      ...
      if ((e = n[h]) || 0 === e)
        if ("object" === et(e)) i.merge(y, e.nodeType ? [e] : e);
          ...
          for (
            o = o || s.appendChild(t.createElement("div")),
              p = (wu.exec(e) || ["", ""])[1].toLowerCase(),
              c = v[p] || v._default,
              o.innerHTML = c[1] + i.htmlPrefilter(e) + c[2],
              a = c[0];
            a--;
    ...
    for (s.textContent = "", h = 0; (e = y[h++]); )
      if (u && -1 < i.inArray(e, u)) f && f.push(e);
        ...
        ((w = ct(e)), (o = l(s.appendChild(e), "script")), w && nr(o), r)
      )
          ...
          handler: function (n) {
            ...
            if (1 & n.isTrigger && this[t]) {
              if (u)
                ...
                return n.stopImmediatePropagation(), n.preventDefault(), f;
            } else
              u &&
                (r.set(this, t, i.event.trigger(u[0], u.slice(1), this)),
                n.stopPropagation(),
                (n.isImmediatePropagationStopped = at));
          },
        }))
  ...
  function yt(n, t, u, o) {
    ...
    var a,
      ...
      w = t[0],
      k = e(w);
    if (k || (1 < p && "string" == typeof w && !f.checkClone && uo.test(w)))
    ...
    if (
      p &&
      ((b = (a = du(t, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === a.childNodes.length && (a = b),
      b || o)
    ) {
      for (v = (c = i.map(l(a, "script"), eo)).length; h < p; h++)
        (s = a),
          h !== d &&
            ((s = i.clone(s, !0, !0)), v && i.merge(c, l(s, "script"))),
          u.call(n[h], s, h);
      if (v)
        for (y = c[c.length - 1].ownerDocument, i.map(c, oo), h = 0; h < v; h++)
          (s = c[h]),
            bu.test(s.type || "") &&
              ...
              (s.src && "module" !== (s.type || "").toLowerCase()
                ...
                : nu(s.textContent.replace(fo, ""), s, y));
    }
    return n;
  }
  function tf(n, t, r) {
    for (var u, e = t ? i.filter(t, n) : n, f = 0; null != (u = e[f]); f++)
      r || 1 !== u.nodeType || i.cleanData(l(u)),
        u.parentNode &&
          (r && ct(u) && nr(l(u, "script")), u.parentNode.removeChild(u));
    return n;
  }
  function ui(n, t, r) {
    var o,
    ...
    return (
      (r = r || yi(n)) &&
        ...
        c && u && (u = u.replace(gt, "$1") || void 0),
        "" !== u || ct(n) || (u = i.style(n, t)),
        !f.pixelBoxStyles() &&
          rr.test(u) &&
          so.test(t) &&
          ((o = e.width),
    ...
    return (
      ...
      (n in ef
        ...
        : (sf[n] =
            (function (n) {
              for (
                var i = n[0].toUpperCase() + n.slice(1), t = ff.length;
                t--;
  ...
  function er(n, t, r, u, f, e) {
    ...
    for (; o < 4; o += 2)
      "margin" === r && (c += i.css(n, r + nt[o], !0, f)),
        u
          ? ("content" === r && (s -= i.css(n, "padding" + nt[o], !0, f)),
            "margin" !== r &&
              (s -= i.css(n, "border" + nt[o] + "Width", !0, f)))
          : ((s += i.css(n, "padding" + nt[o], !0, f)),
            "padding" !== r
              ? (s += i.css(n, "border" + nt[o] + "Width", !0, f))
              : (h += i.css(n, "border" + nt[o] + "Width", !0, f)));
    return (
      !u &&
        0 <= e &&
        (s +=
  ...
  function lf(n, t, r) {
    var e = yi(n),
      o =
        ...
        "border-box" === i.css(n, "boxSizing", !1, e),
      h = o,
      u = ui(n, t, e),
    ...
    return (
      ((!f.boxSizingReliable() && o) ||
        (!f.reliableTrDimensions() && s(n, "tr")) ||
        "auto" === u ||
        (!parseFloat(u) && "inline" === i.css(n, "display", !1, e))) &&
        n.getClientRects().length &&
        ((o = "border-box" === i.css(n, "boxSizing", !1, e)),
        (h = c in n) && (u = n[c])),
      (u = parseFloat(u) || 0) +
        er(n, t, r || (o ? "border" : "content"), h, e, u) +
        "px"
    );
  }
  ...
  function or() {
    pi &&
      (!1 === u.hidden && n.requestAnimationFrame
        ? n.requestAnimationFrame(or)
        : n.setTimeout(or, i.fx.interval),
      i.fx.tick());
  }
  function pf() {
    return (
  ...
  function w(n, t, r) {
    ...
    for (
      ...
      if ((o = w.prefilters[h].call(u, n, c, u.opts)))
        return (
          e(o.stop) &&
            (i._queueHooks(u.elem, u.opts.queue).stop = o.stop.bind(o)),
          o
        );
    return (
      i.map(c, wf, u),
      e(u.opts.start) && u.opts.start.call(n, u),
      u
  ...
  function ar(n, t, r, u) {
    ...
    else for (f in t) ar(n + "[" + f + "]", t[f], r, u);
  }
  function ue(n) {
    return function (t, i) {
  ...
  i.extend({
    ...
    isPlainObject: function (n) {
      var t, i;
      return (
        !(!n || "[object Object]" !== dr.call(n)) &&
        (!(t = br(n)) ||
          ("function" ==
            typeof (i = dt.call(t, "constructor") && t.constructor) &&
            gr.call(i) === le))
      );
    },
    ...
    isXMLDoc: function (n) {
      ...
      return !ve.test(i || (t && t.nodeName) || "HTML");
    },
    merge: function (n, t) {
  ...
  !(function () {
    function r(n, t, o, s) {
      ...
      if (
        ((o = o || []),
        "string" != typeof n || !n || (1 !== p && 9 !== p && 11 !== p))
      )
        return o;
      if (!s && (nt(t), (t = t || u), l)) {
        if (11 !== p && (k = ir.exec(n)))
          if ((h = k[1])) {
            ...
            if ((h = k[3]) && t.getElementsByClassName)
              return v.apply(o, t.getElementsByClassName(h)), o;
          }
        if (!(ht[n + " "] || (c && c.test(n)))) {
          if (((g = n), (w = t), 1 === p && (ki.test(n) || li.test(n)))) {
            for (
              ((w = (bt.test(n) && kt(t.parentNode)) || t) == t && f.scope) ||
                ((y = t.getAttribute("id"))
                  ? (y = i.escapeSelector(y))
                  : t.setAttribute("id", (y = e))),
                b = (d = et(n)).length;
              b--;

            )
              d[b] = (y ? "#" + y : ":scope") + " " + at(d[b]);
            g = d.join(",");
          }
          try {
          ...
          ? t.parentNode && !1 === t.disabled
            ? "label" in t
              ? "label" in t.parentNode
                ...
                : t.disabled === n
              : t.isDisabled === n || (t.isDisabled !== !n && ur(t) === n)
            : t.disabled === n
    ...
    function nt(n) {
      var s,
        h = n ? n.ownerDocument || n : b;
      return (
        h != u &&
          9 === h.nodeType &&
          h.documentElement &&
          ((p = (u = h).documentElement),
          (l = !i.isXMLDoc(u)),
          (pt = p.matches || p.webkitMatchesSelector || p.msMatchesSelector),
          p.msMatchesSelector &&
            b != u &&
            (s = u.defaultView) &&
            s.top !== s &&
            s.addEventListener("unload", rr),
          (f.getById = ut(function (n) {
            return (
              (p.appendChild(n).id = i.expando),
              !u.getElementsByName || !u.getElementsByName(i.expando).length
            );
          })),
              ...
              (1 &
                (i =
                  (n.ownerDocument || n) == (t.ownerDocument || t)
                    ...
                    : 1) ||
              (!f.sortDetached && t.compareDocumentPosition(n) === i)
                ? n === u || (n.ownerDocument == b && r.contains(b, n))
                  ? -1
                  : t === u || (t.ownerDocument == b && r.contains(b, t))
                    ? 1
                    : ft
                      ? d.call(ft, n) - d.call(ft, t)
                      : 0
                : 4 & i
                  ? -1
                  : 1)
    ...
    function et(n, i) {
      ...
      for (u = n, h = [], c = t.preFilter; u; ) {
        for (o in ((e && !(f = bi.exec(u))) ||
          (f && (u = u.slice(f[0].length) || u), h.push((s = []))),
        (e = !1),
        (f = li.exec(u)) &&
          ((e = f.shift()),
          s.push({ value: e, type: f[0].replace(gt, " ") }),
          (u = u.slice(e.length))),
        t.filter))
          (f = ct[o].exec(u)) &&
            (!c[o] || (f = c[o](f))) &&
    ...
    function ti(n, t, i, u, f, o) {
      return (
        ...
        y(function (e, o, s, h) {
          ...
          if (
            (i ? i(p, (c = f || (e ? n : k || u) ? [] : o), s, h) : (c = p), u)
          )
            for (a = yt(c, w), u(a, [], s, h), l = a.length; l--; )
              (y = a[l]) && (c[w[l]] = !(p[w[l]] = y));
          if (e) {
            if (f || n) {
              if (f) {
              ...
              for (l = c.length; l--; )
                (y = c[l]) &&
                  -1 < (a = f ? d.call(e, y) : b[l]) &&
                  (e[a] = !(o[a] = y));
            }
          } else
            (c = yt(c === o ? c.splice(k, c.length) : c)),
              f ? f(null, o, c, h) : v.apply(o, c);
        })
      );
    }
    function ii(n) {
    ...
    function ri(n, r) {
      var s,
        ...
        f = ei[n + " "];
      if (!f) {
        for (r || (r = et(n)), s = r.length; s--; )
          (f = ii(r[s]))[e] ? b.push(f) : k.push(f);
        (f = ei(
          n,
          ((h = k),
          (o = 0 < (c = b).length),
          ...
          (p = function (n, r, f, e, s) {
            var y,
              ...
              it = ot,
              rt = n || (a && t.find.TAG("*", s)),
              ut = (w += null == it ? 1 : Math.random() || 0.1),
              ft = rt.length;
            for (
              s && (ot = r == u || r || s);
              p !== ft && null != (y = rt[p]);
              ...
              if (a && y) {
                for (
                  g = 0, r || y.ownerDocument == u || (nt(y), (f = !l));
                  (k = h[g++]);
            ...
            if (((d += p), o && p !== d)) {
              ...
              if (n) {
                if (0 < d) while (p--) tt[p] || b[p] || (b[p] = ye.call(e));
                b = yt(b);
              }
              v.apply(e, b);
    ...
    function yi(n, i, r, u) {
      ...
      if (((r = r || []), 1 === s.length)) {
        if (
          ...
          if (!(i = (t.find.ID(e.matches[0].replace(k, g), i) || [])[0]))
            return r;
          h && (i = i.parentNode);
        ...
        for (o = ct.needsContext.test(n) ? 0 : f.length; o--; ) {
          ...
          if (
            (a = t.find[c]) &&
            (u = a(
              e.matches[0].replace(k, g),
              (bt.test(f[0].type) && kt(i.parentNode)) || i,
            ))
          ) {
            if ((f.splice(o, 1), !(n = u.length && at(f))))
              return v.apply(r, u), r;
            break;
          }
        }
      }
    ...
    (i.uniqueSort = function (n) {
      ...
      if (
        ((st = !f.sortStable),
        (ft = !f.sortStable && a.call(n, 0)),
        pe.call(n, wt),
        st)
      ) {
        while ((r = n[i++])) r === n[i] && (t = u.push(i));
        while (t--) we.call(n, u[t], 1);
      }
      return (ft = null), n;
    }),
    ...
    ((t = i.expr =
      {
            ...
            return 1 === r && 0 === u
              ...
              : function (t, i, c) {
                  var p,
                    ...
                    v,
                    b,
                    k = h !== o ? "nextSibling" : "previousSibling",
                    y = t.parentNode,
              ...
              : 1 < u.length
                ? ((f = [n, n, "", i]),
                  t.setFilters.hasOwnProperty(n.toLowerCase())
                    ? y(function (n, t) {
                        for (var e, r = u(n, i), f = r.length; f--; )
                          n[(e = d.call(n, r[f]))] = !(t[e] = r[f]);
                      })
                    : function (n) {
                        return u(n, 0, f);
                      })
        ...
        pseudos: {
          ...
          lang: y(function (n) {
            return (
              gi.test(n || "") || r.error("unsupported lang: " + n),
              (n = n.replace(k, g).toLowerCase()),
              function (t) {
                var i;
                do
                  if (
          ...
          checked: function (n) {
            return (
              (s(n, "input") && !!n.checked) || (s(n, "option") && !!n.selected)
            );
          },
          selected: function (n) {
            return (
  ...
  i.fn.extend({
    ...
    is: function (n) {
      return !!di(this, "string" == typeof n && uu.test(n) ? i(n) : n || [], !1)
        .length;
    },
  });
  ou = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    if (((r = r || eu), "string" == typeof n)) {
      ...
      if (f[1]) {
        if (
          ...
          fu.test(f[1]) && i.isPlainObject(t))
        )
          for (f in t) e(this[f]) ? this[f](t[f]) : this.attr(f, t[f]);
        return this;
      }
      return (
        (o = u.getElementById(f[2])) && ((this[0] = o), (this.length = 1)), this
      );
    }
    return n.nodeType
  ...
  i.each(
    {
      ...
      contents: function (n) {
        return null != n.contentDocument && br(n.contentDocument)
          ? n.contentDocument
          : (s(n, "template") && (n = n.content || n),
    ...
    function (n, t) {
      i.fn[n] = function (r, u) {
        ...
        return (
          ...
          1 < this.length &&
            (hu[n] || i.uniqueSort(f), su.test(n) && f.reverse()),
          this.pushStack(f)
        );
      };
    },
    ...
    var o,
      ...
      c = {
        add: function () {
          return (
            t &&
              (r && !o && ((f = t.length - 1), s.push(r)),
              (function u(r) {
                i.each(r, function (i, r) {
                  e(r)
                    ? (n.unique && c.has(r)) || t.push(r)
                    : r && r.length && "string" !== et(r) && u(r);
                });
              })(arguments),
              r && !o && v()),
            this
  ...
  i.extend({
              ...
              return function () {
                var h = this,
                  ...
                  a = function () {
                    ...
                    if (!(t < o)) {
                      ...
                      e(i)
                        ? f
                          ? i.call(n, s(o, r, st, f), s(o, r, hi, f))
                          : (o++,
                            i.call(
                              n,
                              s(o, r, st, f),
                              s(o, r, hi, f),
                              s(o, r, st, r.notifyWith),
                            ))
                        : (u !== st && ((h = void 0), (c = [n])),
                          (f || r.resolveWith)(h, c));
                    }
                    ...
                    : function () {
                        try {
                          ...
                          i.Deferred.exceptionHook &&
                            i.Deferred.exceptionHook(a, l.error);
                          o <= t + 1 &&
                            (u !== hi && ((h = void 0), (c = [a])),
                            r.rejectWith(h, c));
                        }
                ...
                t
                  ...
                  : (i.Deferred.getErrorHook
                      ? (l.error = i.Deferred.getErrorHook())
                      : i.Deferred.getStackHook &&
                        (l.error = i.Deferred.getStackHook()),
                    n.setTimeout(l));
              };
            }
            var o = 0;
    ...
    when: function (n) {
      ...
      if (
        f <= 1 &&
        (lu(n, r.done(s(t)).resolve, r.reject, !f),
        "pending" === r.state() || e(u[t] && u[t].then))
      )
        return r.then();
  ...
  ("loading" !== u.readyState && !u.documentElement.doScroll)
    ...
    : (u.addEventListener("DOMContentLoaded", li),
      n.addEventListener("load", li));
  ...
  ni.prototype = {
    ...
    set: function (n, t, i) {
      ...
      else for (r in t) u[k(r)] = t[r];
      return u;
    },
    get: function (n, t) {
      return void 0 === t
        ? this.cache(n)
        : n[this.expando] && n[this.expando][k(t)];
    },
  ...
  i.fn.extend({
    data: function (n, t) {
      ...
      if (void 0 === n) {
        if (
          this.length &&
          ((e = c.get(i)), 1 === i.nodeType && !r.get(i, "hasDataAttrs"))
        ) {
          for (f = o.length; f--; )
            o[f] &&
              0 === (u = o[f].name).indexOf("data-") &&
              ((u = k(u.slice(5))), vu(i, u, e[u]));
  ...
  tt.getRootNode &&
    (ct = function (n) {
      return (
        i.contains(n.ownerDocument, n) || n.getRootNode(io) === n.ownerDocument
      );
    });
  ii = function (n, t) {
    return (
      "none" === (n = t || n).style.display ||
      ("" === n.style.display && ct(n) && "none" === i.css(n, "display"))
    );
  };
  gi = {};
  i.fn.extend({
  ...
  v.th = v.td;
  f.option ||
    (v.optgroup = v.option = [1, "<select multiple='multiple'>", "<\/select>"]);
  ku = /<|&#?\w+;/;
  tr = /^([^.]*)(?:\.(.+)|)/;
  i.event = {
    global: {},
        ...
        for (
          ...
          (o = d = (k = tr.exec(t[w]) || [])[1]),
            ...
            o &&
              ...
              (c = a[o]) ||
                (((c = a[o] = []).delegateCount = 0),
                (s.setup && !1 !== s.setup.call(n, f, b, l)) ||
                  (n.addEventListener && n.addEventListener(o, l))),
              s.add &&
    ...
    special: {
      ...
      click: {
        setup: function (n) {
          var t = this || n;
          return (
            ri.test(t.type) && t.click && s(t, "input") && vi(t, "click", !0),
            !1
          );
        },
        trigger: function (n) {
  ...
  i.each({ focus: "focusin", blur: "focusout" }, function (n, t) {
    ...
    i.event.special[n] = {
      ...
      teardown: function () {
        ...
        (n = r.get(this, t) - 1)
          ? r.set(this, t, n)
          : (this.removeEventListener(t, f), r.remove(this, t));
      },
      _default: function (t) {
  ...
  i.extend({
    ...
    clone: function (n, t, r) {
      ...
      if (
        ...
        for (e = l(s), u = 0, h = (o = l(n)).length; u < h; u++)
          (c = o[u]),
            (a = e[u]),
            void 0,
            "input" === (v = a.nodeName.toLowerCase()) && ri.test(c.type)
              ? (a.checked = c.checked)
              : ("input" !== v && "textarea" !== v) ||
                (a.defaultValue = c.defaultValue);
      if (t)
        if (r)
          for (o = o || l(n), e = e || l(s), u = 0, h = o.length; u < h; u++)
            nf(o[u], e[u]);
        else nf(n, s);
  ...
  i.fn.extend({
    ...
    empty: function () {
      for (var n, t = 0; null != (n = this[t]); t++)
        1 === n.nodeType && (i.cleanData(l(n, !1)), (n.textContent = ""));
      return this;
    },
    clone: function (n, t) {
      return (
      ...
      return g(
        ...
        function (n) {
          ...
          if (
            "string" == typeof n &&
            !ro.test(n) &&
            !v[(wu.exec(n) || ["", ""])[1].toLowerCase()]
          ) {
            n = i.htmlPrefilter(n);
            try {
              for (; r < u; r++)
                1 === (t = this[r] || {}).nodeType &&
                  (i.cleanData(l(t, !1)), (t.innerHTML = n));
              t = 0;
            } catch (n) {}
          }
    ...
    replaceWith: function () {
      ...
      return yt(
        ...
        function (t) {
          ...
          i.inArray(this, n) < 0 &&
            (i.cleanData(l(this)), r && r.replaceChild(t, this));
        },
        n,
      );
    },
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == o &&
              ...
              (o =
                parseInt(f.height, 10) +
                  parseInt(f.borderTopWidth, 10) +
                  parseInt(f.borderBottomWidth, 10) ===
                t.offsetHeight),
              tt.removeChild(i)),
            o
          );
  ...
  var ff = ["Webkit", "Moz", "ms"],
    ...
    sf = {};
  var ho = /^(none|table(?!-c[ea]).+)/,
    co = { position: "absolute", visibility: "hidden", display: "block" },
    hf = { letterSpacing: "0", fontWeight: "400" };
  i.extend({
    cssHooks: {
      opacity: {
        get: function (n, t) {
    ...
    style: function (n, t, r, u) {
      if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
        var e,
          ...
          s = n.style;
        if (
          (l || (t = fr(c)), (o = i.cssHooks[t] || i.cssHooks[c]), void 0 === r)
        )
          return o && "get" in o && void 0 !== (e = o.get(n, !1, u)) ? e : s[t];
        "string" == (h = typeof r) &&
          (e = ti.exec(r)) &&
          e[1] &&
          ((r = pu(n, t, e)), (h = "number"));
  ...
  i.each(["height", "width"], function (n, t) {
    i.cssHooks[t] = {
      get: function (n, r, u) {
        if (r)
          return !ho.test(i.css(n, "display")) ||
  ...
  i.cssHooks.marginLeft = uf(f.reliableMarginLeft, function (n, t) {
    if (t)
      return (
        (parseFloat(ui(n, "marginLeft")) ||
          n.getBoundingClientRect().left -
            rf(n, { marginLeft: 0 }, function () {
    ...
    i.cssHooks[n + t] = {
      expand: function (i) {
        for (
          ...
          f[n + nt[r] + t] = u[r] || u[r - 2] || u[0];
        return f;
      },
    };
    "margin" !== n && (i.cssHooks[n + t].set = cf);
  });
  i.fn.extend({
    css: function (n, t) {
      return g(
    ...
    _default: {
      ...
      set: function (n) {
        i.fx.step[n.prop]
          ? i.fx.step[n.prop](n)
          : 1 !== n.elem.nodeType ||
              (!i.cssHooks[n.prop] && null == n.elem.style[fr(n.prop)])
            ? (n.elem[n.prop] = n.now)
        ...
        if ((h = !i.isEmptyObject(t)) || !i.isEmptyObject(p))
          ...
          p))
            h ||
              ...
              a && lt([n], !0),
              v.done(function () {
                for (f in (a || lt([n]), r.remove(n, "fxshow"), p))
                  i.style(n, f, p[f]);
              })),
              (h = wf(a ? e[f] : 0, f, v)),
              f in e ||
    ...
    stop: function (n, t, u) {
      ...
      return (
        ...
        this.each(function () {
          ...
          else for (t in e) e[t] && e[t].stop && yf.test(t) && f(e[t]);
          for (t = o.length; t--; )
            o[t].elem !== this ||
              (null != n && o[t].queue !== n) ||
  ...
  af = u.createElement("select").appendChild(u.createElement("option"));
  wt.type = "checkbox";
  f.checkOn = "" !== wt.value;
  f.optSelected = af.selected;
        ...
        return "undefined" == typeof n.getAttribute
          ...
          : ((1 === e && i.isXMLDoc(n)) ||
              (u =
                ...
                (i.expr.match.bool.test(t) ? bf : void 0)),
            void 0 !== r
              ? null === r
  ...
  kf = /^(?:input|select|textarea|button)$/i;
  df = /^(?:a|area)$/i;
  i.fn.extend({
    prop: function (n, t) {
    ...
    addClass: function (n) {
      ...
      return e(n)
        ...
        : (u = sr(n)).length
          ? this.each(function () {
              if (
                ((f = ut(this)), (t = 1 === this.nodeType && " " + rt(f) + " "))
              ) {
                for (r = 0; r < u.length; r++)
                  (o = u[r]), t.indexOf(" " + o + " ") < 0 && (t += o + " ");
                s = rt(t);
        ...
        : arguments.length
          ? (u = sr(n)).length
            ? this.each(function () {
                if (
                  ((f = ut(this)),
                  (t = 1 === this.nodeType && " " + rt(f) + " "))
                ) {
                  for (r = 0; r < u.length; r++)
                    for (o = u[r]; -1 < t.indexOf(" " + o + " "); )
                      t = t.replace(" " + o + " ", " ");
                  s = rt(t);
                  f !== s && this.setAttribute("class", s);
                }
      ...
      return e(n)
        ...
        : "boolean" == typeof t && c
          ...
          : ((s = sr(n)),
            this.each(function () {
              if (c)
                for (o = i(this), f = 0; f < s.length; f++)
                  (u = s[f]), o.hasClass(u) ? o.removeClass(u) : o.addClass(u);
              else
                (void 0 !== n && "boolean" !== h) ||
                  ((u = ut(this)) && r.set(this, "__className__", u),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      u || !1 === n ? "" : r.get(this, "__className__") || "",
                    ));
            }));
    },
    hasClass: function (n) {
      for (var t, r = 0, i = " " + n + " "; (t = this[r++]); )
        if (1 === t.nodeType && -1 < (" " + rt(ut(t)) + " ").indexOf(i))
          return !0;
      return !1;
    },
  });
      ...
      return arguments.length
        ? ((f = e(n)),
          this.each(function (r) {
            var u;
            1 === this.nodeType &&
              (null == (u = f ? n.call(this, r, i(this).val()) : n)
                ? (u = "")
                : "number" == typeof u
                  ? (u += "")
                  : Array.isArray(u) &&
        ...
        : u
          ? (t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]) &&
            "get" in t &&
            void 0 !== (r = t.get(u, "value"))
            ? r
            : "string" == typeof (r = u.value)
              ? r.replace(gf, "")
              : null == r
                ? ""
                : r
    ...
    trigger: function (t, f, o, s) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          ...
          (a = i.event.special[h] || {}),
          s || !a.trigger || !1 !== a.trigger.apply(o, f)))
      ) {
        if (!s && !a.noBubble && !ft(o)) {
          for (
            d = a.delegateType || h, cr.test(d + h) || (c = c.parentNode);
            c;
            c = c.parentNode
          )
            w.push(c), (l = c);
        ...
        for (k = 0; (c = w[k++]) && !t.isPropagationStopped(); )
          (p = c),
            ...
            (y =
              ...
              r.get(c, "handle")) && y.apply(c, f),
            (y = v && c[v]) &&
              y.apply &&
              ht(c) &&
              ((t.result = y.apply(c, f)),
              !1 === t.result && t.preventDefault());
        return (
          (t.type = h),
          s ||
            t.isDefaultPrevented() ||
            (a._default && !1 !== a._default.apply(w.pop(), f)) ||
            !ht(o) ||
            (v &&
              e(o[h]) &&
              !ft(o) &&
              ((l = o[v]) && (o[v] = null),
              (i.event.triggered = h),
              t.isPropagationStopped() && p.addEventListener(h, lr),
              o[h](),
              t.isPropagationStopped() && p.removeEventListener(h, lr),
      ...
      return this.map(function () {
        ...
        .filter(function () {
          ...
          return (
            this.name &&
            !i(this).is(":disabled") &&
            vo.test(this.nodeName) &&
            !ao.test(n) &&
            (this.checked || !ri.test(n))
          );
        })
        .map(function (n, t) {
          var r = i(this).val();
  ...
  return (
      ...
      ajax: function (t, r) {
        function b(t, r, u, c) {
          ...
          s ||
            ...
            !y &&
              -1 < i.inArray("script", f.dataTypes) &&
              i.inArray("json", f.dataTypes) < 0 &&
            ...
            y
              ? (f.ifModified &&
                ...
                204 === t || "HEAD" === f.type
                  ...
                  : 304 === t
                    ? (a = "notmodified")
                    : ((a = p.state), (rt = p.data), (y = !(b = p.error))))
              : ((b = a), (!t && a) || ((a = "error"), t < 0 && (t = 0))),
            (e.status = t),
            (e.statusText = (r || a) + ""),
            y ? tt.resolveWith(h, [rt, a, e]) : tt.rejectWith(h, [e, a, b]),
            e.statusCode(w),
            (w = void 0),
            v &&
              nt.trigger(y ? "ajaxSuccess" : "ajaxError", [e, f, y ? rt : b]),
            it.fireWith(h, [e, a]),
            v &&
        ...
        if (
          ...
          try {
            ...
            c.href = c.href;
            f.crossDomain =
              yr.protocol + "//" + yr.host != c.protocol + "//" + c.host;
          } catch (t) {
            f.crossDomain = !0;
          }
        }
        if (
          ...
          return e;
        for (g in ((v = i.event && f.global) &&
          0 == i.active++ &&
          i.event.trigger("ajaxStart"),
        (f.type = f.type.toUpperCase()),
        (f.hasContent = !ko.test(f.type)),
        (o = f.url.replace(po, "")),
        f.hasContent
          ? f.data &&
            f.processData &&
            ...
            (f.data = f.data.replace(yo, "+"))
          : ((p = f.url.slice(o.length)),
            f.data &&
              (f.processData || "string" == typeof f.data) &&
              ((o += (hr.test(o) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((o = o.replace(wo, "$1")),
              (p = (hr.test(o) ? "&" : "?") + "_=" + ne.guid++ + p)),
            (f.url = o + p)),
        f.ifModified &&
          (i.lastModified[o] &&
            e.setRequestHeader("If-Modified-Since", i.lastModified[o]),
          i.etag[o] && e.setRequestHeader("If-None-Match", i.etag[o])),
        ((f.data && f.hasContent && !1 !== f.contentType) || r.contentType) &&
        ...
        if (f.beforeSend && (!1 === f.beforeSend.call(h, e, f) || s))
          return e.abort();
        if (
          ((ft = "abort"),
          it.add(f.complete),
    ...
    i.ajaxSetup({
      ...
      jsonpCallback: function () {
        var n = wr.pop() || i.expando + "_" + ne.guid++;
        return (this[n] = !0), n;
      },
    }),
    i.ajaxPrefilter("json jsonp", function (t, r, u) {
      ...
      if (h || "jsonp" === t.dataTypes[0])
        return (
          ...
          h
            ? (t[h] = t[h].replace(bi, "$1" + f))
            : !1 !== t.jsonp &&
              (t.url += (hr.test(t.url) ? "&" : "?") + t.jsonp + "=" + f),
    ...
    (f.createHTMLDocument =
      (((oe = u.implementation.createHTMLDocument("").body).innerHTML =
        "<form><\/form><form><\/form>"),
      ...
      return "string" != typeof n
        ...
        : ("boolean" == typeof t && ((r = t), (t = !1)),
          t ||
            (f.createHTMLDocument
              ? (((s = (t =
                  u.implementation.createHTMLDocument("")).createElement(
                  "base",
    ...
    (i.fn.load = function (n, t, r) {
      var u,
        ...
        o = n.indexOf(" ");
      return (
        -1 < o && ((u = rt(n.slice(o))), (n = n.slice(0, o))),
        e(t)
          ? ((r = t), (t = void 0))
        ...
        i.fn[n] = function (i) {
          return g(
            ...
            function (n, i, u) {
              var f;
              if (
                (ft(n) ? (f = n) : 9 === n.nodeType && (f = n.defaultView),
                void 0 === u)
              )
                return f ? f[t] : n[i];
              f
    ...
    i.each(["top", "left"], function (n, t) {
      i.cssHooks[t] = uf(f.pixelPosition, function (n, r) {
        if (r)
          return (r = ui(n, t)), rr.test(r) ? i(n).position()[t] + "px" : r;
      });
    }),
    ...
    (se = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g),
    (i.proxy = function (n, t) {
      var r, u, f;
      if (("string" == typeof t && ((r = n[t]), (t = n), (n = r)), e(n)))
        return (
    ...
    (i.noConflict = function (t) {
      return n.$ === i && (n.$ = ce), t && n.jQuery === i && (n.jQuery = he), i;
    }),
...
!(function (n, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(t)
      : ((n =
          "undefined" != typeof globalThis ? globalThis : n || self).bootstrap =
          t());
})(this, function () {
  "use strict";
  function oe(n, t) {
    return (t && `${t}::${fe++}`) || n.uidEvent || fe++;
  }
  function se(n) {
    const t = oe(n);
    return (n.uidEvent = t), (iu[t] = iu[t] || {}), iu[t];
  }
  function he(n, t, i = null) {
  ...
  function ce(n, t, i) {
    const u = "string" == typeof t,
      f = u ? i : t || i;
    let r = ae(n);
    return cc.has(r) || (r = n), [u, f, r];
  }
  function le(t, i, r, u, f) {
    if ("string" == typeof i && t) {
      ...
      const l = se(t),
        a = l[h] || (l[h] = {}),
        c = he(a, e, s ? r : null);
      if (c) return void (c.oneOff = c.oneOff && f);
      const v = oe(e, i.replace(oc, "")),
        o = s
          ? (function (t, i, r) {
              return function u(f) {
                const e = t.querySelectorAll(i);
                for (let { target: o } = f; o && o !== this; o = o.parentNode)
                  for (const s of e)
                    if (s === o)
                      return (
                        uu(f, { delegateTarget: o }),
                        u.oneOff && n.off(t, f.type, i, r),
                        r.apply(o, [f])
                      );
              };
            })(t, r, e)
          : (function (t, i) {
              return function r(u) {
                return (
                  uu(u, { delegateTarget: t }),
                  r.oneOff && n.off(t, u.type, i),
                  i.apply(t, [u])
                );
              };
            })(t, e);
      o.delegationSelector = s ? r : null;
      o.callable = e;
      o.oneOff = f;
      o.uidEvent = v;
      a[v] = o;
  ...
  function ru(n, t, i, r, u) {
    const f = he(t[i], r, u);
    f && (n.removeEventListener(i, f, Boolean(u)), delete t[i][f.uidEvent]);
  }
  function lc(n, t, i, r) {
    const u = t[i] || {};
    for (const [e, f] of Object.entries(u))
      e.includes(r) && ru(n, t, i, f.callable, f.delegationSelector);
  }
  function ae(n) {
    return (n = n.replace(sc, "")), ee[n] || n;
  }
  function uu(n, t = {}) {
  ...
  function ot(n) {
    return n instanceof o(n).Element || n instanceof Element;
  }
  function c(n) {
    return n instanceof o(n).HTMLElement || n instanceof HTMLElement;
  }
  function yu(n) {
    return (
      "undefined" != typeof ShadowRoot &&
      (n instanceof o(n).ShadowRoot || n instanceof ShadowRoot)
    );
  }
  function y(n) {
    return n.split("-")[0];
  ...
  function ti(n, t, i) {
    ...
    t &&
      c(n) &&
      ((f = (n.offsetWidth > 0 && ni(r.width) / n.offsetWidth) || 1),
      (e = (n.offsetHeight > 0 && ni(r.height) / n.offsetHeight) || 1));
    var u = (ot(n) ? o(n) : window).visualViewport,
      l = !lo() && i,
      s = (r.left + (l && u ? u.offsetLeft : 0)) / f,
      h = (r.top + (l && u ? u.offsetTop : 0)) / e,
      a = r.width / f,
      v = r.height / e;
    return {
      width: a,
  ...
  function bu(n) {
    ...
    return (
      ...
      { x: n.offsetLeft, y: n.offsetTop, width: i, height: r }
    );
  }
  function ao(n, t) {
  ...
  function k(n) {
    return o(n).getComputedStyle(n);
  }
  function dl(n) {
    return ["table", "td", "th"].indexOf(v(n)) >= 0;
  }
  function rt(n) {
    return ((ot(n) ? n.ownerDocument : n.document) || window.document)
      .documentElement;
  }
  function sr(n) {
    return "html" === v(n)
      ? n
      : n.assignedSlot || n.parentNode || (yu(n) ? n.host : null) || rt(n);
  }
  function vo(n) {
    return c(n) && "fixed" !== k(n).position ? n.offsetParent : null;
  }
  function pi(n) {
    for (var i = o(n), t = vo(n); t && dl(t) && "static" === k(t).position; )
      t = vo(t);
    return t &&
      ("html" === v(t) || ("body" === v(t) && "static" === k(t).position))
      ? i
      : t ||
          (function (n) {
            var r = /firefox/i.test(wu()),
              t,
              i;
            if (/Trident/i.test(wu()) && c(n) && "fixed" === k(n).position)
              return null;
            for (
              t = sr(n), yu(t) && (t = t.host);
              c(t) && ["html", "body"].indexOf(v(t)) < 0;
  ...
  function ko(n) {
    var l,
      ...
      st = v.y,
      u = void 0 === st ? 0 : st,
      ht = "function" == typeof w ? w({ x: t, y: u }) : { x: t, y: u },
      y,
      g,
      nt;
    t = ht.x;
    u = ht.y;
    var ct = v.hasOwnProperty("x"),
      lt = v.hasOwnProperty("y"),
      b = r,
      d = i,
      s = window;
    if (ft) {
      var c = pi(a),
        ...
        vt = "clientWidth";
      c === o(a) &&
        "static" !== k((c = rt(a))).position &&
        "absolute" === ut &&
        ((at = "scrollHeight"), (vt = "scrollWidth"));
      (h === i || ((h === r || h === e) && it === dt)) &&
        ((d = f),
        (u -=
          (et && c === s && s.visualViewport
      ...
      (h !== r && ((h !== i && h !== f) || it !== dt)) ||
        ((b = e),
        (t -=
          (et && c === s && s.visualViewport ? s.visualViewport.width : c[vt]) -
          tt.width),
        (t *= p ? 1 : -1));
    }
    return (
      (g = Object.assign({ position: ut }, ft && bo)),
      (nt =
        !0 === w
          ? (function (n, t) {
              var r = n.x,
              ...
              return { x: ni(r * i) / i || 0, y: ni(u * i) / i || 0 };
            })({ x: t, y: u }, o(a))
          : { x: t, y: u }),
      (t = nt.x),
      (u = nt.y),
  ...
  function tf(n) {
    return ti(rt(n)).left + nf(n).scrollLeft;
  }
  function rf(n) {
    var t = k(n),
      i = t.overflow,
  ...
  function is(n) {
    return ["html", "body", "#document"].indexOf(v(n)) >= 0
  ...
  function ki(n, t) {
    ...
    var i = is(n),
      ...
      f = o(i),
      e = u ? [f].concat(f.visualViewport || [], rf(i) ? i : []) : i,
      s = t.concat(e);
    return u ? s : s.concat(ki(sr(e)));
  }
  function uf(n) {
          ...
          (function (n, t) {
            ...
            return (
              i &&
                ...
                (r = lo()),
                (r || (!r && "fixed" === t)) &&
                  ((s = i.offsetLeft), (h = i.offsetTop))),
              { width: f, height: e, x: s + tf(n), y: h }
            );
          })(n, i),
        )
      : ot(t)
        ? (function (n, t) {
            var i = ti(n, !1, "fixed" === t);
            return (
        ...
        : uf(
            (function (n) {
              ...
              return (
                "rtl" === k(t || i).direction &&
                  (e += st(i.clientWidth, t ? t.clientWidth : 0) - f),
                { width: f, height: o, x: e, y: s }
              );
            })(rt(n)),
          );
  }
  function us(n) {
    var u,
      ...
      v = t.y + t.height / 2 - s.height / 2,
      o,
      h;
    switch (l) {
      case i:
        u = { x: a, y: t.y - s.height };
        break;
      case f:
  ...
  function ri(n, t) {
    ...
    var r = t,
      p = r.placement,
      w = void 0 === p ? n.placement : p,
      b = r.strategy,
      ct = void 0 === b ? n.strategy : b,
      d = r.boundary,
      lt = void 0 === d ? ge : d,
      g = r.rootBoundary,
      at = void 0 === g ? lu : g,
      ...
      it = r.padding,
      l = void 0 === it ? 0 : it,
      o = yo("number" != typeof l ? l : po(l, kt)),
      yt = u === gt ? no : gt,
      ut = n.rects.popper,
      a = n.elements[vt ? yt : u],
      s = (function (n, t, i, r) {
        var e =
            "clippingParents" === t
              ? (function (n) {
                  var i = ki(sr(n)),
                    t =
                      ["absolute", "fixed"].indexOf(k(n).position) >= 0 && c(n)
                        ? pi(n)
                        : n;
                  return ot(t)
                    ? i.filter(function (n) {
                        return ot(n) && ao(n, t) && "body" !== v(n);
                      })
                    : [];
                })(n)
              : [].concat(t),
          ...
          u = f.reduce(
            function (t, i) {
              var u = rs(n, i, r);
              return (
                (t.top = st(u.top, t.top)),
                (t.right = or(u.right, t.right)),
                (t.bottom = or(u.bottom, t.bottom)),
                (t.left = st(u.left, t.left)),
                t
              );
            },
            rs(n, o, r),
      ...
      })(ot(a) ? a : a.contextElement || rt(n.elements.popper), lt, at, ct),
      ft = ti(n.elements.reference),
      pt = us({
        reference: ft,
        element: ut,
        strategy: "absolute",
      ...
      wt = uf(Object.assign({}, ut, pt)),
      h = u === gt ? wt : ft,
      y = {
        top: s.top - h.top + o.top,
        bottom: h.bottom - s.bottom + o.bottom,
        left: s.left - h.left + o.left,
        right: h.right - s.right + o.right,
      },
      et = n.modifiersData.offset;
    return (
      u === gt &&
        et &&
        ((ht = et[w]),
        Object.keys(y).forEach(function (n) {
          var t = [e, f].indexOf(n) >= 0 ? 1 : -1,
            r = [i, f].indexOf(n) >= 0 ? "y" : "x";
          y[n] += ht[r] * t;
        })),
      y
    );
  ...
  function os(n) {
    return [i, e, f, r].some(function (t) {
      return n[t] >= 0;
    });
  }
  function na(n, t, i) {
      ...
      a =
        ...
        (function (n) {
          var t = n.getBoundingClientRect(),
            i = ni(t.width) / n.offsetWidth || 1,
            r = ni(t.height) / n.offsetHeight || 1;
          return 1 !== i || 1 !== r;
        })(t),
      e = rt(t),
      f = ti(n, a, i),
    ...
    return (
      (l || (!l && !i)) &&
        (("body" !== v(t) || rf(e)) &&
          (s =
            (r = t) !== o(r) && c(r)
              ? { scrollLeft: (h = r).scrollLeft, scrollTop: h.scrollTop }
              : nf(r)),
        c(t)
          ? (((u = ti(t, !0)).x += t.clientLeft), (u.y += t.clientTop))
          : e && (u.x = tf(e))),
      {
    ...
    return function (n, i, r) {
      ...
      var c,
        ...
        u = {
          placement: "bottom",
          orderedModifiers: [],
          options: Object.assign({}, ef, t),
          modifiersData: {},
          elements: { reference: n, popper: i },
          attributes: {},
          styles: {},
        },
        s = [],
        ...
        e = {
          ...
          setOptions: function (r) {
            var a = "function" == typeof r ? r(u.options) : r,
              h,
              o,
              c;
            return (
              l(),
              (u.options = Object.assign({}, t, u.options, a)),
              (u.scrollParents = {
                reference: ot(n)
                  ? ki(n)
                  : n.contextElement
              ...
              (c = (function (n) {
                ...
                ((h = [].concat(f, u.options.modifiers)),
                (o = h.reduce(function (n, t) {
                  var i = n[t.name];
                  return (
                    (n[t.name] = i
                      ? Object.assign({}, i, t, {
              ...
              (u.orderedModifiers = c.filter(function (n) {
                return n.enabled;
              })),
              u.orderedModifiers.forEach(function (n) {
                var f = n.name,
                  ...
                  r;
                "function" == typeof i &&
                  ((r = i({ state: u, name: f, instance: e, options: o })),
                  s.push(r || function () {}));
              }),
              e.update()
            );
          ...
          forceUpdate: function () {
            ...
            if (!h) {
              ...
              if (ls(f, t))
                for (
                  u.rects = {
                    reference: na(f, pi(t), "fixed" === u.options.strategy),
                    popper: bu(t),
                  },
                    u.reset = !1,
                  ...
                  if (!0 !== u.reset) {
                    ...
                    "function" == typeof o &&
                      (u =
                        o({ state: u, options: c, name: l, instance: e }) || u);
                  } else (u.reset = !1), (n = -1);
            }
          },
          update:
      ...
      return ls(n, i)
        ? (e.setOptions(r).then(function (n) {
  ...
  const g = new Map(),
    dr = {
      ...
      get: (n, t) => (g.has(n) && g.get(n).get(t)) || null,
      remove(n, t) {
        if (g.has(n)) {
          const i = g.get(n);
          i.delete(t);
    ...
    ne = (n) => (
      n &&
        window.CSS &&
        window.CSS.escape &&
        (n = n.replace(/#([^\s"#']+)/g, (n, t) => `#${CSS.escape(t)}`)),
      n
    ),
    te = (n) => {
      n.dispatchEvent(new Event(gr));
    },
    w = (n) =>
      !(!n || "object" != typeof n) &&
    ...
    nt = (n) =>
      w(n)
        ...
        : "string" == typeof n && n.length > 0
          ? document.querySelector(ne(n))
          : null,
    vt = (n) => {
      if (!w(n) || 0 === n.getClientRects().length) return !1;
      const i =
    ...
    u = (n, t = [], i = n) => ("function" == typeof n ? n(...t) : i),
    ue = (n, t, i = !0) => {
      if (!i) return void u(n);
      const e =
        ((n) => {
          if (!n) return 0;
      ...
      let r = !1;
      const f = ({ target: i }) => {
        i === t && ((r = !0), t.removeEventListener(gr, f), u(n));
      };
      t.addEventListener(gr, f);
      setTimeout(() => {
        r || te(t);
      }, e);
    },
  ...
  const n = {
    ...
    off(n, t, i, r) {
      if ("string" == typeof t && n) {
        const [s, e, f] = ce(t, i, r),
          h = f !== t,
          u = se(n),
          o = u[f] || {},
          c = t.startsWith(".");
        if (void 0 === e) {
          if (c) for (const i of Object.keys(u)) lc(n, u, i, t.slice(1));
          for (const [r, i] of Object.entries(o)) {
            const e = r.replace(hc, "");
            (h && !t.includes(e)) ||
              ru(n, u, f, i.callable, i.delegationSelector);
          }
        } else {
    ...
    trigger(n, t, i) {
      ...
      t !== ae(t) &&
        ...
        ((r = f.Event(t, i)),
        f(n).trigger(r),
        (e = !r.isPropagationStopped()),
        (o = !r.isImmediatePropagationStopped()),
        (s = r.isDefaultPrevented()));
      const u = uu(new Event(t, { bubbles: e, cancelable: !0 }), i);
      return (
        s && u.preventDefault(),
        o && n.dispatchEvent(u),
  ...
  const b = {
    setDataAttribute(n, t, i) {
      n.setAttribute(`data-bs-${fu(t)}`, i);
    },
    removeDataAttribute(n, t) {
      n.removeAttribute(`data-bs-${fu(t)}`);
    },
    getDataAttributes(n) {
      if (!n) return {};
      const t = {},
    ...
    getDataAttribute: (n, t) => ve(n.getAttribute(`data-bs-${fu(t)}`)),
  };
  class ci {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(n, t) {
      const i = w(t) ? b.getDataAttribute(t, "config") : {};
      return {
        ...this.constructor.Default,
        ...("object" == typeof i ? i : {}),
        ...(w(t) ? b.getDataAttributes(t) : {}),
        ...("object" == typeof n ? n : {}),
      };
    }
    _typeCheckConfig(n, t = this.constructor.DefaultType) {
          ...
          f = w(t)
            ...
            : null == (i = t)
              ...
              : Object.prototype.toString
                  ...
                  .match(/\s([a-z]+)/i)[1]
                  .toLowerCase();
        if (!new RegExp(u).test(f))
          throw new TypeError(
            `${this.constructor.NAME.toUpperCase()}: Option "${r}" provided type "${f}" but expected type "${u}".`,
          );
      }
      var i;
    }
  ...
  class a extends ci {
    ...
    static getInstance(n) {
      return dr.get(nt(n), this.DATA_KEY);
    }
    static getOrCreateInstance(n, t = {}) {
      return (
        this.getInstance(n) || new this(n, "object" == typeof t ? t : null)
      );
    }
    static get VERSION() {
      return "5.3.2";
  ...
  const eu = (n) => {
    ...
    t = {
      ...
      children: (n, t) => [].concat(...n.children).filter((n) => n.matches(t)),
      parents(n, t) {
        const r = [];
      ...
      focusableChildren(n) {
        const t = [
          ...
          .join(",");
        return this.find(t, n).filter((n) => !tt(n) && vt(n));
      },
      getSelectorFromElement(n) {
        const i = eu(n);
        return i && t.findOne(i) ? i : null;
      },
      getElementFromSelector(n) {
        const i = eu(n);
        return i ? t.findOne(i) : null;
      },
    ...
    nr = (i, r = "hide") => {
      const f = `click.dismiss${i.EVENT_KEY}`,
        u = i.NAME;
      n.on(document, f, `[data-bs-dismiss="${u}"]`, function (n) {
        if (
          (["A", "AREA"].includes(this.tagName) && n.preventDefault(),
          !tt(this))
        ) {
          const f = t.getElementFromSelector(this) || this.closest(`.${u}`);
          i.getOrCreateInstance(f)[r]();
        }
      });
    },
    ye = ".bs.alert",
  ...
  class tr extends a {
    ...
    close() {
      if (!n.trigger(this._element, ac).defaultPrevented) {
    ...
    _destroyElement() {
      ...
      n.trigger(this._element, vc);
      this.dispose();
    }
    static jQueryInterface(n) {
      return this.each(function () {
        const t = tr.getOrCreateInstance(this);
        if ("string" == typeof n) {
          if (void 0 === t[n] || n.startsWith("_") || "constructor" === n)
  ...
  n.on(document, "click.bs.button.data-api", pe, (n) => {
    n.preventDefault();
    const t = n.target.closest(pe);
    ir.getOrCreateInstance(t).toggle();
  });
  h(ir);
  const yt = ".bs.swipe",
    yc = `touchstart${yt}`,
  ...
  class ou extends ci {
    ...
    _handleSwipe() {
      ...
      if (!(n <= 40)) {
        const t = n / this._deltaX;
        this._deltaX = 0;
        t && u(t > 0 ? this._config.rightCallback : this._config.leftCallback);
      }
    }
    _initEvents() {
      this._supportPointerEvents
        ? (n.on(this._element, bc, (n) => this._start(n)),
          n.on(this._element, kc, (n) => this._end(n)),
          this._element.classList.add("pointer-event"))
        : (n.on(this._element, yc, (n) => this._start(n)),
          n.on(this._element, pc, (n) => this._move(n)),
          n.on(this._element, wc, (n) => this._end(n)));
    }
  ...
  class ai extends a {
    ...
    pause() {
      this._isSliding && te(this._element);
      this._clearInterval();
    }
    cycle() {
      this._clearInterval();
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? n.one(this._element, su, () => this.cycle())
          : this.cycle());
    }
    to(t) {
      ...
      if (!(t > i.length - 1) && !(t < 0)) {
        if (this._isSliding)
          return void n.one(this._element, su, () => this.to(t));
    ...
    _addEventListeners() {
      this._config.keyboard && n.on(this._element, tl, (n) => this._keydown(n));
      "hover" === this._config.pause &&
        (n.on(this._element, il, () => this.pause()),
        n.on(this._element, rl, () => this._maybeEnableCycle()));
      this._config.touch && ou.isSupported() && this._addTouchEventListeners();
    }
    _addTouchEventListeners() {
      for (const i of t.find(".carousel-item img", this._element))
        n.on(i, ul, (n) => n.preventDefault());
      const i = {
      ...
      this._swipeHelper = new ou(this._element, i);
    }
    _keydown(n) {
      if (!/input|textarea/i.test(n.target.tagName)) {
        const t = sl[n.key];
        t && (n.preventDefault(), this._slide(this._directionToOrder(t)));
      }
    }
    _getItemIndex(n) {
    ...
    _setActiveIndicatorElement(n) {
      if (this._indicatorsElement) {
        const r = t.findOne(ke, this._indicatorsElement);
        r.classList.remove(ur);
        r.removeAttribute("aria-current");
        const i = t.findOne(
          `[data-bs-slide-to="${n}"]`,
          this._indicatorsElement,
        );
        i && (i.classList.add(ur), i.setAttribute("aria-current", "true"));
      }
    }
    _updateInterval() {
      const n = this._activeElement || this._getActive();
      if (n) {
        const t = Number.parseInt(n.getAttribute("data-bs-interval"), 10);
    ...
    _slide(t, i = null) {
      if (!this._isSliding) {
        const u = this._getActive(),
          e = t === li,
          r = i || tu(this._getItems(), u, e, this._config.wrap);
        if (r !== u) {
          const s = this._getItemIndex(r),
            h = (i) =>
              n.trigger(this._element, i, {
                relatedTarget: r,
                direction: this._orderToDirection(t),
                from: this._getItemIndex(u),
                to: s,
              });
          if (!h(nl).defaultPrevented && u && r) {
            const c = Boolean(this._interval);
            this.pause();
            this._isSliding = !0;
            this._setActiveIndicatorElement(s);
            this._activeElement = r;
            const f = e ? "carousel-item-start" : "carousel-item-end",
              o = e ? "carousel-item-next" : "carousel-item-prev";
            r.classList.add(o);
            hi(r);
            u.classList.add(f);
            r.classList.add(f);
            this._queueCallback(
              () => {
                r.classList.remove(f, o),
                  r.classList.add(ur),
                  u.classList.remove(ur, o, f),
                  (this._isSliding = !1),
                  h(su);
              },
              u,
    ...
    _getActive() {
      return t.findOne(ol, this._element);
    }
    _getItems() {
      return t.find(de, this._element);
    }
    _clearInterval() {
      this._interval &&
    ...
    _directionToOrder(n) {
      return s() ? (n === wt ? pt : li) : n === wt ? li : pt;
    }
    _orderToDirection(n) {
      return s() ? (n === pt ? wt : rr) : n === pt ? rr : wt;
    }
    static jQueryInterface(n) {
      return this.each(function () {
        const t = ai.getOrCreateInstance(this, n);
        if ("number" != typeof n) {
          if ("string" == typeof n) {
            if (void 0 === t[n] || n.startsWith("_") || "constructor" === n)
              throw new TypeError(`No method named "${n}"`);
  ...
  n.on(document, el, "[data-bs-slide], [data-bs-slide-to]", function (n) {
    const r = t.getElementFromSelector(this);
    if (r && r.classList.contains(be)) {
      n.preventDefault();
      const i = ai.getOrCreateInstance(r),
        u = this.getAttribute("data-bs-slide-to");
      return u
        ? (i.to(u), void i._maybeEnableCycle())
  ...
  n.on(window, fl, () => {
    const n = t.find('[data-bs-ride="carousel"]');
    for (const t of n) ai.getOrCreateInstance(t);
  });
  h(ai);
  const vi = ".bs.collapse",
    ll = `show${vi}`,
    al = `shown${vi}`,
    vl = `hide${vi}`,
    yl = `hidden${vi}`,
    pl = `click${vi}.data-api`,
    hu = "show",
    bt = "collapse",
    fr = "collapsing",
    wl = `:scope .${bt} .${bt}`,
    cu = '[data-bs-toggle="collapse"]',
    bl = { parent: null, toggle: !0 },
    kl = { parent: "(null|element)", toggle: "boolean" };
  class yi extends a {
    constructor(n, i) {
      super(n, i);
      ...
      const r = t.find(cu);
      for (const n of r) {
        const i = t.getSelectorFromElement(n),
          r = t.find(i).filter((n) => n === this._element);
        null !== i && r.length && this._triggerArray.push(n);
      }
        ...
        if (
          (this._config.parent &&
            (i = this._getFirstLevelChildren(
              ...
              .map((n) => yi.getOrCreateInstance(n, { toggle: !1 }))),
          !i.length || !i[0]._isTransitioning) &&
          !n.trigger(this._element, ll).defaultPrevented
        ) {
          for (const n of i) n.hide();
          ...
          this._queueCallback(
            () => {
              (this._isTransitioning = !1),
                ...
                this._element.classList.add(bt, hu),
                (this._element.style[t] = ""),
                n.trigger(this._element, al);
            },
            this._element,
            !0,
          );
    ...
    hide() {
      if (
        ...
        this._isShown() &&
        !n.trigger(this._element, vl).defaultPrevented
      ) {
        ...
        hi(this._element);
        this._element.classList.add(fr);
        this._element.classList.remove(bt, hu);
        for (const n of this._triggerArray) {
          const i = t.getElementFromSelector(n);
    ...
    _isShown(n = this._element) {
      return n.classList.contains(hu);
    }
    _configAfterMerge(n) {
      return (n.toggle = Boolean(n.toggle)), (n.parent = nt(n.parent)), n;
    }
    _getDimension() {
    ...
    _initializeChildren() {
      if (this._config.parent) {
        const n = this._getFirstLevelChildren(cu);
        for (const i of n) {
          const n = t.getElementFromSelector(i);
          n && this._addAriaAndCollapsedClass([i], this._isShown(n));
        }
      }
    }
    _getFirstLevelChildren(n) {
      const i = t.find(wl, this._config.parent);
      return t.find(n, this._config.parent).filter((n) => !i.includes(n));
    }
  ...
  n.on(document, pl, cu, function (n) {
    ("A" === n.target.tagName ||
      (n.delegateTarget && "A" === n.delegateTarget.tagName)) &&
      n.preventDefault();
    for (const n of t.getMultipleElementsFromSelector(this))
      yi.getOrCreateInstance(n, { toggle: !1 }).toggle();
  });
  h(yi);
  var i = "top",
    f = "bottom",
    ...
    gt = "popper",
    no = "reference",
    au = kt.reduce(function (n, t) {
      return n.concat([t + "-" + et, t + "-" + dt]);
    }, []),
    vu = [].concat(kt, [er]).reduce(function (n, t) {
      return n.concat([t, t + "-" + et, t + "-" + dt]);
    }, []),
    to = "beforeRead",
    io = "read",
    ro = "afterRead",
  ...
  const wo = {
    ...
    fn: function (n) {
      var s,
        ...
        a = y(t.placement),
        u = ku(a),
        o = [r, e].indexOf(a) >= 0 ? "height" : "width";
      if (h && c) {
        var v = (function (n, t) {
            return yo(
              "number" !=
          ...
          it =
            ...
            c[u] -
            t.rects.popper[o],
          rt = c[u] - t.rects.reference[u],
          l = pi(h),
          w = l ? ("y" === u ? l.clientHeight || 0 : l.clientWidth || 0) : 0,
          ut = it / 2 - rt / 2,
          ft = v[nt],
          et = w - p[o] - v[tt],
          b = w / 2 - p[o] / 2 + ut,
          k = wi(ft, b, et),
          ot = u;
        t.modifiersData[d] = (((s = {})[ot] = k), (s.centerOffset = k - b), s);
      }
    },
    effect: function (n) {
      var i = n.state,
      ...
      null != t &&
        ("string" != typeof t || (t = i.elements.popper.querySelector(t))) &&
        ao(i.elements.popper, t) &&
        (i.elements.arrow = t);
    },
    requires: ["popperOffsets"],
    requiresIfExists: ["preventOverflow"],
  };
  bo = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
  const du = {
    name: "computeStyles",
    enabled: !0,
    phase: "beforeWrite",
  ...
  const gu = {
    ...
    effect: function (n) {
      var i = n.state,
        ...
        e = r.resize,
        s = void 0 === e || e,
        h = o(i.elements.popper),
        c = [].concat(i.scrollParents.reference, i.scrollParents.popper);
      return (
        f &&
          c.forEach(function (n) {
            n.addEventListener("scroll", t.update, bi);
          }),
        s && h.addEventListener("resize", t.update, bi),
        function () {
          f &&
            c.forEach(function (n) {
              n.removeEventListener("scroll", t.update, bi);
            });
          s && h.removeEventListener("resize", t.update, bi);
        }
      );
    },
    data: {},
  ...
  const fs = {
    ...
    fn: function (n) {
      var t = n.state,
        ...
        at,
        v;
      if (!t.modifiersData[k]._skip) {
        for (
          var d = u.mainAxis,
            vt = void 0 === d || d,
            g = u.altAxis,
            yt = void 0 === g || g,
            pt = u.fallbackPlacements,
            nt = u.padding,
            tt = u.boundary,
            it = u.rootBoundary,
            wt = u.altBoundary,
            ...
            dt =
              ...
              (kt !== o && p
                ...
                : [hr(o)]),
            c = [o].concat(dt).reduce(function (n, i) {
              return n.concat(
                y(i) === er
                  ? gl(t, {
                      placement: i,
          ...
          for (
            at = function (n) {
              var t = c.find(function (t) {
                var i = ut.get(t);
                if (i)
                  return i.slice(0, n).every(function (n) {
                    return n;
                  });
              });
        ...
        t.placement !== l &&
          ((t.modifiersData[k]._skip = !0), (t.placement = l), (t.reset = !0));
      }
    },
  ...
  const ss = {
      ...
      fn: function (n) {
        var t = n.state,
          ...
          c = ri(t, { elementContext: "reference" }),
          l = ri(t, { altBoundary: !0 }),
          i = es(c, o),
          r = es(l, s, h),
          u = os(i),
          f = os(r);
    ...
    hs = {
      ...
      fn: function (n) {
        var t = n.state,
          ...
          u = s.offset,
          c = void 0 === u ? [0, 0] : u,
          f = vu.reduce(function (n, u) {
            return (
              (n[u] = (function (n, t, u) {
                var s = y(n),
                  c = [r, i].indexOf(s) >= 0 ? -1 : 1,
                  h =
                    "function" == typeof u
                      ? u(Object.assign({}, t, { placement: n }))
                      : u,
                  f = h[0],
                  o = h[1];
                return (
                  (f = f || 0),
                  (o = (o || 0) * c),
                  [r, e].indexOf(s) >= 0 ? { x: o, y: f } : { x: f, y: o }
                );
              })(u, t.rects, c)),
              n
            );
    ...
    cs = {
      ...
      fn: function (n) {
        var t = n.state,
          ...
          d =
            "function" == typeof it
              ? it(Object.assign({}, t.rects, { placement: t.placement }))
              : it,
          a =
            "number" == typeof d
        ...
        if (w) {
          if (ki) {
            var pt,
              ...
              ur = rt === et ? -b[o] : -c[o],
              ni = t.elements.arrow,
              fr = h && ni ? bu(ni) : { width: 0, height: 0 },
              ti = t.modifiersData["arrow#persistent"]
              ...
              nt = wi(0, c[o], fr[o]),
              er = yt
                ? c[o] / 2 - gt - nt - ui - a.mainAxis
                : rr - nt - ui - a.mainAxis,
              sr = yt
                ? -c[o] / 2 + gt + nt + fi + a.mainAxis
                : ur + nt + fi + a.mainAxis,
              ...
              hr = ft
                ? "y" === u
                  ...
                  : ft.clientLeft || 0
                : 0,
              ei = null != (pt = null == g ? void 0 : g[u]) ? pt : 0,
              cr = v + sr - ei,
              oi = wi(
                h ? or(kt, v + er - ei - hr) : kt,
                v,
                h ? st(dt, cr) : dt,
              );
            w[u] = oi;
          ...
          if (di) {
            var si,
              ...
              ci = l - k[ar],
              ot = -1 !== [i, r].indexOf(vt),
              li = null != (si = null == g ? void 0 : g[p]) ? si : 0,
              ai = ot ? hi : l - c[tt] - b[tt] - li + a.altAxis,
              vi = ot ? l + c[tt] + b[tt] - li - a.altAxis : ci,
              yi =
                h && ot
                  ? (function (n, t, i) {
                      var r = wi(n, t, i);
                  ...
                  : wi(h ? ai : hi, l, h ? vi : ci);
            w[p] = yi;
            ut[p] = yi - l;
          }
          t.modifiersData[bi] = ut;
        }
      },
      requiresIfExists: ["offset"],
    };
  ef = { placement: "bottom", modifiers: [], strategy: "absolute" };
  var ia = cr(),
    ra = cr({ defaultModifiers: [gu, ff, du, pu] }),
    sf = cr({ defaultModifiers: [gu, ff, du, pu, hs, fs, cs, wo, ss] });
  const as = Object.freeze(
    ...
    ca = `${ct}.${ui}`,
    lr = ".dropdown-menu",
    la = s() ? "top-end" : "top-start",
    aa = s() ? "top-start" : "top-end",
    va = s() ? "bottom-end" : "bottom-start",
    ya = s() ? "bottom-start" : "bottom-end",
    pa = s() ? "left-start" : "right-start",
    wa = s() ? "right-start" : "left-start",
    ba = {
      autoClose: !0,
  ...
  class p extends a {
    constructor(n, i) {
      ...
      this._menu =
        t.next(this._element, lr)[0] ||
        t.prev(this._element, lr)[0] ||
        t.findOne(lr, this._parent);
    ...
    show() {
      if (!tt(this._element) && !this._isShown()) {
        const t = { relatedTarget: this._element };
        if (!n.trigger(this._element, oa, t).defaultPrevented) {
          if (
            (this._createPopper(),
            "ontouchstart" in document.documentElement &&
    ...
    _completeHide(t) {
      if (!n.trigger(this._element, fa, t).defaultPrevented) {
        if ("ontouchstart" in document.documentElement)
          for (const t of [].concat(...document.body.children))
            n.off(t, "mouseover", gi);
        this._popper && this._popper.destroy();
        this._menu.classList.remove(ui);
        this._element.classList.remove(ui);
        this._element.setAttribute("aria-expanded", "false");
        b.removeDataAttribute(this._menu, "popper");
        n.trigger(this._element, ea, t);
      }
    }
    _getConfig(n) {
      if (
        ...
        throw new TypeError(
          `${vs.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`,
        );
      return n;
    }
    _createPopper() {
      ...
      "parent" === this._config.reference
        ...
        : w(this._config.reference)
          ? (n = nt(this._config.reference))
          : "object" == typeof this._config.reference &&
            (n = this._config.reference);
      const t = this._getPopperConfig();
      this._popper = sf(n, this._menu, t);
    }
    _isShown() {
    ...
    _getPlacement() {
      ...
      if (n.classList.contains("dropend")) return pa;
      if (n.classList.contains("dropstart")) return wa;
      if (n.classList.contains("dropup-center")) return "top";
      if (n.classList.contains("dropdown-center")) return "bottom";
      const t =
        "end" ===
        getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
      return n.classList.contains("dropup") ? (t ? aa : la) : t ? ya : va;
    }
    _detectNavbar() {
    ...
    _getOffset() {
      ...
      return "string" == typeof n
        ? n.split(",").map((n) => Number.parseInt(n, 10))
        : "function" == typeof n
          ? (t) => n(t, this._element)
          : n;
    }
    _getPopperConfig() {
      ...
      return (
        ...
        { ...n, ...u(this._config.popperConfig, [n]) }
      );
    }
    _selectMenuItem({ key: i, target: n }) {
      const r = t
        .find(
        ...
        .filter((n) => vt(n));
      r.length && tu(r, n, i === ys, !r.includes(n)).focus();
    }
    static jQueryInterface(n) {
      return this.each(function () {
        const t = p.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
    ...
    static clearMenus(n) {
      if (2 !== n.button && ("keyup" !== n.type || "Tab" === n.key)) {
        const i = t.find(ca);
        for (const t of i) {
          const i = p.getInstance(t);
          if (i && !1 !== i._config.autoClose) {
            const r = n.composedPath(),
              u = r.includes(i._menu);
            if (
              !r.includes(i._element) &&
              ("inside" !== i._config.autoClose || u) &&
              ("outside" !== i._config.autoClose || !u) &&
              (!i._menu.contains(n.target) ||
                (("keyup" !== n.type || "Tab" !== n.key) &&
                  !/input|select|option|textarea|form/i.test(n.target.tagName)))
            ) {
              const f = { relatedTarget: i._element };
              "click" === n.type && (f.clickEvent = n);
              i._completeHide(f);
            }
          }
        }
    ...
    static dataApiKeydownHandler(n) {
      const e = /input|textarea/i.test(n.target.tagName),
        r = "Escape" === n.key,
        u = [ua, ys].includes(n.key);
      if ((u || r) && (!e || r)) {
        n.preventDefault();
        const f = this.matches(ct)
            ? this
            : t.prev(this, ct)[0] ||
              t.next(this, ct)[0] ||
              t.findOne(ct, n.delegateTarget.parentNode),
          i = p.getOrCreateInstance(f);
        if (u) return n.stopPropagation(), i.show(), void i._selectMenuItem(n);
        i._isShown() && (n.stopPropagation(), i.hide(), f.focus());
      }
    }
  }
  n.on(document, ws, ct, p.dataApiKeydownHandler);
  n.on(document, ws, lr, p.dataApiKeydownHandler);
  n.on(document, ps, p.clearMenus);
  n.on(document, ha, p.clearMenus);
  n.on(document, ps, ct, function (n) {
    n.preventDefault();
    p.getOrCreateInstance(this).toggle();
  });
  h(p);
  const bs = "backdrop",
    ks = "show",
  ...
  class gs extends ci {
    ...
    show(n) {
      if (!this._config.isVisible) return void u(n);
      this._append();
      const t = this._getElement();
      this._config.isAnimated && hi(t);
      t.classList.add(ks);
    ...
    _configAfterMerge(n) {
      return (n.rootElement = nt(n.rootElement)), n;
    }
    _append() {
      if (!this._isAppended) {
        const t = this._getElement();
    ...
    _emulateAnimation(n) {
      ue(n, this._getElement(), this._config.isAnimated);
    }
  }
  const ar = ".bs.focustrap",
    ...
    tv = `keydown.tab${ar}`,
    nh = "backward",
    iv = { autofocus: !0, trapElement: null },
    rv = { autofocus: "boolean", trapElement: "element" };
  class th extends ci {
    constructor(n) {
      super();
      this._config = this._getConfig(n);
    ...
    activate() {
      this._isActive ||
        ...
        n.off(document, ar),
        n.on(document, nv, (n) => this._handleFocusin(n)),
        n.on(document, tv, (n) => this._handleKeydown(n)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), n.off(document, ar));
    }
    _handleFocusin(n) {
      const { trapElement: i } = this._config;
      if (n.target !== document && n.target !== i && !i.contains(n.target)) {
        const r = t.focusableChildren(i);
        0 === r.length
          ? i.focus()
          : this._lastTabNavDirection === nh
            ? r[r.length - 1].focus()
            : r[0].focus();
      }
    }
    _handleKeydown(n) {
      "Tab" === n.key &&
        (this._lastTabNavDirection = n.shiftKey ? nh : "forward");
    }
  }
  const ih = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    rh = ".sticky-top",
    vr = "padding-right",
    uh = "margin-right";
  class cf {
    ...
    hide() {
      ...
      this._setElementAttributes(this._element, vr, (t) => t + n);
      this._setElementAttributes(ih, vr, (t) => t + n);
      this._setElementAttributes(rh, uh, (t) => t - n);
    }
    reset() {
      this._resetElementAttributes(this._element, "overflow");
      this._resetElementAttributes(this._element, vr);
      this._resetElementAttributes(ih, vr);
      this._resetElementAttributes(rh, uh);
    }
    isOverflowing() {
    ...
    _setElementAttributes(n, t, i) {
      const r = this.getWidth();
      this._applyManipulationCallback(n, (n) => {
        if (n === this._element || !(window.innerWidth > n.clientWidth + r)) {
          this._saveInitialAttribute(n, t);
          const u = window.getComputedStyle(n).getPropertyValue(t);
          n.style.setProperty(t, `${i(Number.parseFloat(u))}px`);
        }
      });
    }
    _saveInitialAttribute(n, t) {
      const i = n.style.getPropertyValue(t);
      i && b.setDataAttribute(n, t, i);
    }
    _resetElementAttributes(n, t) {
      this._applyManipulationCallback(n, (n) => {
        const i = b.getDataAttribute(n, t);
        null !== i
          ? (b.removeDataAttribute(n, t), n.style.setProperty(t, i))
          : n.style.removeProperty(t);
      });
    }
    _applyManipulationCallback(n, i) {
      if (w(n)) i(n);
      else for (const r of t.find(n, this._element)) i(r);
    }
  }
  const l = ".bs.modal",
    uv = `hide${l}`,
    ...
    ov = `resize${l}`,
    sv = `click.dismiss${l}`,
    hv = `mousedown.dismiss${l}`,
    cv = `keydown.dismiss${l}`,
    lv = `click${l}.data-api`,
    oh = "modal-open",
    sh = "show",
    lf = "modal-static",
    av = { backdrop: !0, focus: !0, keyboard: !0 },
    vv = {
  ...
  class fi extends a {
    ...
    show(t) {
      this._isShown ||
        this._isTransitioning ||
        n.trigger(this._element, eh, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    hide() {
      this._isShown &&
        !this._isTransitioning &&
        (n.trigger(this._element, uv).defaultPrevented ||
          ((this._isShown = !1),
          (this._isTransitioning = !0),
    ...
    _showElement(i) {
      ...
      const r = t.findOne(".modal-body", this._dialog);
      r && (r.scrollTop = 0);
      hi(this._element);
      ...
      this._queueCallback(
        () => {
          this._config.focus && this._focustrap.activate(),
            (this._isTransitioning = !1),
            n.trigger(this._element, ev, { relatedTarget: i });
        },
        this._dialog,
        this._isAnimated(),
      );
    ...
    _addEventListeners() {
      ...
      n.on(this._element, hv, (t) => {
        n.one(this._element, sv, (n) => {
    ...
    _triggerBackdropTransition() {
      if (!n.trigger(this._element, fv).defaultPrevented) {
        const i =
            this._element.scrollHeight > document.documentElement.clientHeight,
          t = this._element.style.overflowY;
        "hidden" === t ||
          this._element.classList.contains(lf) ||
          (i || (this._element.style.overflowY = "hidden"),
          this._element.classList.add(lf),
          this._queueCallback(() => {
            this._element.classList.remove(lf),
              this._queueCallback(() => {
    ...
    static jQueryInterface(n, t) {
      return this.each(function () {
        const i = fi.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === i[n]) throw new TypeError(`No method named "${n}"`);
          i[n](t);
        }
  ...
  n.on(document, lv, '[data-bs-toggle="modal"]', function (i) {
    const r = t.getElementFromSelector(this);
    ...
    const u = t.findOne(".modal.show");
    u && fi.getInstance(u).hide();
    fi.getOrCreateInstance(r).toggle(this);
  });
  nr(fi);
  h(fi);
  const d = ".bs.offcanvas",
    hh = ".data-api",
    yv = `load${d}${hh}`,
    ch = "show",
    lh = "showing",
    ...
    kv = `resize${d}`,
    dv = `click${d}${hh}`,
    gv = `keydown.dismiss${d}`,
    ny = { backdrop: !0, keyboard: !0, scroll: !1 },
    ty = {
      backdrop: "(boolean|string)",
      keyboard: "boolean",
      scroll: "boolean",
  ...
  class ut extends a {
    ...
    show(t) {
      this._isShown ||
        n.trigger(this._element, pv, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
        this._config.scroll || new cf().hide(),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        ...
        this._queueCallback(
          () => {
            (this._config.scroll && !this._config.backdrop) ||
              ...
              this._element.classList.add(ch),
              this._element.classList.remove(lh),
              n.trigger(this._element, wv, { relatedTarget: t });
          },
          this._element,
          !0,
        ));
    ...
    hide() {
      this._isShown &&
        (n.trigger(this._element, bv).defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(ch, ah),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
                this._config.scroll || new cf().reset(),
                n.trigger(this._element, ph);
            },
            this._element,
            !0,
          )));
    ...
    _addEventListeners() {
      n.on(this._element, gv, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : n.trigger(this._element, yh));
      });
    }
    static jQueryInterface(n) {
      return this.each(function () {
        const t = ut.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === t[n] || n.startsWith("_") || "constructor" === n)
            throw new TypeError(`No method named "${n}"`);
          t[n](this);
  ...
  n.on(document, dv, '[data-bs-toggle="offcanvas"]', function (i) {
    const r = t.getElementFromSelector(this);
    if (
      (["A", "AREA"].includes(this.tagName) && i.preventDefault(), !tt(this))
    ) {
      n.one(r, ph, () => {
        vt(this) && this.focus();
      });
      const u = t.findOne(vh);
      u && u !== r && ut.getInstance(u).hide();
      ut.getOrCreateInstance(r).toggle(this);
    }
  });
  n.on(window, yv, () => {
    for (const n of t.find(vh)) ut.getOrCreateInstance(n).show();
  });
  n.on(window, kv, () => {
    for (const n of t.find("[aria-modal][class*=show][class*=offcanvas-]"))
      "fixed" !== getComputedStyle(n).position &&
        ut.getOrCreateInstance(n).hide();
  });
  nr(ut);
  h(ut);
  const wh = {
    ...
    uy = (n, t) => {
      ...
      return t.includes(i)
        ? !iy.has(i) || Boolean(ry.test(n.nodeValue))
  ...
  class sy extends ci {
    ...
    _checkContent(n) {
      for (const [t, i] of Object.entries(n))
        super._typeCheckConfig({ selector: t, entry: i }, oy);
    }
    _setContent(n, i, r) {
      const u = t.findOne(r, n);
      u &&
        ((i = this._resolvePossibleFunction(i))
          ? w(i)
            ? this._putElementInTemplate(nt(i), u)
            : this._config.html
              ? (u.innerHTML = this._maybeSanitize(i))
              : (u.textContent = i)
          : u.remove());
    }
    _maybeSanitize(n) {
      return this._config.sanitize
        ? (function (n, t, i) {
            ...
            const r = new window.DOMParser().parseFromString(n, "text/html"),
              u = [].concat(...r.body.querySelectorAll("*"));
            for (const n of u) {
              const i = n.nodeName.toLowerCase();
              ...
              const r = [].concat(...n.attributes),
                u = [].concat(t["*"] || [], t[i] || []);
              for (const t of r) uy(t, u) || n.removeAttribute(t.nodeName);
            }
    ...
    _putElementInTemplate(n, t) {
      if (this._config.html) return (t.innerHTML = ""), void t.append(n);
      t.textContent = n.textContent;
    }
  }
  const hy = new Set(["sanitize", "allowList", "sanitizeFn"]),
    af = "fade",
    yr = "show",
    bh = ".modal",
    kh = "hide.bs.modal",
  ...
  class ei extends a {
    ...
    dispose() {
      ...
      n.off(this._element.closest(bh), kh, this._hideModalHandler);
    ...
    show() {
      ...
      if (this._isWithContent() && this._isEnabled) {
        const i = n.trigger(this._element, this.constructor.eventName("show")),
          r = (
            ie(this._element) || this._element.ownerDocument.documentElement
          ).contains(this._element);
        if (!i.defaultPrevented && r) {
          this._disposePopper();
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove(yr),
          "ontouchstart" in document.documentElement)
        )
          for (const t of [].concat(...document.body.children))
            n.off(t, "mouseover", gi);
    ...
    _createTipElement(n) {
      const t = this._getTemplateFactory(n).toHtml();
      if (!t) return null;
      t.classList.remove(af, yr);
      ...
      return (
        t.setAttribute("id", i), this._isAnimated() && t.classList.add(af), t
      );
    }
    setContent(n) {
      this._newContent = n;
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(af))
      );
    }
    _isShown() {
      return this.tip && this.tip.classList.contains(yr);
    }
    _createPopper(n) {
      const t = u(this._config.placement, [this, n, this._element]),
        i = cy[t.toUpperCase()];
      return sf(this._element, n, this._getPopperConfig(i));
    }
    _getOffset() {
      const { offset: n } = this._config;
      return "string" == typeof n
    ...
    _getPopperConfig(n) {
      ...
      return { ...t, ...u(this._config.popperConfig, [t]) };
    }
    _setListeners() {
      ...
      for (const i of t)
        if ("click" === i)
          ...
          n.on(this._element, t, this._config.selector, (n) => {
            const t = this._initializeOnDelegatedTarget(n);
            t._activeTrigger["focusin" === n.type ? vf : di] = !0;
            t._enter();
          });
          n.on(this._element, r, this._config.selector, (n) => {
            const t = this._initializeOnDelegatedTarget(n);
            t._activeTrigger["focusout" === n.type ? vf : di] =
      ...
      n.on(this._element.closest(bh), kh, this._hideModalHandler);
    }
    _fixTitle() {
    ...
    _getConfig(n) {
      ...
      for (const n of Object.keys(t)) hy.has(n) && delete t[n];
      return (
        (n = { ...t, ...("object" == typeof n && n ? n : {}) }),
        (n = this._mergeConfigObj(n)),
        (n = this._configAfterMerge(n)),
        this._typeCheckConfig(n),
        n
    ...
    _configAfterMerge(n) {
      return (
        (n.container = !1 === n.container ? document.body : nt(n.container)),
    ...
    _getDelegateConfig() {
      ...
      for (const [t, i] of Object.entries(this._config))
        this.constructor.Default[t] !== i && (n[t] = i);
    ...
    static jQueryInterface(n) {
      return this.each(function () {
        const t = ei.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === t[n]) throw new TypeError(`No method named "${n}"`);
          t[n]();
        }
  ...
  const vy = {
    ...
    yy = { ...ei.DefaultType, content: "(null|string|element|function)" };
  class yf extends ei {
    static get Default() {
      return vy;
    }
    ...
    static jQueryInterface(n) {
      return this.each(function () {
        const t = yf.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === t[n]) throw new TypeError(`No method named "${n}"`);
          t[n]();
        }
  ...
  const pf = ".bs.scrollspy",
    ...
    wf = "[href]",
    gh = ".nav-link",
    by = `${gh}, .nav-item > ${gh}, .list-group-item`,
    ky = {
      offset: null,
  ...
  class pr extends a {
    ...
    _configAfterMerge(n) {
      return (
        (n.target = nt(n.target) || document.body),
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (n.off(this._config.target, dh),
        n.on(this._config.target, dh, wf, (n) => {
          const t = this._observableSections.get(n.target.hash);
          if (t) {
            n.preventDefault();
    ...
    _getNewObserver() {
      ...
      return new IntersectionObserver((n) => this._observerCallback(n), n);
    }
    _observerCallback(n) {
      const i = (n) => this._targetLinks.get(`#${n.target.id}`),
        r = (n) => {
          (this._previousScrollData.visibleEntryTop = n.target.offsetTop),
            this._process(i(n));
        },
        t = (this._rootElement || document.documentElement).scrollTop,
        u = t >= this._previousScrollData.parentScrollTop;
      this._previousScrollData.parentScrollTop = t;
      for (const f of n) {
        if (!f.isIntersecting) {
          this._activeTarget = null;
          this._clearActiveClass(i(f));
          continue;
        }
        const n =
          f.target.offsetTop >= this._previousScrollData.visibleEntryTop;
        if (u && n) {
          if ((r(f), !t)) return;
        } else u || n || r(f);
      }
    ...
    _initializeTargetsAndObservables() {
      this._targetLinks = new Map();
      this._observableSections = new Map();
      const n = t.find(wf, this._config.target);
      for (const i of n)
        if (i.hash && !tt(i)) {
          const n = t.findOne(decodeURI(i.hash), this._element);
          vt(n) &&
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        n.trigger(this._element, py, { relatedTarget: t }));
    }
    _activateParents(n) {
      if (n.classList.contains("dropdown-item"))
        t.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(oi);
      else
        for (const i of t.parents(n, ".nav, .list-group"))
          for (const n of t.prev(i, by)) n.classList.add(oi);
    }
    _clearActiveClass(n) {
      n.classList.remove(oi);
      const i = t.find(`${wf}.${oi}`, n);
      for (const n of i) n.classList.remove(oi);
    }
    static jQueryInterface(n) {
      return this.each(function () {
        const t = pr.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === t[n] || n.startsWith("_") || "constructor" === n)
            throw new TypeError(`No method named "${n}"`);
          t[n]();
  ...
  n.on(window, wy, () => {
    for (const n of t.find('[data-bs-spy="scroll"]')) pr.getOrCreateInstance(n);
  });
  h(pr);
  const lt = ".bs.tab",
    gy = `hide${lt}`,
    ...
    gf = `.nav-link${df}, .list-group-item${df}, [role="tab"]${df}, ${fc}`,
    sp = `.${at}[data-bs-toggle="tab"], .${at}[data-bs-toggle="pill"], .${at}[data-bs-toggle="list"]`;
  class si extends a {
    constructor(t) {
      super(t);
      ...
      this._parent &&
        ...
        n.on(this._element, up, (n) => this._keydown(n)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      if (!this._elemIsActive(t)) {
        const i = this._getActiveElem(),
          r = i ? n.trigger(i, gy, { relatedTarget: t }) : null;
        n.trigger(t, tp, { relatedTarget: i }).defaultPrevented ||
    ...
    _activate(i, r) {
      i &&
        (i.classList.add(at),
        this._activate(t.getElementFromSelector(i)),
        this._queueCallback(
          () => {
            "tab" === i.getAttribute("role")
              ? (i.removeAttribute("tabindex"),
                ...
                n.trigger(i, ip, { relatedTarget: r }))
              : i.classList.add(kf);
          },
          i,
          i.classList.contains(rc),
        ));
    }
    _deactivate(i, r) {
      i &&
        ...
        i.blur(),
        this._deactivate(t.getElementFromSelector(i)),
        this._queueCallback(
          () => {
            "tab" === i.getAttribute("role")
              ? (i.setAttribute("aria-selected", !1),
                ...
                n.trigger(i, np, { relatedTarget: r }))
              : i.classList.remove(kf);
          },
          i,
          i.classList.contains(rc),
        ));
    ...
    _keydown(n) {
      if ([ep, nc, op, tc, bf, ic].includes(n.key)) {
        n.stopPropagation();
        n.preventDefault();
        const i = this._getChildren().filter((n) => !tt(n));
        let t;
        if ([bf, ic].includes(n.key)) t = i[n.key === bf ? 0 : i.length - 1];
        else {
          const r = [nc, tc].includes(n.key);
          t = tu(i, n.target, r, !0);
        }
        t && (t.focus({ preventScroll: !0 }), si.getOrCreateInstance(t).show());
      }
    }
    _getChildren() {
      return t.find(gf, this._parent);
    }
    _getActiveElem() {
      return this._getChildren().find((n) => this._elemIsActive(n)) || null;
    }
    _setInitialAttributes(n, t) {
    ...
    _setInitialAttributesOnChild(n) {
      ...
      const t = this._elemIsActive(n),
        i = this._getOuterElement(n);
      n.setAttribute("aria-selected", t);
      i !== n && this._setAttributeIfNotExists(i, "role", "presentation");
    ...
    _setInitialAttributesOnTargetPanel(n) {
      ...
      i &&
        ...
        n.id && this._setAttributeIfNotExists(i, "aria-labelledby", `${n.id}`));
    }
    _toggleDropDown(n, i) {
      const r = this._getOuterElement(n);
      if (r.classList.contains("dropdown")) {
        const u = (n, u) => {
          const f = t.findOne(n, r);
          f && f.classList.toggle(u, i);
        };
        u(uc, at);
        u(".dropdown-menu", kf);
    ...
    _setAttributeIfNotExists(n, t, i) {
      n.hasAttribute(t) || n.setAttribute(t, i);
    }
    _elemIsActive(n) {
      return n.classList.contains(at);
    }
    _getInnerElement(n) {
      return n.matches(gf) ? n : t.findOne(gf, n);
    }
    _getOuterElement(n) {
  ...
  n.on(document, rp, fc, function (n) {
    ["A", "AREA"].includes(this.tagName) && n.preventDefault();
    tt(this) || si.getOrCreateInstance(this).show();
  });
  n.on(window, fp, () => {
    for (const n of t.find(sp)) si.getOrCreateInstance(n);
  });
  h(si);
  const ft = ".bs.toast",
    hp = `mouseover${ft}`,
    ...
    wr = "show",
    br = "showing",
    bp = { animation: "boolean", autohide: "boolean", delay: "number" },
    kp = { animation: !0, autohide: !0, delay: 5e3 };
  class kr extends a {
    constructor(n, t) {
      super(n, t);
      this._timeout = null;
    ...
    show() {
      n.trigger(this._element, pp).defaultPrevented ||
        (this._clearTimeout(),
    ...
    hide() {
      this.isShown() &&
        (n.trigger(this._element, vp).defaultPrevented ||
          (this._element.classList.add(br),
          this._queueCallback(
            () => {
              this._element.classList.add(ec),
                this._element.classList.remove(br, wr),
                n.trigger(this._element, yp);
            },
            this._element,
            this._config.animation,
          )));
    ...
    _setListeners() {
      n.on(this._element, hp, (n) => this._onInteraction(n, !0));
      n.on(this._element, cp, (n) => this._onInteraction(n, !1));
      n.on(this._element, lp, (n) => this._onInteraction(n, !0));
      n.on(this._element, ap, (n) => this._onInteraction(n, !1));
    }
    _clearTimeout() {
      clearTimeout(this._timeout);
      this._timeout = null;
    ...
    static jQueryInterface(n) {
      return this.each(function () {
        const t = kr.getOrCreateInstance(this, n);
        if ("string" == typeof n) {
          if (void 0 === t[n]) throw new TypeError(`No method named "${n}"`);
          t[n](this);
        }
  ...
  (function (n) {
    ...
    t = (function () {
      function i(i, r) {
        ...
        u.autoPlayToggleHandler = n.proxy(u.autoPlayToggleHandler, u);
    ...
    t.prototype.autoPlayToggleHandler = function () {
      var n = this;
      n.paused
        ? (n.$playIcon.css("display", "none"),
          n.$pauseIcon.css("display", "inline"),
          n.$pauseButton
            .find(".slick-play-text")
            .attr("style", "display: none"),
          n.$pauseButton.find(".slick-pause-text").removeAttr("style"),
          n.slickPlay())
        : (n.$playIcon.css("display", "inline"),
          n.$pauseIcon.css("display", "none"),
          n.$pauseButton.find(".slick-play-text").removeAttr("style"),
          n.$pauseButton
      ...
      if (t.options.arrows === !0)
        if (
          ...
          if (t.htmlExpr.test(t.options.prevArrow))
            ...
            else t.$prevArrow.prependTo(t.options.appendArrows);
          if (t.htmlExpr.test(t.options.nextArrow))
            if (t.options.arrowsPlacement != null)
              switch (t.options.arrowsPlacement) {
                case "beforeSlides":
                  console.log("test2");
                  t.$prevArrow.after(t.$nextArrow);
                  break;
                case "afterSlides":
                case "split":
                  t.$nextArrow.appendTo(t.options.appendArrows);
              }
            else t.$nextArrow.appendTo(t.options.appendArrows);
    ...
    t.prototype.buildOut = function () {
      ...
      t.$slides.each(function (i, r) {
        n(r)
          ...
          .data("originalStyling", n(r).attr("style") || "");
      ...
      t.options.autoplay &&
        ...
        ((t.$pauseIcon = n(t.options.pauseIcon).attr("aria-hidden", !0)),
        (t.$playIcon = n(t.options.playIcon).attr("aria-hidden", !0)),
        (t.$pauseButton = n(
        ...
        t.$pauseButton.append(
          n('<span class="slick-pause-text slick-sr-only">Pause<\/span>'),
        ),
        t.$pauseButton.append(
          n(
      ...
      t.options.instructionsText != null &&
        t.options.instructionsText != "" &&
        ((t.$instructionsText = n(
    ...
    t.prototype.cleanUpEvents = function () {
      ...
      t.options.autoplay &&
        t.options.useAutoplayToggleButton &&
        t.$pauseButton.off("click.slick", t.autoPlayToggleHandler);
      t.options.dots &&
        t.$dots !== null &&
        n("li", t.$dots)
    ...
    t.prototype.getSlideCount = function () {
      var t = this,
        ...
        u;
      return (
        (u = t.options.centerMode === !0 ? Math.floor(t.$list.width() / 2) : 0),
        (r = t.swipeLeft * -1 + u),
    ...
    t.prototype.init = function (t) {
      ...
      i.updateSlideVisibility();
      i.options.accessibility != undefined &&
        console.warn("accessibility setting is no longer supported.");
      i.options.focusOnChange != undefined &&
        console.warn("focusOnChange is no longer supported.");
      i.options.focusOnSelect != undefined &&
    ...
    t.prototype.initializeEvents = function () {
      ...
      if (
        ...
        t.$pauseButton.on("click.slick", t.autoPlayToggleHandler);
      t.$list.on(
    ...
    t.prototype.reinit = function () {
      var n = this;
      n.$slides = n.$slideTrack
        .children(n.options.slide)
        .addClass("slick-slide");
      ...
      n.setSlideClasses(typeof n.currentSlide == "number" ? n.currentSlide : 0);
      n.setPosition();
      n.focusHandler();
    ...
    t.prototype.setSlideClasses = function (t) {
      ...
      r = i.$slider
        ...
        .attr("aria-label", function () {
          return n(this).attr("aria-label").replace(" (centered)", "");
        });
      i.$slides.eq(t).addClass("slick-current");
      i.options.centerMode === !0
        ? ((o = i.options.slidesToShow % 2 == 0 ? 1 : 0),
          (f = Math.floor(i.options.slidesToShow / 2)),
          i.options.infinite === !0 &&
            (t >= f && t <= i.slideCount - 1 - f
              ? i.$slides
                  .slice(t - f + o, t + f + 1)
                  .addClass("slick-active")
                  .removeAttr("aria-hidden")
              : ((u = i.options.slidesToShow + t),
                r
                  .slice(u - f + 1 + o, u + f + 2)
                  .addClass("slick-active")
                  .removeAttr("aria-hidden")),
            t === 0
              ? r
                  .eq(i.options.slidesToShow + i.slideCount + 1)
                  .addClass("slick-center")
                  .attr("aria-label", function () {
                    return n(this).attr("aria-label") + " (centered)";
                  })
              : t === i.slideCount - 1 &&
                r
        ...
        : t >= 0 && t <= i.slideCount - i.options.slidesToShow
          ...
          : r.length <= i.options.slidesToShow
            ? r.addClass("slick-active").removeAttr("aria-hidden")
            : ((e = i.slideCount % i.options.slidesToShow),
              (u = i.options.infinite === !0 ? i.options.slidesToShow + t : t),
              i.options.slidesToShow == i.options.slidesToScroll &&
              i.slideCount - t < i.options.slidesToShow
                ? r
                    .slice(u - (i.options.slidesToShow - e), u + e)
                    .addClass("slick-active")
                    .removeAttr("aria-hidden")
                : r
                    .slice(u, u + i.options.slidesToShow)
                    .addClass("slick-active")
                    .removeAttr("aria-hidden"));
    ...
    t.prototype.updateArrows = function () {
      ...
      n.options.arrows === !0 &&
        n.slideCount > n.options.slidesToShow &&
        !n.options.infinite &&
        (n.$prevArrow.removeClass("slick-disabled").prop("disabled", !1),
        n.$nextArrow.removeClass("slick-disabled").prop("disabled", !1),
        n.currentSlide === 0
          ? (n.$prevArrow.addClass("slick-disabled").prop("disabled", !0),
            n.$nextArrow.removeClass("slick-disabled").prop("disabled", !1))
          : n.currentSlide >= n.slideCount - n.options.slidesToShow &&
              n.options.centerMode === !1
            ? (n.$nextArrow.addClass("slick-disabled").prop("disabled", !0),
              n.$prevArrow.removeClass("slick-disabled").prop("disabled", !1))
    ...
    t.prototype.updateSlideVisibility = function () {
      var n = this;
      n.$slideTrack
        .find(".slick-slide")
        .attr("aria-hidden", "true")
 ...
 */
<<<<<<< HEAD
!function(){"use strict";function o(n,t,i){"addEventListener"in window?n.addEventListener(t,i,!1):"attachEvent"in window&&n.attachEvent("on"+t,i)}function k(){for(var i=["moz","webkit","o","ms"],n=0;n<i.length&&!r;n+=1)r=window[i[n]+"RequestAnimationFrame"];r||t(" RequestAnimationFrame not supported")}function t(t){n.log&&"object"==typeof console&&console.log(u+"[Host page"+b+"]"+t)}function d(r){function o(){function t(){c(f);s();n.resizedCallback(f)}l(t,f,"resetPage")}function v(i){var r=i.id;t(" Removing iFrame: "+r);i.parentNode.removeChild(i);n.closedCallback(r);t(" --")}function y(){var n=e.substr(w).split(":");return{iframe:document.getElementById(n[0]),id:n[0],height:n[1],width:n[2],type:n[3]}}function a(i){var e=Number(n["max"+i]),o=Number(n["min"+i]),r=i.toLowerCase(),u=Number(f[r]);if(o>e)throw new Error("Value for min"+i+" can not be greater than max"+i);t(" Checking "+r+" is in range "+o+"-"+e);o>u&&(u=o,t(" Set "+r+" to min value"));u>e&&(u=e,t(" Set "+r+" to max value"));f[r]=""+u}function k(){var i=r.origin,u=f.iframe.src.split("/").slice(0,3).join("/");if(n.checkOrigin&&(t(" Checking connection is from: "+u),""+i!="null"&&i!==u))throw new Error("Unexpected message received from: "+i+" for "+f.iframe.id+". Message was: "+r.data+". This error can be disabled by adding the checkOrigin: false option.");return!0}function d(){return u===(""+e).substr(0,w)}function g(){var n=f.type in{"true":1,"false":1};return n&&t(" Ignoring init message from meta parent page"),n}function nt(){var i=e.substr(e.indexOf(":")+it+6);t(" MessageCallback passed: {iframe: "+f.iframe.id+", message: "+i+"}");n.messageCallback({iframe:f.iframe,message:i});t(" --")}function tt(){if(null===f.iframe)throw new Error("iFrame ("+f.id+") does not exist on "+b);return!0}function rt(){t(" Reposition requested from iFrame");i={x:f.width,y:f.height};s()}function ut(){switch(f.type){case"close":v(f.iframe);n.resizedCallback(f);break;case"message":nt();break;case"scrollTo":rt();break;case"reset":h(f);break;case"init":o();n.initCallback(f.iframe);break;default:o()}}var e=r.data,f={};d()&&(t(" Received: "+e),f=y(),a("Height"),a("Width"),!g()&&tt()&&k()&&(ut(),p=!1))}function g(){null===i&&(i={x:void 0!==window.pageXOffset?window.pageXOffset:document.documentElement.scrollLeft,y:void 0!==window.pageYOffset?window.pageYOffset:document.documentElement.scrollTop},t(" Get position: "+i.x+","+i.y))}function s(){null!==i&&(window.scrollTo(i.x,i.y),t(" Set position: "+i.x+","+i.y),i=null)}function h(n){function i(){c(n);e("reset","reset",n.iframe)}t(" Size reset requested by "+("init"===n.type?"host page":"iFrame"));g();l(i,n,"init")}function c(i){function r(n){i.iframe.style[n]=i[n]+"px";t(" IFrame ("+i.iframe.id+") "+n+" set to "+i[n]+"px")}n.sizeHeight&&r("height");n.sizeWidth&&r("width")}function l(n,i,u){u!==i.type&&r?(t(" Requesting animation frame"),r(n)):n()}function e(n,i,r){t("["+n+"] Sending msg to iframe ("+i+")");r.contentWindow.postMessage(u+i,"*")}function a(){function u(){function r(r){1/0!==n[r]&&0!==n[r]&&(i.style[r]=n[r]+"px",t(" Set "+r+" = "+n[r]+"px"))}r("maxHeight");r("minHeight");r("maxWidth");r("minWidth")}function f(n){return""===n&&(i.id=n="iFrameResizer"+tt++,t(" Added missing iframe ID: "+n+" ("+i.src+")")),n}function s(){t(" IFrame scrolling "+(n.scrolling?"enabled":"disabled")+" for "+r);i.style.overflow=!1===n.scrolling?"hidden":"auto";i.scrolling=!1===n.scrolling?"no":"yes"}function c(){("number"==typeof n.bodyMargin||"0"===n.bodyMargin)&&(n.bodyMarginV1=n.bodyMargin,n.bodyMargin=""+n.bodyMargin+"px")}function l(){return r+":"+n.bodyMarginV1+":"+n.sizeWidth+":"+n.log+":"+n.interval+":"+n.enablePublicMethods+":"+n.autoResize+":"+n.bodyMargin+":"+n.heightCalculationMethod+":"+n.bodyBackground+":"+n.bodyPadding+":"+n.tolerance}function a(t){o(i,"load",function(){var r=p;e("iFrame.onload",t,i);!r&&n.heightCalculationMethod in rt&&h({iframe:i,height:0,width:0,type:"init"})});e("init",t,i)}var i=this,r=f(i.id);s();u();c();a(l())}function v(n){if("object"!=typeof n)throw new TypeError("Options is not an object.");}function y(){function t(n){if("IFRAME"!==n.tagName.toUpperCase())throw new TypeError("Expected <IFRAME> tag, found <"+n.tagName+">.");a.call(n)}function i(t){t=t||{};v(t);for(var i in f)f.hasOwnProperty(i)&&(n[i]=t.hasOwnProperty(i)?t[i]:f[i])}return function(n,r){i(n);Array.prototype.forEach.call(document.querySelectorAll(r||"iframe"),t)}}function nt(t){t.fn.iFrameResize=function(i){return i=i||{},v(i),n=t.extend({},f,i),this.filter("iframe").each(a).end()}}var tt=0,p=!0,it=7,u="[iFrameSizer]",w=u.length,b="",i=null,r=window.requestAnimationFrame,rt={max:1,scroll:1,bodyScroll:1,documentElementScroll:1},n={},f={autoResize:!0,bodyBackground:null,bodyMargin:null,bodyMarginV1:8,bodyPadding:null,checkOrigin:!0,enablePublicMethods:!1,heightCalculationMethod:"offset",interval:32,log:!1,maxHeight:1/0,maxWidth:1/0,minHeight:0,minWidth:0,scrolling:!1,sizeHeight:!0,sizeWidth:!1,tolerance:0,closedCallback:function(){},initCallback:function(){},messageCallback:function(){},resizedCallback:function(){}};k();o(window,"message",d);"jQuery"in window&&nt(jQuery);"function"==typeof define&&define.amd?define(function(){return y()}):window.iFrameResize=y()}();Array.prototype.forEach||(Array.prototype.forEach=function(n){"use strict";var t;if(this===void 0||this===null||typeof n!="function")throw new TypeError;var i=Object(this),r=i.length>>>0,u=arguments.length>=2?arguments[1]:void 0;for(t=0;t<r;t++)t in i&&n.call(u,i[t],t,i)});$(document).ready(function(){$("iframe.responsive").iFrameResize({log:!1,checkOrigin:!1})});$(document).ready(function(){sendDimensions();__iframe!==undefined&&(__iframe.addEventListener?__iframe.addEventListener("load",sendDimensions,!1):__iframe.attachEvent("onload",sendDimensions))});$(window).scroll(function(){sendDimensions()});$(window).resize(function(){sendDimensions()});const BREAKPOINT_SM=576,BREAKPOINT_MD=768,BREAKPOINT_LG=992,BREAKPOINT_XL=1200,BREAKPOINT_XXL=1440;let LAST_SCROLL_TOP=$(window).scrollTop(),LAST_SCROLL_TOP_INPAGENAV=$(window).scrollTop(),RADIALS_ARE_DESKTOP_SIZE=!1,SHOW_NAV=!0;(function(n){n(document).ready(function(){if(location.hash){if(n(".js-intersection-fade-group").length){const t=n(".js-intersection-fade-group");t.each(function(){const t=n(this);t.addClass("is-inview").removeAttr("data-fade-order");const i=t.find("[data-fade-order]");i.length&&i.removeAttr("data-fade-order")})}setTimeout(function(){var i,t;window.scrollTo(0,0);i=location.hash;n(i).length&&(t=n(i).offset().top,t-=n(document).scrollTop()<=t?0:n(".js-nav").outerHeight(),scrollToTopPos(t,0))},1)}n(".js-slick-featured-content").length&&n(".js-slick-featured-content").each(function(){function f(n){u.on("click",function(){const i=n.slideCount-1,t=n.currentSlide,r=t===i?0:t+1;n.slickGoTo(r)})}const t=n(this),i=t.find(".slick-next"),r=t.find(".slick-prev"),u=t.find(".js-featured-content-cycle-carousel");t.on("init",function(n,t){f(t)});t.slick({nextArrow:i,prevArrow:r,infinite:!1,dots:!1,fade:!0,speed:600,cssEase:"ease-in-out"}).on("beforeChange",function(n,i,r,u){updateCarouselPagination(t,u)})});n(".js-slick-news-carousel").length&&n(".js-slick-news-carousel").each(function(){const i=n(this),t=n(this).closest(".js-news-carousel"),r=t.find(".slick-next"),u=t.find(".slick-prev");i.slick({nextArrow:r,prevArrow:u,mobileFirst:!0,slidesToShow:1,infinite:!1,slidesToScroll:1,speed:600,cssEase:"ease-out",responsive:[{breakpoint:BREAKPOINT_MD-1,settings:{slidesToShow:1.15}},{breakpoint:BREAKPOINT_XL-1,settings:{slidesToShow:2.4}}]})});n(".js-slick-case-study").length&&n(".js-slick-case-study").each(function(){const t=n(this),i=n(this).closest(".js-case-study"),r=i.find(".slick-next"),u=i.find(".slick-prev");t.on("init",function(){adjustBoxHeights(t)});t.on("reInit",function(){adjustBoxHeights(t)});n(this).hasClass("js-slick-case-study-titles")?t.slick({nextArrow:r,prevArrow:u,slidesToShow:1,infinite:!0,slidesToScroll:1,variableWidth:!1,centerMode:!0,centerPadding:"16px",mobileFirst:!0,dots:!0,responsive:[{breakpoint:BREAKPOINT_MD,settings:{centerPadding:"36px",variableWidth:!0}}],customPaging:function(n,t){var i=n.$slides.eq(t).find("h2").text();return'<span class="b-case-study-carousel-dots-titles">'+i+"<\/span>"}}):t.slick({nextArrow:r,prevArrow:u,slidesToShow:1,infinite:!0,slidesToScroll:1,variableWidth:!1,centerMode:!0,centerPadding:"16px",mobileFirst:!0,dots:!0,responsive:[{breakpoint:BREAKPOINT_MD,settings:{centerPadding:"36px",variableWidth:!0}}]})});n(".js-media-carousel").length&&n(".js-media-carousel").each(function(){initMediaCarouselAria(n(this));const t=n(this).find(".js-slick-media-carousel-text");t.length&&t.slick({arrows:!1,dots:!1,autoplay:!1,draggable:!1,fade:!0,infinite:!1,speed:600,touchMove:!1})});n(".js-pyramid").length&&n(".js-pyramid").each(function(){initPyramidCarousel(n(this))});n(".js-signpost-item").length&&n(window).outerWidth()>=BREAKPOINT_XL&&n(".js-signpost-item").each(function(){animateSignpostOut(n(this))});n(".js-form-signup").length&&n(".js-form-signup").each(function(){const i=n(this).find("form"),r=i.find('input[type="submit"]'),u='<button type="submit" class="btn btn-brand">'+r.val()+'<img class="m-filter m-filter-white" src="/Images/Arrows/Black/arrow-right.svg" alt="Arrow right icon"><\/button>',t=i.find('input[type="email"]');t.closest(".umbraco-forms-field-wrapper").prepend("<div class='e-form-signup-email'><\/div>");t.closest(".umbraco-forms-field-wrapper").find(".e-form-signup-email").prepend(t).append(u);n(this).addClass("is-js")});n(".js-form-signup-panel").length&&n(".js-form-signup-panel").each(function(){const t=n(this).find("form"),u=t.find('input[type="submit"]'),e=t.find(".privacypolicy p").html(),i=t.find(".umbraco-forms-field.yesigivepermissiontostoreandprocessmydata");i.prepend("<div class='e-form-signup-checkbox'><\/div>");i.find("label.umbraco-forms-label").append(e);const o=i.find('input[type="checkbox"]'),s=i.find("label.umbraco-forms-label");i.find(".e-form-signup-checkbox").prepend(o).append(s);const f='<button type="submit" class="btn btn-brand">'+u.val()+'<img class="m-filter m-filter-white" src="/Images/Arrows/Black/arrow-right.svg" alt="Arrow right icon"><\/button>';u.after(f);const r=t.find('input[type="email"]'),h=t.find(".umbraco-forms-field.email label.umbraco-forms-label");r.closest(".umbraco-forms-field-wrapper").prepend("<div class='e-form-signup-email'><\/div>");r.closest(".umbraco-forms-field-wrapper").find(".e-form-signup-email").prepend(r).prepend(h).append(f);n(this).addClass("is-js")});n(".js-hero-play").on("click",function(t){t.preventDefault();n(".js-hero-content").fadeOut()});n(".js-news-carousel .js-carousel-next").on("click",function(t){t.preventDefault();n(this).closest(".js-news-carousel").find(".carousel").carousel("next")});n(".js-news-carousel .js-carousel-prev").on("click",function(t){t.preventDefault();n(this).closest(".js-news-carousel").find(".carousel").carousel("prev")});if(n("#modal-video").length){const t=new bootstrap.Modal("#modal-video"),i=document.getElementById("modal-video");i.addEventListener("hidden.bs.modal",()=>{n("#modal-video-iframe").attr("src","")});n(".js-play, .js-hero-play").on("click",function(i){i.preventDefault();var r=n(this).data("video-id"),u=n(this).data("video-hash");n("#modal-video-iframe").attr("src","https://player.vimeo.com/video/"+r+"?h="+u+"&dnt=1");t.show()});n(".modal-close").on("click",function(){n(".js-hero-content").length&&n(".js-hero-content").fadeIn()})}n(".js-video-autoplay-controls").on("click",function(){n(this).data("js-video-autoplay-status")!="paused"?(n(this).closest("section").find("video[autoplay]")[0].pause(),n("html").addClass("prefers-reduce-motion"),n(this).addClass("play").data("js-video-autoplay-status","paused"),n(this).find("span").text("play")):(n("html").removeClass("prefers-reduce-motion"),n(this).removeClass("play").data("js-video-autoplay-status","playing"),n(this).closest("section").find("video[autoplay]")[0].play(),n(this).find("span").text("pause"))});n(".js-infographic-next").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-infographic"),u=i.find(".js-infographic-item"),f=u.length-1,r=i.find(".js-infographic-item.is-active").index(),e=r===f?0:r+1;cycleInfographic(i,r,e)});n(".js-infographic-prev").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-infographic"),u=i.find(".js-infographic-item"),f=u.length-1,r=i.find(".js-infographic-item.is-active").index(),e=r===0?f:r-1;cycleInfographic(i,r,e)});n(".js-infographic-cycle").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-infographic"),r=i.find(".js-infographic-item.is-active").index(),u=n(this).index();cycleInfographic(i,r,u)});n(".js-complex-acrdn-toggle").on("click",function(t){t.preventDefault();const u=400,f=n(this).closest(".js-complex-acrdn"),i=n(this).closest(".js-complex-acrdn-item"),r=n(this).closest(".js-complex-acrdn-container");r.addClass("is-open");r.attr("data-active-item",i.index()+1);i.toggleClass("wide");f.find(".js-complex-acrdn-item.is-active").not(i).each(function(){n(this).removeClass("wide");n(this).find(".js-complex-acrdn-text").slideUp(u);n(this).removeClass("is-active");n(this).find(".js-accordion-control").removeClass("e-control-accordion-close")});i.find(".js-complex-acrdn-text").slideToggle(u,function(){i.toggleClass("is-active")});i.find(".js-accordion-control").toggleClass("e-control-accordion-close");!f.find(".js-complex-acrdn-item").not(i).hasClass("is-active")&&i.hasClass("is-active")&&r.removeClass("is-open")});n(".js-animated-accordion-toggle").on("click",function(){function o(){r.addClass("is-open");t.toggleClass("mod");r.find(".js-animated-accordion-item.is-open").not(t).each(function(){n(this).removeAttr("style");n(this).find(".js-animated-accordion-content").slideUp(i);n(this).removeClass("is-open mod");n(this).find(".js-animated-accordion-toggle").removeClass("is-open has-fade")});f.slideToggle(i,function(){t.toggleClass("is-open");t.removeAttr("style");u.removeClass("has-fade")});!r.find(".js-animated-accordion-item").not(t).hasClass("is-open")&&t.hasClass("is-open")&&r.removeClass("is-open")}function s(){if(t.stop(),r.find(".js-animated-accordion-item.is-open").not(t).each(function(){const t=n(this);t.find(".js-animated-accordion-content").slideUp(i);t.removeClass("is-open mod");t.find(".js-animated-accordion-toggle").removeClass("is-open");t.animate({now:1},{duration:i,easing:"linear",step:function(t){n(this).css({"flex-grow":t})},complete:function(){t.find(".js-animated-accordion-toggle").removeClass("has-fade")}})}),t.toggleClass("mod is-open"),e)f.slideUp(i),t.animate({now:1},{duration:i,easing:"linear",step:function(t){n(this).css({"flex-grow":t})},complete:function(){u.removeClass("has-fade")}});else{const o=e?1:r.find(".js-animated-accordion-item").length;u.addClass("has-fade");t.animate({now:o},{duration:i,easing:"linear",step:function(t){n(this).css({"flex-grow":t})},complete:function(){f.slideDown(i)}})}}const i=400,u=n(this),r=n(this).closest(".js-animated-accordion-list"),t=n(this).closest(".js-animated-accordion-item"),f=t.find(".js-animated-accordion-content"),e=u.hasClass("is-open");u.toggleClass("is-open");n(window).outerWidth()>=BREAKPOINT_XL?s():o()});n(".js-animated-accordion-close").on("click",function(){const t=n(this).closest(".js-animated-accordion-item");t.find(".js-animated-accordion-toggle").click()});n(".js-footer-accordion-toggle").on("click",function(t){t.preventDefault();const u=n(this),i=n(this).closest(".js-footer-accordion"),r=i.find(".js-footer-accordion-content"),f=u.hasClass("is-active");u.toggleClass("is-active");r.stop();f?r.slideUp(400,function(){n(this).removeAttr("style");i.removeClass("is-active")}):r.slideDown(400,function(){n(this).removeAttr("style");i.addClass("is-active")})});n(".js-in-page-nav-item a").on("click",function(t){t.preventDefault();const i=n(this).attr("href");if(updateActivePageNav(i),n(i).length){var r=n(i).offset().top;r-=n(document).scrollTop()<=r?0:n(".js-nav").outerHeight();scrollToTopPos(r,0)}});n(".js-media-carousel-next").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-media-carousel"),r=i.find(".js-media-carousel-item.item-center").index();rotateMediaCarousel(i,r,!0)});n(".js-media-carousel-prev").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-media-carousel"),r=i.find(".js-media-carousel-item.item-center").index();rotateMediaCarousel(i,r,!1)});n(".js-nav-open").on("click",function(t){t.preventDefault();n("html, body").addClass("m-preventScrolling");n(".js-nav").addClass("mob-menu-open");n(".js-nav-overlay").fadeIn(400)});n(".js-nav-close").on("click",function(t){t.preventDefault();n(".m-preventScrolling").removeClass("m-preventScrolling");n(".js-nav").removeClass("mob-menu-open");n(".js-nav-overlay").fadeOut(400);n(".js-nav-menu .is-open").each(function(){n(this).removeClass("is-open")})});n("body").on("click",".js-nav.mob-menu-open .js-nav-item.has-subnav > a",function(t){t.preventDefault();var i=n(this).closest(".js-nav-item").data("nav"),r='.js-nav-screen[data-nav-screen="'+i+'"]';n(r).addClass("is-open")});n(".js-nav-back").on("click",function(t){t.preventDefault();n(this).closest(".js-nav-screen").removeClass("is-open")});n(".js-nav-search").on("click",function(t){t.preventDefault();n(".js-nav").toggleClass("is-solid");n(".js-nav-search-bar").slideToggle(400,function(){n(this).toggleClass("is-active").removeAttr("style");n(".b-nav-search-bar-input").focus()})});n(".js-profiles-toggle").on("click",function(t){t.preventDefault();const r=400,u=n(this).closest(".js-profiles"),i=n(this).closest(".js-profiles-item"),f=i.find(".js-profiles-control"),e=i.find(".js-profiles-bio");u.find(".js-profiles-item.is-active").not(i).each(function(){n(this).find(".js-profiles-control").removeClass("e-control-accordion-close");n(this).find(".js-profiles-bio").slideUp(r);n(this).removeClass("is-active")});f.toggleClass("e-control-accordion-close");e.slideToggle(r);i.toggleClass("is-active")});n(".js-profiles-close").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-profiles-item");i.find(".js-profiles-toggle").click()});n("body").on("click",function(t){n(t.target).closest(".js-select").length==0&&n(".js-select.is-active").length&&n(".js-select.is-active").each(function(){closeSelect(n(this))})});n(".js-select-selected").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-select"),r=i.find(".js-select-dropdown");n(".js-select.is-active").not(i).each(function(){closeSelect(n(this))});n(this).toggleClass("is-active");r.slideToggle(400,function(){n(this).removeAttr("style");i.toggleClass("is-active")})});n(".js-select:not(.js-select-multi) .js-select-option").on("click",function(t){t.preventDefault();const r=n(this),i=n(this).closest(".js-select");i.find(".js-select-option.is-active").not(r).removeClass("is-active");r.toggleClass("is-active");updateSelectValue(i);closeSelect(i)});n(".js-select.js-select-multi .js-select-option").on("click",function(t){t.preventDefault();const i=n(this),r=n(this).closest(".js-select");i.toggleClass("is-active");updateSelectValue(r)});n(".js-people-view-grid").on("click",function(t){t.preventDefault();n(this).siblings().removeClass("is-active");n(this).addClass("is-active");n(this).closest(".js-people").removeClass("b-people-list")});n(".js-people-view-list").on("click",function(t){t.preventDefault();n(this).siblings().removeClass("is-active");n(this).addClass("is-active");n(this).closest(".js-people").addClass("b-people-list")});n(".js-tabs-accordion-btn").on("click",function(){const i=n(this).closest(".js-tabs"),r=i.find(".js-tabs-btn"),u=i.find(".js-tabs-accordion-item"),f=n(this).closest(".js-tabs-accordion-item").index(),t=r.eq(f),e=u.eq(f);t.hasClass("is-active")||(r.not(t).each(function(){n(this).removeClass("is-active")}),t.addClass("is-active"),u.not(e).each(function(){n(this).removeClass("is-active")}),e.addClass("is-active"))});n(".js-tabs-btn").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-tabs"),r=i.find(".js-tabs-accordion-item"),u=n(this).index();r.eq(u).find(".js-tabs-accordion-btn").click()});n(".js-results-preview").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-results-preview-item");if(!i.hasClass("is-active")){const o=i.find(".js-results-preview-embed").html(),f=n(this).closest(".js-results"),r=f.find(".js-results-playing"),s=f.find(".js-results-preview-item");s.not(i).each(function(){n(this).removeClass("is-active")});i.addClass("is-active");r.addClass("is-active");r.html(o);const e=r.find("iframe");let u=e.attr("src");u+=u.indexOf("?")!=-1?"&autoplay=1   ":"?autoplay=1";e.attr("src",u)}});n(".js-results-play").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-results");i.find(".js-results-preview").eq(0).click()});n(".js-divisions-item-toggle").on("click",function(t){t.preventDefault();divisionsToggle(n(this))});n(".js-framework-item-toggle").on("click",function(t){t.preventDefault();const f=n(this).closest(".js-framework"),e=f.find(".js-framework-item.is-active"),i=n(this).closest(".js-framework-item"),o=i.find(".js-framework-item-content"),s=i.find(".js-framework-accordion-btn"),r="e-control-accordion-close",u=400;e.not(i).each(function(){const t=n(this),i=t.find(".js-framework-item-content"),f=t.find(".js-framework-accordion-btn");f.removeClass(r);i.slideUp(u,function(){n(this).removeAttr("style");t.removeClass("is-active")})});s.toggleClass(r);o.slideToggle(u,function(){n(this).removeAttr("style");i.toggleClass("is-active")})});n(".js-framework-prev").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-framework"),u=i.find(".js-framework-item"),f=u.length-1,r=i.find(".js-framework-item.is-active").data("framework-index"),e=r===0?f:r-1;cycleFramework(i,e)});n(".js-framework-next").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-framework"),u=i.find(".js-framework-item"),f=u.length-1,r=i.find(".js-framework-item.is-active").data("framework-index"),e=r===f?0:r+1;cycleFramework(i,e)});n(".js-framework-diamond-interact").on("click",function(t){if(t.preventDefault(),!(n(window).outerWidth()<BREAKPOINT_MD)){const u=n(this).closest(".js-framework"),i=u.find(".js-framework-info"),r=n(this).closest(".js-framework-diamond"),f=u.find(".js-framework-diamond.is-active"),e=400;if(f.not(r).each(function(){const t=n(this).data("framework-item"),i=n('.js-framework-item[data-framework-diamond="'+t+'"]');n(this).removeClass("is-active");i.removeClass("is-active")}),f.length||i.fadeIn(e,function(){i.removeAttr("style").addClass("is-active")}),r.hasClass("is-active"))i.fadeOut(e,function(){i.removeAttr("style").removeClass("is-active")});else{const t=r.data("framework-item"),i=n('.js-framework-item[data-framework-diamond="'+t+'"]'),f=i.data("framework-index");cycleFramework(u,f)}r.toggleClass("is-active")}});n(".js-framework-close").on("click",function(t){t.preventDefault();n(this).closest(".js-framework").find(".js-framework-diamond.is-active").each(function(){n(this).removeClass("is-active")});n(this).closest(".js-framework-info").fadeOut(400,function(){n(this).removeAttr("style").removeClass("is-active")})});n(".js-framework-option").on("click",function(t){t.preventDefault();const i=n(this),r=i.closest(".js-framework");if(!i.hasClass("is-active")){const f=i.data("framework-intro"),u=n('.js-framework-intro-option[data-framework-intro-option="'+f+'"]');r.find(".js-framework-option.is-active").not(i).each(function(){n(this).removeClass("is-active")});r.find(".js-framework-intro-option.is-active").not(u).each(function(){n(this).removeClass("is-active")});i.addClass("is-active");u.addClass("is-active")}});n(".js-value-engine-toggle").on("click",function(t){t.preventDefault();const i=n(this);valueEngineClickEvents(i)});n(".js-value-engine-reveal-close").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-value-engine");i.find(".is-active").removeClass("is-active");i.find(".is-hidden").removeClass("is-hidden")});n(".js-val-eng-toggle").on("click",function(t){t.preventDefault();const i=n(this),f=i.closest(".js-val-eng"),r=i.closest(".js-val-eng-item"),e=f.find(".js-val-eng-item.is-active"),o=r.find(".js-val-eng-content"),u=400;e.not(r).each(function(){const t=n(this);t.find(".js-val-eng-toggle").removeClass("is-active");t.find(".js-val-eng-content").slideUp(u,function(){n(this).removeAttr("style");t.removeClass("is-active")})});i.toggleClass("is-active");o.slideToggle(u,function(){n(this).removeAttr("style");r.toggleClass("is-active")})});n(".js-language").on("click",function(t){t.preventDefault();n(this).toggleClass("is-active");n(this).next(".js-language-menu").slideToggle(400)});n(".js-copy-url").on("click",function(t){t.preventDefault();const r=window.location.href,i=n(".js-url-copied");document.addEventListener("copy",function(n){n.clipboardData.setData("text/plain",r);n.preventDefault()},!0);document.execCommand("copy");i.stop();i.fadeIn(200,function(){i.delay(500).fadeOut(200)})});n(".js-jobs-language-select").on("click",function(t){t.preventDefault();const i=n(this).closest(".js-jobs-language");i.toggleClass("is-active");i.find(".js-jobs-language-menu").slideToggle(400)});n(".accordion-collapse").length&&n(".accordion-collapse").each(function(){const i=n(this).closest(".accordion-item"),t=n(this).get(0);t.addEventListener("show.bs.collapse",()=>{SHOW_NAV=!1});t.addEventListener("shown.bs.collapse",()=>{scrollToTopPos(i.offset().top,0)})});n(".js-signpost-item").on("mouseenter",function(){const t=n(this);animateSignpostIn(t)}).on("mouseleave",function(){const t=n(this);animateSignpostOut(t)});n(".js-featured-grid-item").on("mouseenter",function(){const t=n(this);animateFeaturedGridIn(t)}).on("mouseleave",function(){const t=n(this);animateFeaturedGridOut(t)});n(".js-in-page-nav").length&&inPageNavMouseEvents();n(".js-nav").length&&navMouseEvents();n(".js-behaviours-interact").on("mouseenter",function(){const t=n(this).closest(".js-behaviours-petal"),i=t.index(),r=n(this).closest(".js-behaviours");t.addClass("is-active");r.find(".js-behaviours-item").eq(i).addClass("is-active")}).on("mouseleave",function(){const t=n(this).closest(".js-behaviours-petal"),i=t.index(),r=n(this).closest(".js-behaviours");t.removeClass("is-active");r.find(".js-behaviours-item").eq(i).removeClass("is-active")});if(n(".js-intersection-in-page-nav").length){const t=n(".js-intersection-in-page-nav"),i=t.length-1;function r(n){for(const r of n)r.target==t[0]&&r.boundingClientRect.top>0&&resetPageNav(),r.target==t[i]&&r.boundingClientRect.top<=0&&resetPageNav(),r.isIntersecting&&updateActivePageNav(r.target.id)}const u=new IntersectionObserver(r,{root:null,threshold:[.4],rootMargin:"0px"});for(let n=0;n<t.length;n++)u.observe(t[n])}if(n(".js-copy-table-to-clipboard").length)n(".js-copy-table-to-clipboard").on("click",function(t){t.preventDefault();n(this).parent().find("table").select();navigator.clipboard.writeText(n(this).parent().find(".table-responsive").html());alert("Copied to clipboard.\r\nYou can now paste into a spreadsheet for further analysis.")})});n(window).on("resize",function(){n(".js-nav").length&&(navCleanseMob(),navCleanseDesk());n(window).outerWidth()>=BREAKPOINT_XL&&n(".js-animated-accordion-list.is-open")&&n(".js-animated-accordion-list.is-open").each(function(){n(this).removeClass("is-open");n(this).find(".is-open").removeClass("is-open");n(this).find("[style]").removeAttr("style");n(this).find(".mod").removeClass("mod")});n(".js-radial-random-container").length&&n(".m-radial-random").length&&radials(!0);n(".js-signpost-item").length&&n(window).outerWidth()>=BREAKPOINT_XL&&n(".js-signpost-item").each(function(){animateSignpostOut(n(this))});n(".js-slick-case-study").length&&n(".js-slick-case-study").each(function(){const t=n(this);t.find(".b-case-study-item").css("opacity","1");t.slick("setPosition");adjustBoxHeights(t)})});n(window).on("scroll",function(){if(n(".js-nav").length&&(navScroll(),navBackground()),n(".js-in-page-nav").length){const t=n(window).scrollTop();t>0&&t>LAST_SCROLL_TOP_INPAGENAV?n(".js-in-page-nav").offset().top<t&&!n(".js-in-page-nav").hasClass("is-floating")&&n(".js-in-page-nav").addClass("is-floating"):n(".js-in-page-nav").offset().top>=t&&n(".js-in-page-nav").hasClass("is-floating")&&n(".js-in-page-nav").removeClass("is-floating");LAST_SCROLL_TOP_INPAGENAV=t}});n(window).on("load",function(){if(n(".js-intersection-fade-group").length){const t=n(".js-intersection-fade-group");function i(n){for(const t of n){const n=t.target.classList.contains("is-inview");if(n)return;(t.isIntersecting||t.boundingClientRect.top<=0)&&(t.target.classList.add("is-inview"),executeGroupFade(t.target))}}const r=new IntersectionObserver(i,{root:null,threshold:0,rootMargin:"0px"});for(let n=0;n<t.length;n++)r.observe(t[n])}n(".js-radial-random-container").length&&radials(!1);n(".m-spacing").length&&notches()})})(jQuery);ajaxSearchProgress=null;ajaxSearchAutocompleteProgress=null,function(n){n(document).ready(function(){accessibilityFixes();ajaxFiltersInit(n(".js-people"),"/umbraco/surface/people/getitems");ajaxFiltersInit(n(".js-news"),"/umbraco/surface/news/getitems");ajaxFiltersInit(n(".js-smithsleadersblog"),"/umbraco/surface/smithsleadersblog/getitems");ajaxFiltersInit(n(".js-engineeringexplained"),"/umbraco/surface/engineeringexplained/getitems");ajaxFiltersInit(n(".js-insights"),"/umbraco/surface/insights/getitems");ajaxFiltersInit(n(".js-results"),"/umbraco/surface/results/getitems");ajaxFiltersInit(n(".js-job-search"),"/umbraco/surface/jobsearch/getitems");n(".js-filters-back").on("click",function(n){n.preventDefault();history.back()});n(".js-search-result-filters").on("click","a",function(t){(t.preventDefault(),n(this).hasClass("is-active"))||(n(this).siblings().removeClass("is-active"),n(this).addClass("is-active"),ajaxSearch(!1,!0))});n(".js-search-search").on("submit",function(n){n.preventDefault();ajaxSearch(!1,!0)});n(".js-search .js-search-result-load").on("click",function(n){n.preventDefault();ajaxSearch(!0,!1)});if(n(".js-events-item").length)n(".js-events-item").on("click",function(t){t.preventDefault();var i=slugify(n(this).closest("tr").find("td:eq(1)").text())+".ics";n.ajax({url:"/umbraco/api/events/generateicsfile",type:"POST",data:{id:n(this).data("id")},success:function(t){var r=n("<a />");r.attr("download",i);r.attr("href","data:text/calendar;base64,"+t);n("body").append(r);r[0].click();r[0].remove()},error:function(){},complete:function(){}})})});n(window).on("load",function(){})}(jQuery)
=======
!(function () {
  "use strict";
  function o(n, t, i) {
  ...
  function d(r) {
    ...
    function nt() {
      ...
      n.messageCallback({ iframe: f.iframe, message: i });
      t(" --");
    }
    function tt() {
      if (null === f.iframe)
        throw new Error("iFrame (" + f.id + ") does not exist on " + b);
      return !0;
    }
    function rt() {
      t(" Reposition requested from iFrame");
      i = { x: f.width, y: f.height };
      s();
    }
    function ut() {
      switch (f.type) {
  ...
  function g() {
    null === i &&
      ...
      t(" Get position: " + i.x + "," + i.y));
  }
  function s() {
    null !== i &&
      (window.scrollTo(i.x, i.y),
      t(" Set position: " + i.x + "," + i.y),
      (i = null));
  }
  function h(n) {
    function i() {
      c(n);
      e("reset", "reset", n.iframe);
    }
    t(
  ...
  function a() {
    ...
    function a(t) {
      o(i, "load", function () {
        ...
        e("iFrame.onload", t, i);
        !r &&
          n.heightCalculationMethod in rt &&
          h({ iframe: i, height: 0, width: 0, type: "init" });
      });
      e("init", t, i);
    }
    var i = this,
  ...
  function v(n) {
    if ("object" != typeof n) throw new TypeError("Options is not an object.");
  }
  function y() {
    function t(n) {
    ...
    return function (n, r) {
      i(n);
      Array.prototype.forEach.call(document.querySelectorAll(r || "iframe"), t);
    };
  }
  function nt(t) {
    t.fn.iFrameResize = function (i) {
      return (
        (i = i || {}),
        v(i),
        (n = t.extend({}, f, i)),
        this.filter("iframe").each(a).end()
      );
    };
  }
  var tt = 0,
    ...
    rt = { max: 1, scroll: 1, bodyScroll: 1, documentElementScroll: 1 },
    n = {},
    f = {
      autoResize: !0,
      bodyBackground: null,
  ...
  k();
  o(window, "message", d);
  "jQuery" in window && nt(jQuery);
  "function" == typeof define && define.amd
    ? define(function () {
        return y();
      })
    : (window.iFrameResize = y());
})();
Array.prototype.forEach ||
  (Array.prototype.forEach = function (n) {
    "use strict";
    var t;
    if (this === void 0 || this === null || typeof n != "function")
      throw new TypeError();
    var i = Object(this),
      r = i.length >>> 0,
      u = arguments.length >= 2 ? arguments[1] : void 0;
    for (t = 0; t < r; t++) t in i && n.call(u, i[t], t, i);
  });
$(document).ready(function () {
  $("iframe.responsive").iFrameResize({ log: !1, checkOrigin: !1 });
});
$(document).ready(function () {
  sendDimensions();
  __iframe !== undefined &&
    (__iframe.addEventListener
      ? __iframe.addEventListener("load", sendDimensions, !1)
...
let LAST_SCROLL_TOP = $(window).scrollTop(),
  LAST_SCROLL_TOP_INPAGENAV = $(window).scrollTop(),
  RADIALS_ARE_DESKTOP_SIZE = !1,
  SHOW_NAV = !0;
(function (n) {
  n(document).ready(function () {
    if (location.hash) {
      if (n(".js-intersection-fade-group").length) {
        const t = n(".js-intersection-fade-group");
        t.each(function () {
          const t = n(this);
          t.addClass("is-inview").removeAttr("data-fade-order");
          const i = t.find("[data-fade-order]");
          i.length && i.removeAttr("data-fade-order");
        });
      }
      setTimeout(function () {
        var i, t;
        ...
        n(i).length &&
          ((t = n(i).offset().top),
          (t -= n(document).scrollTop() <= t ? 0 : n(".js-nav").outerHeight()),
          scrollToTopPos(t, 0));
      }, 1);
    }
    n(".js-slick-featured-content").length &&
      n(".js-slick-featured-content").each(function () {
        function f(n) {
          u.on("click", function () {
            const i = n.slideCount - 1,
              t = n.currentSlide,
              r = t === i ? 0 : t + 1;
            n.slickGoTo(r);
          });
        ...
        const t = n(this),
          i = t.find(".slick-next"),
          r = t.find(".slick-prev"),
          u = t.find(".js-featured-content-cycle-carousel");
        ...
        t.slick({
          ...
          speed: 600,
          cssEase: "ease-in-out",
        }).on("beforeChange", function (n, i, r, u) {
          updateCarouselPagination(t, u);
        });
      });
    n(".js-slick-news-carousel").length &&
      n(".js-slick-news-carousel").each(function () {
        const i = n(this),
          t = n(this).closest(".js-news-carousel"),
          r = t.find(".slick-next"),
          u = t.find(".slick-prev");
        i.slick({
          nextArrow: r,
          ...
          cssEase: "ease-out",
          responsive: [
            { breakpoint: BREAKPOINT_MD - 1, settings: { slidesToShow: 1.15 } },
            { breakpoint: BREAKPOINT_XL - 1, settings: { slidesToShow: 2.4 } },
          ],
        });
      });
    n(".js-slick-case-study").length &&
      n(".js-slick-case-study").each(function () {
        const t = n(this),
          i = n(this).closest(".js-case-study"),
          r = i.find(".slick-next"),
          u = i.find(".slick-prev");
        t.on("init", function () {
          adjustBoxHeights(t);
        });
        t.on("reInit", function () {
          adjustBoxHeights(t);
        });
        n(this).hasClass("js-slick-case-study-titles")
          ? t.slick({
              nextArrow: r,
              prevArrow: u,
              slidesToShow: 1,
              ...
              responsive: [
                {
                  ...
                  settings: { centerPadding: "36px", variableWidth: !0 },
                },
              ],
              customPaging: function (n, t) {
                var i = n.$slides.eq(t).find("h2").text();
                return (
                  '<span class="b-case-study-carousel-dots-titles">' +
                  i +
                  "<\/span>"
                );
              },
    ...
    n(".js-media-carousel").length &&
      n(".js-media-carousel").each(function () {
        initMediaCarouselAria(n(this));
        const t = n(this).find(".js-slick-media-carousel-text");
        t.length &&
          t.slick({
            arrows: !1,
            dots: !1,
    ...
    n(".js-pyramid").length &&
      n(".js-pyramid").each(function () {
        initPyramidCarousel(n(this));
      });
    n(".js-signpost-item").length &&
      n(window).outerWidth() >= BREAKPOINT_XL &&
      n(".js-signpost-item").each(function () {
        animateSignpostOut(n(this));
      });
    n(".js-form-signup").length &&
      n(".js-form-signup").each(function () {
        const i = n(this).find("form"),
          r = i.find('input[type="submit"]'),
          u =
            '<button type="submit" class="btn btn-brand">' +
            r.val() +
            '<img class="m-filter m-filter-white" src="/Images/Arrows/Black/arrow-right.svg" alt="Arrow right icon"><\/button>',
          t = i.find('input[type="email"]');
        t.closest(".umbraco-forms-field-wrapper").prepend(
          "<div class='e-form-signup-email'><\/div>",
        );
        t.closest(".umbraco-forms-field-wrapper")
          .find(".e-form-signup-email")
          .prepend(t)
          .append(u);
        n(this).addClass("is-js");
      });
    n(".js-form-signup-panel").length &&
      n(".js-form-signup-panel").each(function () {
        const t = n(this).find("form"),
          u = t.find('input[type="submit"]'),
          e = t.find(".privacypolicy p").html(),
          i = t.find(
            ".umbraco-forms-field.yesigivepermissiontostoreandprocessmydata",
          );
        i.prepend("<div class='e-form-signup-checkbox'><\/div>");
        i.find("label.umbraco-forms-label").append(e);
        const o = i.find('input[type="checkbox"]'),
          s = i.find("label.umbraco-forms-label");
        i.find(".e-form-signup-checkbox").prepend(o).append(s);
        const f =
          '<button type="submit" class="btn btn-brand">' +
          u.val() +
          '<img class="m-filter m-filter-white" src="/Images/Arrows/Black/arrow-right.svg" alt="Arrow right icon"><\/button>';
        u.after(f);
        const r = t.find('input[type="email"]'),
          h = t.find(".umbraco-forms-field.email label.umbraco-forms-label");
        r.closest(".umbraco-forms-field-wrapper").prepend(
          "<div class='e-form-signup-email'><\/div>",
        );
        r.closest(".umbraco-forms-field-wrapper")
          .find(".e-form-signup-email")
          .prepend(r)
          .prepend(h)
          .append(f);
    ...
    n(".js-hero-play").on("click", function (t) {
      t.preventDefault();
      n(".js-hero-content").fadeOut();
    });
    n(".js-news-carousel .js-carousel-next").on("click", function (t) {
      t.preventDefault();
      n(this).closest(".js-news-carousel").find(".carousel").carousel("next");
    });
    n(".js-news-carousel .js-carousel-prev").on("click", function (t) {
      t.preventDefault();
      n(this).closest(".js-news-carousel").find(".carousel").carousel("prev");
    });
    if (n("#modal-video").length) {
      const t = new bootstrap.Modal("#modal-video"),
        i = document.getElementById("modal-video");
      i.addEventListener("hidden.bs.modal", () => {
        n("#modal-video-iframe").attr("src", "");
      });
      n(".js-play, .js-hero-play").on("click", function (i) {
        i.preventDefault();
        var r = n(this).data("video-id"),
          u = n(this).data("video-hash");
        n("#modal-video-iframe").attr(
          "src",
          "https://player.vimeo.com/video/" + r + "?h=" + u + "&dnt=1",
        );
        t.show();
      });
      n(".modal-close").on("click", function () {
        n(".js-hero-content").length && n(".js-hero-content").fadeIn();
      });
    }
    n(".js-video-autoplay-controls").on("click", function () {
      n(this).data("js-video-autoplay-status") != "paused"
        ? (n(this).closest("section").find("video[autoplay]")[0].pause(),
          n("html").addClass("prefers-reduce-motion"),
          n(this).addClass("play").data("js-video-autoplay-status", "paused"),
          n(this).find("span").text("play"))
        : (n("html").removeClass("prefers-reduce-motion"),
          n(this)
            .removeClass("play")
            .data("js-video-autoplay-status", "playing"),
          n(this).closest("section").find("video[autoplay]")[0].play(),
          n(this).find("span").text("pause"));
    });
    n(".js-infographic-next").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-infographic"),
        u = i.find(".js-infographic-item"),
        f = u.length - 1,
        r = i.find(".js-infographic-item.is-active").index(),
        e = r === f ? 0 : r + 1;
      cycleInfographic(i, r, e);
    });
    n(".js-infographic-prev").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-infographic"),
        u = i.find(".js-infographic-item"),
        f = u.length - 1,
    ...
    n(".js-infographic-cycle").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-infographic"),
        r = i.find(".js-infographic-item.is-active").index(),
        u = n(this).index();
      cycleInfographic(i, r, u);
    });
    n(".js-complex-acrdn-toggle").on("click", function (t) {
      t.preventDefault();
      const u = 400,
        f = n(this).closest(".js-complex-acrdn"),
        i = n(this).closest(".js-complex-acrdn-item"),
        r = n(this).closest(".js-complex-acrdn-container");
      r.addClass("is-open");
      r.attr("data-active-item", i.index() + 1);
      i.toggleClass("wide");
      f.find(".js-complex-acrdn-item.is-active")
        .not(i)
        .each(function () {
          n(this).removeClass("wide");
          n(this).find(".js-complex-acrdn-text").slideUp(u);
          n(this).removeClass("is-active");
          n(this)
            .find(".js-accordion-control")
            .removeClass("e-control-accordion-close");
        });
      i.find(".js-complex-acrdn-text").slideToggle(u, function () {
        i.toggleClass("is-active");
      });
      i.find(".js-accordion-control").toggleClass("e-control-accordion-close");
      !f.find(".js-complex-acrdn-item").not(i).hasClass("is-active") &&
        i.hasClass("is-active") &&
        r.removeClass("is-open");
    });
    n(".js-animated-accordion-toggle").on("click", function () {
      function o() {
        r.addClass("is-open");
        t.toggleClass("mod");
        r.find(".js-animated-accordion-item.is-open")
          .not(t)
          .each(function () {
            n(this).removeAttr("style");
            n(this).find(".js-animated-accordion-content").slideUp(i);
            n(this).removeClass("is-open mod");
            n(this)
              .find(".js-animated-accordion-toggle")
              .removeClass("is-open has-fade");
          });
        f.slideToggle(i, function () {
          t.toggleClass("is-open");
          t.removeAttr("style");
          u.removeClass("has-fade");
        });
        !r.find(".js-animated-accordion-item").not(t).hasClass("is-open") &&
          t.hasClass("is-open") &&
          r.removeClass("is-open");
      }
      function s() {
        if (
          (t.stop(),
          r
            .find(".js-animated-accordion-item.is-open")
            .not(t)
            .each(function () {
              const t = n(this);
              t.find(".js-animated-accordion-content").slideUp(i);
              t.removeClass("is-open mod");
              t.find(".js-animated-accordion-toggle").removeClass("is-open");
              t.animate(
                { now: 1 },
                {
                  duration: i,
                  easing: "linear",
                  step: function (t) {
                    n(this).css({ "flex-grow": t });
                  },
                  complete: function () {
                    t.find(".js-animated-accordion-toggle").removeClass(
                      "has-fade",
                    );
                  },
                },
          ...
          const o = e ? 1 : r.find(".js-animated-accordion-item").length;
          u.addClass("has-fade");
          t.animate(
            { now: o },
            {
      ...
      const i = 400,
        u = n(this),
        r = n(this).closest(".js-animated-accordion-list"),
        t = n(this).closest(".js-animated-accordion-item"),
        f = t.find(".js-animated-accordion-content"),
        e = u.hasClass("is-open");
      u.toggleClass("is-open");
      n(window).outerWidth() >= BREAKPOINT_XL ? s() : o();
    });
    n(".js-animated-accordion-close").on("click", function () {
      const t = n(this).closest(".js-animated-accordion-item");
      t.find(".js-animated-accordion-toggle").click();
    });
    n(".js-footer-accordion-toggle").on("click", function (t) {
      t.preventDefault();
      const u = n(this),
        i = n(this).closest(".js-footer-accordion"),
        r = i.find(".js-footer-accordion-content"),
        f = u.hasClass("is-active");
      ...
      f
        ...
        : r.slideDown(400, function () {
            n(this).removeAttr("style");
            i.addClass("is-active");
          });
    });
    n(".js-in-page-nav-item a").on("click", function (t) {
      t.preventDefault();
      const i = n(this).attr("href");
      if ((updateActivePageNav(i), n(i).length)) {
        var r = n(i).offset().top;
        r -= n(document).scrollTop() <= r ? 0 : n(".js-nav").outerHeight();
        scrollToTopPos(r, 0);
      }
    });
    n(".js-media-carousel-next").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-media-carousel"),
        r = i.find(".js-media-carousel-item.item-center").index();
      rotateMediaCarousel(i, r, !0);
    });
    n(".js-media-carousel-prev").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-media-carousel"),
        r = i.find(".js-media-carousel-item.item-center").index();
      rotateMediaCarousel(i, r, !1);
    });
    n(".js-nav-open").on("click", function (t) {
      t.preventDefault();
      n("html, body").addClass("m-preventScrolling");
      n(".js-nav").addClass("mob-menu-open");
      n(".js-nav-overlay").fadeIn(400);
    });
    n(".js-nav-close").on("click", function (t) {
      t.preventDefault();
      n(".m-preventScrolling").removeClass("m-preventScrolling");
      n(".js-nav").removeClass("mob-menu-open");
      n(".js-nav-overlay").fadeOut(400);
      n(".js-nav-menu .is-open").each(function () {
        n(this).removeClass("is-open");
      });
    });
    n("body").on(
      "click",
      ".js-nav.mob-menu-open .js-nav-item.has-subnav > a",
      function (t) {
        t.preventDefault();
        var i = n(this).closest(".js-nav-item").data("nav"),
          r = '.js-nav-screen[data-nav-screen="' + i + '"]';
        n(r).addClass("is-open");
      },
    );
    n(".js-nav-back").on("click", function (t) {
      t.preventDefault();
      n(this).closest(".js-nav-screen").removeClass("is-open");
    });
    n(".js-nav-search").on("click", function (t) {
      t.preventDefault();
      n(".js-nav").toggleClass("is-solid");
      n(".js-nav-search-bar").slideToggle(400, function () {
        n(this).toggleClass("is-active").removeAttr("style");
        n(".b-nav-search-bar-input").focus();
      });
    });
    n(".js-profiles-toggle").on("click", function (t) {
      t.preventDefault();
      const r = 400,
        u = n(this).closest(".js-profiles"),
        i = n(this).closest(".js-profiles-item"),
        f = i.find(".js-profiles-control"),
        e = i.find(".js-profiles-bio");
      u.find(".js-profiles-item.is-active")
        .not(i)
        .each(function () {
          n(this)
            .find(".js-profiles-control")
            .removeClass("e-control-accordion-close");
          n(this).find(".js-profiles-bio").slideUp(r);
          n(this).removeClass("is-active");
        });
      f.toggleClass("e-control-accordion-close");
      e.slideToggle(r);
      i.toggleClass("is-active");
    });
    n(".js-profiles-close").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-profiles-item");
      i.find(".js-profiles-toggle").click();
    });
    n("body").on("click", function (t) {
      n(t.target).closest(".js-select").length == 0 &&
        n(".js-select.is-active").length &&
        n(".js-select.is-active").each(function () {
          closeSelect(n(this));
        });
    });
    n(".js-select-selected").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-select"),
        r = i.find(".js-select-dropdown");
      n(".js-select.is-active")
        .not(i)
        .each(function () {
          closeSelect(n(this));
        });
    ...
    n(".js-select:not(.js-select-multi) .js-select-option").on(
      "click",
      function (t) {
        t.preventDefault();
        const r = n(this),
          i = n(this).closest(".js-select");
        i.find(".js-select-option.is-active").not(r).removeClass("is-active");
        r.toggleClass("is-active");
        updateSelectValue(i);
        closeSelect(i);
      },
    );
    n(".js-select.js-select-multi .js-select-option").on("click", function (t) {
      t.preventDefault();
      const i = n(this),
        r = n(this).closest(".js-select");
      i.toggleClass("is-active");
      updateSelectValue(r);
    });
    n(".js-people-view-grid").on("click", function (t) {
      t.preventDefault();
      n(this).siblings().removeClass("is-active");
      n(this).addClass("is-active");
      n(this).closest(".js-people").removeClass("b-people-list");
    });
    n(".js-people-view-list").on("click", function (t) {
      t.preventDefault();
      n(this).siblings().removeClass("is-active");
      n(this).addClass("is-active");
      n(this).closest(".js-people").addClass("b-people-list");
    });
    n(".js-tabs-accordion-btn").on("click", function () {
      const i = n(this).closest(".js-tabs"),
        r = i.find(".js-tabs-btn"),
        u = i.find(".js-tabs-accordion-item"),
        f = n(this).closest(".js-tabs-accordion-item").index(),
        t = r.eq(f),
        e = u.eq(f);
      t.hasClass("is-active") ||
        ...
        t.addClass("is-active"),
        u.not(e).each(function () {
          n(this).removeClass("is-active");
        }),
        e.addClass("is-active"));
    });
    n(".js-tabs-btn").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-tabs"),
        r = i.find(".js-tabs-accordion-item"),
        u = n(this).index();
      r.eq(u).find(".js-tabs-accordion-btn").click();
    });
    n(".js-results-preview").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-results-preview-item");
      if (!i.hasClass("is-active")) {
        const o = i.find(".js-results-preview-embed").html(),
          f = n(this).closest(".js-results"),
          r = f.find(".js-results-playing"),
          s = f.find(".js-results-preview-item");
        ...
        r.addClass("is-active");
        r.html(o);
        const e = r.find("iframe");
        let u = e.attr("src");
        u += u.indexOf("?") != -1 ? "&autoplay=1   " : "?autoplay=1";
        e.attr("src", u);
      }
    });
    n(".js-results-play").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-results");
      i.find(".js-results-preview").eq(0).click();
    });
    n(".js-divisions-item-toggle").on("click", function (t) {
      t.preventDefault();
      divisionsToggle(n(this));
    });
    n(".js-framework-item-toggle").on("click", function (t) {
      t.preventDefault();
      const f = n(this).closest(".js-framework"),
        e = f.find(".js-framework-item.is-active"),
        i = n(this).closest(".js-framework-item"),
        o = i.find(".js-framework-item-content"),
        s = i.find(".js-framework-accordion-btn"),
        r = "e-control-accordion-close",
        u = 400;
      e.not(i).each(function () {
        const t = n(this),
          i = t.find(".js-framework-item-content"),
          f = t.find(".js-framework-accordion-btn");
        f.removeClass(r);
        i.slideUp(u, function () {
          n(this).removeAttr("style");
          t.removeClass("is-active");
        });
      });
      s.toggleClass(r);
      o.slideToggle(u, function () {
        n(this).removeAttr("style");
        i.toggleClass("is-active");
      });
    });
    n(".js-framework-prev").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-framework"),
        u = i.find(".js-framework-item"),
        f = u.length - 1,
        r = i.find(".js-framework-item.is-active").data("framework-index"),
        e = r === 0 ? f : r - 1;
      cycleFramework(i, e);
    });
    n(".js-framework-next").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-framework"),
        u = i.find(".js-framework-item"),
        f = u.length - 1,
    ...
    n(".js-framework-diamond-interact").on("click", function (t) {
      if ((t.preventDefault(), !(n(window).outerWidth() < BREAKPOINT_MD))) {
        const u = n(this).closest(".js-framework"),
          i = u.find(".js-framework-info"),
          r = n(this).closest(".js-framework-diamond"),
          f = u.find(".js-framework-diamond.is-active"),
          e = 400;
        if (
          (f.not(r).each(function () {
            const t = n(this).data("framework-item"),
              i = n('.js-framework-item[data-framework-diamond="' + t + '"]');
            n(this).removeClass("is-active");
            i.removeClass("is-active");
          }),
          f.length ||
          ...
          i.fadeOut(e, function () {
            i.removeAttr("style").removeClass("is-active");
          });
        else {
          const t = r.data("framework-item"),
            i = n('.js-framework-item[data-framework-diamond="' + t + '"]'),
            f = i.data("framework-index");
          cycleFramework(u, f);
        }
        r.toggleClass("is-active");
      }
    });
    n(".js-framework-close").on("click", function (t) {
      t.preventDefault();
      n(this)
        .closest(".js-framework")
        .find(".js-framework-diamond.is-active")
        .each(function () {
          n(this).removeClass("is-active");
        });
      n(this)
        .closest(".js-framework-info")
        .fadeOut(400, function () {
          n(this).removeAttr("style").removeClass("is-active");
        });
    });
    n(".js-framework-option").on("click", function (t) {
      t.preventDefault();
      const i = n(this),
        r = i.closest(".js-framework");
      if (!i.hasClass("is-active")) {
        const f = i.data("framework-intro"),
          u = n(
            '.js-framework-intro-option[data-framework-intro-option="' +
              f +
              '"]',
          );
        r.find(".js-framework-option.is-active")
          .not(i)
          .each(function () {
            n(this).removeClass("is-active");
          });
        r.find(".js-framework-intro-option.is-active")
          .not(u)
          .each(function () {
            n(this).removeClass("is-active");
          });
    ...
    n(".js-value-engine-toggle").on("click", function (t) {
      t.preventDefault();
      const i = n(this);
      valueEngineClickEvents(i);
    });
    n(".js-value-engine-reveal-close").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-value-engine");
      i.find(".is-active").removeClass("is-active");
      i.find(".is-hidden").removeClass("is-hidden");
    });
    n(".js-val-eng-toggle").on("click", function (t) {
      t.preventDefault();
      const i = n(this),
        f = i.closest(".js-val-eng"),
        r = i.closest(".js-val-eng-item"),
        e = f.find(".js-val-eng-item.is-active"),
        o = r.find(".js-val-eng-content"),
        u = 400;
      e.not(r).each(function () {
        const t = n(this);
        t.find(".js-val-eng-toggle").removeClass("is-active");
        t.find(".js-val-eng-content").slideUp(u, function () {
          n(this).removeAttr("style");
          t.removeClass("is-active");
        });
      });
    ...
    n(".js-language").on("click", function (t) {
      t.preventDefault();
      n(this).toggleClass("is-active");
      n(this).next(".js-language-menu").slideToggle(400);
    });
    n(".js-copy-url").on("click", function (t) {
      t.preventDefault();
      ...
      document.addEventListener(
        "copy",
        function (n) {
          n.clipboardData.setData("text/plain", r);
          n.preventDefault();
        },
        !0,
      );
      ...
      i.fadeIn(200, function () {
        i.delay(500).fadeOut(200);
      });
    });
    n(".js-jobs-language-select").on("click", function (t) {
      t.preventDefault();
      const i = n(this).closest(".js-jobs-language");
      i.toggleClass("is-active");
      i.find(".js-jobs-language-menu").slideToggle(400);
    });
    n(".accordion-collapse").length &&
      n(".accordion-collapse").each(function () {
        const i = n(this).closest(".accordion-item"),
          t = n(this).get(0);
        t.addEventListener("show.bs.collapse", () => {
          SHOW_NAV = !1;
        });
        t.addEventListener("shown.bs.collapse", () => {
          scrollToTopPos(i.offset().top, 0);
        });
      });
    n(".js-signpost-item")
      .on("mouseenter", function () {
      ...
      .on("mouseleave", function () {
        const t = n(this);
        animateSignpostOut(t);
      });
    n(".js-featured-grid-item")
      .on("mouseenter", function () {
        const t = n(this);
        animateFeaturedGridIn(t);
      })
      .on("mouseleave", function () {
        const t = n(this);
        animateFeaturedGridOut(t);
      });
    n(".js-in-page-nav").length && inPageNavMouseEvents();
    n(".js-nav").length && navMouseEvents();
    n(".js-behaviours-interact")
      .on("mouseenter", function () {
        const t = n(this).closest(".js-behaviours-petal"),
          i = t.index(),
          r = n(this).closest(".js-behaviours");
        t.addClass("is-active");
        r.find(".js-behaviours-item").eq(i).addClass("is-active");
      })
      .on("mouseleave", function () {
        const t = n(this).closest(".js-behaviours-petal"),
          i = t.index(),
          r = n(this).closest(".js-behaviours");
        t.removeClass("is-active");
        r.find(".js-behaviours-item").eq(i).removeClass("is-active");
      });
    if (n(".js-intersection-in-page-nav").length) {
      const t = n(".js-intersection-in-page-nav"),
        i = t.length - 1;
      function r(n) {
        for (const r of n)
          r.target == t[0] && r.boundingClientRect.top > 0 && resetPageNav(),
            r.target == t[i] && r.boundingClientRect.top <= 0 && resetPageNav(),
            r.isIntersecting && updateActivePageNav(r.target.id);
      }
      ...
      for (let n = 0; n < t.length; n++) u.observe(t[n]);
    }
    if (n(".js-copy-table-to-clipboard").length)
      n(".js-copy-table-to-clipboard").on("click", function (t) {
        t.preventDefault();
        n(this).parent().find("table").select();
        navigator.clipboard.writeText(
          n(this).parent().find(".table-responsive").html(),
        );
        alert(
          "Copied to clipboard.\r\nYou can now paste into a spreadsheet for further analysis.",
        );
      });
  });
  n(window).on("resize", function () {
    n(".js-nav").length && (navCleanseMob(), navCleanseDesk());
    n(window).outerWidth() >= BREAKPOINT_XL &&
      n(".js-animated-accordion-list.is-open") &&
      n(".js-animated-accordion-list.is-open").each(function () {
        n(this).removeClass("is-open");
        n(this).find(".is-open").removeClass("is-open");
        n(this).find("[style]").removeAttr("style");
        n(this).find(".mod").removeClass("mod");
      });
    n(".js-radial-random-container").length &&
      n(".m-radial-random").length &&
      radials(!0);
    n(".js-signpost-item").length &&
      n(window).outerWidth() >= BREAKPOINT_XL &&
      n(".js-signpost-item").each(function () {
    ...
    n(".js-slick-case-study").length &&
      n(".js-slick-case-study").each(function () {
        const t = n(this);
        t.find(".b-case-study-item").css("opacity", "1");
        t.slick("setPosition");
        adjustBoxHeights(t);
      });
  });
  n(window).on("scroll", function () {
    if (
      (n(".js-nav").length && (navScroll(), navBackground()),
      n(".js-in-page-nav").length)
    ) {
      const t = n(window).scrollTop();
      t > 0 && t > LAST_SCROLL_TOP_INPAGENAV
        ? n(".js-in-page-nav").offset().top < t &&
          !n(".js-in-page-nav").hasClass("is-floating") &&
          n(".js-in-page-nav").addClass("is-floating")
        : n(".js-in-page-nav").offset().top >= t &&
          n(".js-in-page-nav").hasClass("is-floating") &&
          n(".js-in-page-nav").removeClass("is-floating");
      LAST_SCROLL_TOP_INPAGENAV = t;
    }
  });
  n(window).on("load", function () {
    if (n(".js-intersection-fade-group").length) {
      ...
      function i(n) {
        for (const t of n) {
          const n = t.target.classList.contains("is-inview");
          if (n) return;
          (t.isIntersecting || t.boundingClientRect.top <= 0) &&
            (t.target.classList.add("is-inview"), executeGroupFade(t.target));
        }
      }
      ...
      for (let n = 0; n < t.length; n++) r.observe(t[n]);
    }
    n(".js-radial-random-container").length && radials(!1);
    n(".m-spacing").length && notches();
  });
})(jQuery);
ajaxSearchProgress = null;
(ajaxSearchAutocompleteProgress = null),
  (function (n) {
    n(document).ready(function () {
      accessibilityFixes();
      ajaxFiltersInit(n(".js-people"), "/umbraco/surface/people/getitems");
      ajaxFiltersInit(n(".js-news"), "/umbraco/surface/news/getitems");
      ajaxFiltersInit(
        n(".js-yottaleadersblog"),
        "/umbraco/surface/yottaleadersblog/getitems",
      );
      ajaxFiltersInit(
        n(".js-engineeringexplained"),
        "/umbraco/surface/engineeringexplained/getitems",
      );
      ajaxFiltersInit(n(".js-insights"), "/umbraco/surface/insights/getitems");
      ajaxFiltersInit(n(".js-results"), "/umbraco/surface/results/getitems");
      ajaxFiltersInit(
        n(".js-job-search"),
        "/umbraco/surface/jobsearch/getitems",
      );
      n(".js-filters-back").on("click", function (n) {
        n.preventDefault();
        history.back();
      });
      n(".js-search-result-filters").on("click", "a", function (t) {
        (t.preventDefault(), n(this).hasClass("is-active")) ||
          (n(this).siblings().removeClass("is-active"),
          n(this).addClass("is-active"),
          ajaxSearch(!1, !0));
      });
      n(".js-search-search").on("submit", function (n) {
        n.preventDefault();
        ajaxSearch(!1, !0);
      });
      n(".js-search .js-search-result-load").on("click", function (n) {
        n.preventDefault();
        ajaxSearch(!0, !1);
      });
      if (n(".js-events-item").length)
        n(".js-events-item").on("click", function (t) {
          t.preventDefault();
          var i =
            slugify(n(this).closest("tr").find("td:eq(1)").text()) + ".ics";
          n.ajax({
            url: "/umbraco/api/events/generateicsfile",
            type: "POST",
            data: { id: n(this).data("id") },
            success: function (t) {
              var r = n("<a />");
              r.attr("download", i);
              r.attr("href", "data:text/calendar;base64," + t);
              n("body").append(r);
              r[0].click();
              r[0].remove();
            },
