      ...
      h = function (e, t, n) {
        ...
        (b.initialize = function () {
          ...
          (b.requireWidget = function (e) {
            "string" != typeof e &&
              b.logError("Widget Public ID required and should be a string", {
                pid: e,
              }),
          ...
          (b.getWidgetIdByElement = function (e) {
            return "div" === e.tagName.toLowerCase()
              ? b.getEappsClass(e).replace("elfsight-app-", "")
          ...
          (b.resetWidget = function (e) {
            ...
            b.getWidgetsElements().forEach(function (n) {
              b.getWidgetIdByElement(n) === e &&
                (delete v[e], n.parentNode.replaceChild(t(e), n));
            });
          }),
            ...
            if (
              ...
              o.open("get", a + "?" + s),
                ...
                (o.onload = function () {
                  ...
                  t.status ||
                    b.logError("Boot failed because " + t.reason, t.data),
      ...
      c = function () {
        ...
        (e.initialize = function () {
          ...
          (e.sendExtensionPostMessage = function (e, t) {
            ...
            window.postMessage(
              { method: "postMessagePlatformWidget", data: n },
              "*",
            );
          }),
          e.initialize();
            ...
            if (i) {
              ...
              var a = {
                  ...
                  displayFreeLinkRemove:
                    !!o.preferences.display_free_link_remove,
                  freeLinkURL: o.preferences.free_link_url,
