...
(() => {
  function i(e, t) {
    ...
    if (void 0 !== window.aspnetValidation) {
      var a = new aspnetValidation.ValidationService(),
        o = function (e, t) {
          if (
            "checkbox" !== t.type.toLowerCase() &&
            "radio" !== t.type.toLowerCase()
          )
            return Boolean(e);
          for (
            var r = t.form.querySelectorAll("input[name='" + t.name + "']"),
              n = 0;
            n < r.length;
            n++
          )
      ...
      for (var d = 0; d < s.length; d++)
        (s[d].form.elements.PreviousClicked.value = ""),
          s[d].addEventListener("click", l, !1);
      r = f();
  ...
  function c(e, t) {
    for (
      var r,
        ...
        o,
        i,
        a = t ? e.form : JSON.parse(decodeURI(e.form)),
        l = document.querySelectorAll(".umbraco-forms-form"),
        s = 0;
      s < l.length;
      s++
    ) {
      ...
      a.disableValidationDependencyCheck ||
        ((r = d),
        (i = o = n = void 0),
        "undefined" != typeof Umbraco && void 0 !== Umbraco.Sys) ||
        ...
        ((i = !1) ===
          (i =
            (window.jQuery && $ && void 0 !== $.validator) ||
        ...
        new h(
          ...
          a.fieldConditions,
          a.triggerConditionsCheckOn && 0 < a.triggerConditionsCheckOn.length
            ? a.triggerConditionsCheckOn
            : "change",
          a.recordValues,
              ...
              for (var t = 0; t < e.length; t++) {
                ...
                if ("field-validation-error" === r.target.className) {
                  ...
                  for (var n = r.target, o = n.previousElementSibling; o; ) {
                    ...
                    if (
                      o.classList.contains("radiobuttonlist") ||
                      o.classList.contains("checkboxlist")
                    ) {
    ...
    for (var o = !0, i = 0; i < t.length; i++) {
      ...
      if (!l.rule.match(/{({*[\w]*}*)}/)) {
        ...
        ((e, t, r, n, o) => {
          var i, a;
          o.fieldId &&
            ((i = e[o.fieldId]).length &&
              0 < i.length &&
              (i = Array.from(i).filter((e) => e.id === o.fieldId)[0]),
            "aspnet-client-validation" === t
              ...
              : "jquery" === t &&
                ...
                (n
                  ? ((a = d(i, "error")) &&
                      a.innerText === o.errorMessage &&
                      (a.classList.remove("field-validation-error"),
                      a.classList.add("field-validation-valid"),
                      (a.innerText = "")),
                    u)
                  : ((a = d(i, "valid")) &&
                    ...
                    (e, t) => {
                      u(e, t),
                        e &&
                          ((t = document.createElement("li")).appendChild(
  ...
  function d(e, t) {
    return e
      ...
      .querySelector(".field-validation-" + t);
  }
  function u(e, t) {
    e &&
  ...
  function g(e) {
    for (
      var t = e.getElementsByClassName("field-validation-error"), r = 0;
      r < t.length;
      r++
    )
      t[r].className = "field-validation-valid";
  }
  function h(e, t, r, n, o, i, a) {
    ...
    function l(e, t, r) {
      ...
      for (let e = 0; e < n.length; e++) {
        var o = n[e];
        (t[o.getAttribute("id")] = o.value),
          (r[o.getAttribute("id")] = "select");
      }
      var i = e.querySelectorAll("textarea");
      for (let e = 0; e < i.length; e++) {
        var a = i[e];
        (t[a.getAttribute("id")] = a.value),
          (r[a.getAttribute("id")] = "textarea");
      }
      function l(e) {
        return (e = e.getAttribute("id").split("_"))
          .slice(0, e.length - 1)
          .join("_");
      }
      ...
      for (let e = 0; e < s.length; e++) {
        var d,
          u = s[e];
        u.getAttribute("id") !==
        p.formElementHtmlIdPrefix + u.getAttribute("name")
          ? ((t[(d = l(u))] = null), (r[d] = "checkbox"))
          : ((t[u.getAttribute("id")] = null),
            (r[u.getAttribute("id")] = "checkbox"));
      }
      ...
      for (let e = 0; e < c.length; e++) {
        ...
        ("text" !== m.getAttribute("type") &&
          ...
          ((t[m.getAttribute("id")] = m.value),
          (r[m.getAttribute("id")] = "text")),
          "radio" === m.getAttribute("type") &&
            m.matches(":checked") &&
            ((t[(f = l(m))] = m.value), (r[f] = "radio")),
          "checkbox" === m.getAttribute("type") &&
            (m.getAttribute("id") !==
            p.formElementHtmlIdPrefix + m.getAttribute("name")
              ? ((f = l(m)),
                m.matches(":checked") &&
                  (null === t[f] ? (t[f] = m.value) : (t[f] += ";;" + m.value)))
              : (t[m.getAttribute("id")] = m.matches(":checked")
                  ? "true"
                  : "false"));
      }
    }
      ...
      (p.operators = {
        Is: function (e, t) {
          ...
          "TRUE" === t.toUpperCase() || "ON" === t.toUpperCase()
            ? (t = "true")
            : ("FALSE" !== t.toUpperCase() && "OFF" !== t.toUpperCase()) ||
              (t = "false");
        ...
        IsNot: function (e, t, r) {
          ...
          return null == e
            ? t != e
            : ((o = (n = (e = "true;;false" === e ? "true" : e).split(
                ";;",
              )).filter(function (e) {
                return e === t;
              })),
      ...
      (p.run = function () {
        ...
        function d(e) {
          var t,
            r = !0;
          return (
            !!(r = p.fieldConditions[e.field]
              ? u(e.field, p.fieldConditions[e.field])
              : r) &&
            ((e = p.values[p.formElementHtmlIdPrefix + (r = e).field]),
            (t = p.operators[r.operator]),
            null !== e) &&
            t(e, r.value)
          );
        }
                ...
                ? ((i[e] = r),
                  (i[e] = ((e, t) => {
                    ...
                    for (
                      n = 0;
                      n < t.rules.length &&
                      ((s = !!a[(r = t.rules[n]).fieldsetId] && d(t.rules[n])),
                      !o || !s) &&
                      (!i || s);
                      n++
                    );
        ...
        function l(e, t, r) {
          ...
          e &&
            (t
              ? e.classList.remove("umbraco-forms-hidden")
              : e.classList.add("umbraco-forms-hidden"));
        }
        ...
        for (r in p.fieldsetConditions)
          Object.prototype.hasOwnProperty.call(p.fieldsetConditions, r) &&
            ((t = p.formElementHtmlIdPrefix + r),
            l(document.getElementById(t), r, p.fieldsetConditions[r]));
        for (n in p.fieldConditions)
          Object.prototype.hasOwnProperty.call(p.fieldConditions, n) &&
            ...
            l(
              document.getElementById(t).closest(".umbraco-forms-field"),
              n,
              p.fieldConditions[n],
            );
      }),
  ...
  Element.prototype.matches ||
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      if (0 < e.length) {
          ...
          var n = e[r],
            n = {
              ...
              pageButtonConditions: JSON.parse(
                n.dataset.serializedPageButtonConditions,
              ),
              fieldSetConditions: JSON.parse(
                n.dataset.serializedFieldsetConditions,
              ),
              ...
              disableValidationDependencyCheck:
                "true" === n.dataset.disableValidationDependencyCheck,
              recordValues: JSON.parse(n.dataset.serializedFieldsNotDisplayed),
              formElementHtmlIdPrefix: n.dataset.formElementHtmlIdPrefix,
              validationRules: n.dataset.serializedValidationRules
                ? JSON.parse(n.dataset.serializedValidationRules)
                : [],
            };
          t.push(n);
        }
        ...
        "undefined" == typeof umbracoFormsCollection
          ? document.addEventListener("umbracoFormLoaded", c)
          : i(umbracoFormsCollection);
