  ...
  "object" == typeof exports && "object" == typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : "object" == typeof exports
        ? (exports.aspnetValidation = t())
        : (e.aspnetValidation = t());
})(self, () =>
  (() => {
    "use strict";
    var e = {
    ...
    function l(e, t) {
      var n = e.name,
        ...
        i = n.lastIndexOf(".");
      if (i > -1) {
        var s = n.substring(0, i) + "." + r,
          l = document.getElementsByName(s)[0];
        if (a(l)) return l;
      }
      return e.form.querySelector(o("[name=".concat(r, "]")));
    }
    var u = function () {
        (this.required = function (e, t, n) {
          var r = t.type.toLowerCase();
          if ("checkbox" === r || "radio" === r) {
            for (
              var i = 0,
                a = Array.from(
                  t.form.querySelectorAll(
                    o("[name='".concat(t.name, "'][type='").concat(r, "']")),
                  ),
                );
              i < a.length;
              i++
              ...
              var s = a[i];
              if (s instanceof HTMLInputElement && !0 === s.checked) return !0;
            }
            if ("checkbox" === r) {
              var l = t.form.querySelector(
                "input[name='".concat(t.name, "'][type='hidden']"),
              );
              if (l instanceof HTMLInputElement && "false" === l.value)
                return !0;
            }
            return !1;
          }
          return Boolean(null == e ? void 0 : e.trim());
        }),
          (this.stringLength = function (e, t, n) {
            if (!e) return !0;
            if (n.min) {
              var r = parseInt(n.min);
              if (e.length < r) return !1;
            }
            if (n.max) {
              var i = parseInt(n.max);
          ...
          (this.range = function (e, t, n) {
            if (!e) return !0;
            var r = parseFloat(e);
            return !(
              isNaN(r) ||
              (n.min && r < parseFloat(n.min)) ||
              (n.max && r > parseFloat(n.max))
            );
          }),
          (this.regex = function (e, t, n) {
            return !e || !n.pattern || new RegExp(n.pattern).test(e);
          }),
          (this.email = function (e, t, n) {
            return (
              !e ||
          ...
          (this.creditcard = function (e, t, n) {
            if (!e) return !0;
          ...
          (this.phone = function (e, t, n) {
            return (
              !e || (!/[\+\-\s][\-\s]/g.test(e) && /^\+?[0-9\-\s]+$/.test(e))
            );
          }),
          (this.remote = function (e, t, n) {
            if (!e) return !0;
            for (
              var r = n.additionalfields.split(","), i = {}, a = 0, s = r;
              a < s.length;
              a++
            ) {
              var o = s[a],
              ...
              Boolean(d && d.value) &&
                ...
                ("checkbox" === d.type || "radio" === d.type)
                  ? (i[u] = d.checked ? d.value : "")
                  : (i[u] = d.value));
            }
            var c = n.url,
              f = [];
            for (var u in i) {
              var h = encodeURIComponent(u) + "=" + encodeURIComponent(i[u]);
              f.push(h);
            }
            var m = f.join("&");
            return new Promise(function (e, t) {
              var r = new XMLHttpRequest();
              if (n.type && "post" === n.type.toLowerCase()) {
                var a = new FormData();
                for (var s in i) a.append(s, i[s]);
                r.open("post", c),
                  r.setRequestHeader(
                    "Content-Type",
      ...
      d = (function () {
        function e(e) {
          ...
          (this.providers = {}),
            ...
            (this.summary = {}),
            (this.debounce = 300),
            (this.allowHiddenFields = !1),
            (this.validateForm = function (e, i) {
                  ...
                  switch (r.label) {
                    case 0:
                      if (!(e instanceof HTMLFormElement))
                        throw new Error(
                          "validateForm() can only be called on <form> elements",
                        );
                      return (
                        (t = this.getElementUID(e)),
                        (n = this.formEvents[t]),
                        (a = !n) ? [3, 2] : [4, n(void 0, i)]
                      );
                    case 1:
                      (a = r.sent()), (r.label = 2);
                    case 2:
            ...
            (this.validateField = function (e, i) {
              return n(t, void 0, void 0, function () {
                var t, n, a;
                return r(this, function (r) {
                  switch (r.label) {
            ...
            (this.handleValidated = function (e, n, r) {
              if (!(e instanceof HTMLFormElement))
                throw new Error(
                  "handleValidated() can only be called on <form> elements",
                );
              n ? r && t.submitValidForm(e, r) : t.focusFirstInvalid(e);
            }),
            (this.submitValidForm = function (e, t) {
              if (!(e instanceof HTMLFormElement))
                throw new Error(
                  "submitValidForm() can only be called on <form> elements",
                );
              var n = new SubmitEvent("submit", t);
              if (e.dispatchEvent(n)) {
                ...
                if (r) {
                  ...
                  s &&
                    ...
                    (i.name = s),
                    (i.value = r.getAttribute("value")),
                    e.appendChild(i));
                  var o = r.getAttribute("formaction");
                  o && (e.action = o);
                }
                try {
                  e.submit();
                } finally {
                  i && e.removeChild(i), (e.action = a);
                }
              }
            }),
            (this.focusFirstInvalid = function (e) {
              if (!(e instanceof HTMLFormElement))
                throw new Error(
                  "focusFirstInvalid() can only be called on <form> elements",
                );
              var n = t.getElementUID(e),
                r = t.formInputs[n],
                i =
                  null == r
                    ? void 0
              ...
              if (i) {
                var a = t.elementByUID[i];
                a instanceof HTMLElement && a.focus();
              }
            }),
            (this.isValid = function (e, n, r) {
              if ((void 0 === n && (n = !0), !(e instanceof HTMLFormElement)))
                throw new Error(
                  "isValid() can only be called on <form> elements",
                );
              n && t.validateForm(e, r);
              var i = t.getElementUID(e),
                a = t.formInputs[i];
              return !(
                !0 ===
                (null == a
            ...
            (this.isFieldValid = function (e, n, r) {
              void 0 === n && (n = !0), n && t.validateField(e, r);
              var i = t.getElementUID(e);
              return void 0 === t.summary[i];
            }),
            (this.options = {
              root: document.body,
              watch: !1,
        ...
        return (
          (e.prototype.addProvider = function (e, t) {
            this.providers[e] ||
              (this.logger.log("Registered provider: %s", e),
              (this.providers[e] = t));
          }),
          (e.prototype.addMvcProviders = function () {
            var e = new u();
            this.addProvider("required", e.required),
              this.addProvider("length", e.stringLength),
              this.addProvider("maxlength", e.stringLength),
              this.addProvider("minlength", e.stringLength),
              this.addProvider("equalto", e.compare),
              this.addProvider("range", e.range),
              this.addProvider("regex", e.regex),
              this.addProvider("creditcard", e.creditcard),
              this.addProvider("email", e.email),
              this.addProvider("url", e.url),
              this.addProvider("phone", e.phone),
              this.addProvider("remote", e.remote);
          }),
          (e.prototype.scanMessages = function (e, t) {
            for (
              var n = 0, r = Array.from(e.querySelectorAll("span[form]"));
              n < r.length;
              n++
            ) {
              var i = r[n];
              (u = document.getElementById(i.getAttribute("form"))) instanceof
                HTMLFormElement && t.call(this, u, i);
            }
            var a = Array.from(e.querySelectorAll("form"));
            e instanceof HTMLFormElement && a.push(e);
            var s = e instanceof Element ? e.closest("form") : null;
            s && a.push(s);
            for (var o = 0, l = a; o < l.length; o++)
              for (
                var u = l[o],
                  d = 0,
                  c = Array.from(u.querySelectorAll("[data-valmsg-for]"));
                d < c.length;
                d++
              )
                (i = c[d]), t.call(this, u, i);
          }),
          (e.prototype.pushValidationMessageSpan = function (e, t) {
            var n,
              r,
              i,
              a = this.getElementUID(e),
              s =
                null !== (n = (i = this.messageFor)[a]) && void 0 !== n
                  ? n
                  : (i[a] = {}),
              o = t.getAttribute("data-valmsg-for");
            if (o) {
              var l = null !== (r = s[o]) && void 0 !== r ? r : (s[o] = []);
              l.indexOf(t) < 0
                ? l.push(t)
                : this.logger.log(
                    "Validation element for '%s' is already tracked",
                    name,
                    t,
                  );
            }
          }),
          (e.prototype.removeValidationMessageSpan = function (e, t) {
            var n = this.getElementUID(e),
              r = this.messageFor[n];
            if (r) {
              var i = t.getAttribute("data-valmsg-for");
              if (i) {
                var a = r[i];
                if (a) {
                  var s = a.indexOf(t);
                  s >= 0
                    ? a.splice(s, 1)
                    : this.logger.log(
                        "Validation element for '%s' was already removed",
                        name,
                        t,
                      );
                }
          ...
          (e.prototype.parseDirectives = function (e) {
            for (var t = {}, n = {}, r = 0; r < e.length; r++) {
              var i = e[r];
              if (0 === i.name.indexOf("data-val-")) {
                var a = i.name.substr(9);
                n[a] = i.value;
              }
            }
            var s = function (e) {
          ...
          (e.prototype.getElementUID = function (e) {
            var t = this.elementUIDs.filter(function (t) {
              return t.node === e;
            })[0];
            if (t) return t.uid;
            var n = this.guid4();
            return (
              this.elementUIDs.push({ node: e, uid: n }),
              (this.elementByUID[n] = e),
              n
            );
          }),
          (e.prototype.getFormValidationTask = function (e) {
            var t = this.formInputs[e];
            if (!t || 0 === t.length) return Promise.resolve(!0);
          ...
          (e.prototype.getMessageFor = function (e) {
            var t;
            if (e.form) {
              var n = this.getElementUID(e.form);
              return null === (t = this.messageFor[n]) || void 0 === t
                ? void 0
                : t[e.name];
            }
          }),
          ...
          (e.prototype.trackFormInput = function (e, t) {
            var i,
              a,
              s = this,
              o = this.getElementUID(e),
              l =
                null !== (i = (a = this.formInputs)[o]) && void 0 !== i
                  ? i
                  : (a[o] = []);
            if (
              (-1 === l.indexOf(t)
                ? (l.push(t),
                  this.options.addNoValidate
                    ? (this.logger.log("Setting novalidate on form", e),
                      e.setAttribute("novalidate", "novalidate"))
                    : this.logger.log("Not setting novalidate on form", e))
                : this.logger.log(
                    "Form input for UID '%s' is already tracked",
                    t,
                  ),
              !this.formEvents[o])
            ) {
              var u = null,
                d = function (t, i) {
                  return (
                    u ||
                    (s.shouldValidate(t)
                      ? ((u = s.getFormValidationTask(o)),
                        t && s.preValidate(t),
                        s.logger.log("Validating", e),
                        u
                          .then(function (a) {
                          ...
                          .catch(function (e) {
                            return s.logger.log("Validation error", e), !1;
                          })
                          .finally(function () {
                            u = null;
                          }))
              ...
              var c = function (e) {
                for (var t = 0, n = s.formInputs[o]; t < n.length; t++) {
                  var r = n[t];
                  s.resetField(r);
                }
                s.renderSummary();
              };
              e.addEventListener("reset", c),
                (d.remove = function () {
                  e.removeEventListener("submit", d),
                    e.removeEventListener("reset", c);
                }),
                (this.formEvents[o] = d);
            }
          }),
          (e.prototype.reset = function (e) {
            this.isDisabled(e)
              ? this.resetField(this.getElementUID(e))
              : this.scan(e);
          }),
          (e.prototype.resetField = function (e) {
            var t = this.elementByUID[e];
            this.swapClasses(t, "", this.ValidationInputCssClassName),
              this.swapClasses(t, "", this.ValidationInputValidCssClassName);
            var n = a(t) && this.getMessageFor(t);
            if (n)
          ...
          (e.prototype.untrackFormInput = function (e, t) {
            var n,
              r = this.getElementUID(e),
              i = this.formInputs[r];
            if (i) {
              var a = i.indexOf(t);
              a >= 0
                ? (i.splice(a, 1),
                  i.length ||
                    (null === (n = this.formEvents[r]) ||
                      void 0 === n ||
                      n.remove(),
                    delete this.formEvents[r],
                    delete this.formInputs[r],
                    delete this.messageFor[r]))
                : this.logger.log(
                    "Form input for UID '%s' was already removed",
                    t,
                  );
            }
          }),
          (e.prototype.addInput = function (e) {
            var t,
              i = this,
              a = this.getElementUID(e),
              s = this.parseDirectives(e.attributes);
            if (
              ((this.validators[a] = this.createValidator(e, s)),
              e.form && this.trackFormInput(e.form, a),
              !this.inputEvents[a])
            ) {
              var o = function (t, s) {
                  return n(i, void 0, void 0, function () {
                    ...
                    return r(this, function (r) {
                      switch (r.label) {
                        case 0:
                          if (!(n = this.validators[a])) return [2, !0];
                          if (
                            !e.dataset.valEvent &&
                            t &&
                            "input" === t.type &&
                            ...
                            return [2, !0];
                          this.logger.log("Validating", { event: t }),
                            (r.label = 1);
                        case 1:
                          return r.trys.push([1, 3, , 4]), [4, n()];
                        case 2:
                          return (i = r.sent()), s(i), [2, i];
                        case 3:
                          return (
                            (o = r.sent()),
                            this.logger.log("Validation error", o),
                            [2, !1]
                          );
                        case 4:
                          return [2];
              ...
              var u =
                  e instanceof HTMLSelectElement ? "change" : "input change",
                d = (
                  null !== (t = e.dataset.valEvent) && void 0 !== t ? t : u
                ).split(" ");
              d.forEach(function (t) {
                e.addEventListener(t, o.debounced);
              }),
                (o.remove = function () {
                  d.forEach(function (t) {
                    e.removeEventListener(t, o.debounced);
                  });
                }),
                (this.inputEvents[a] = o);
            }
          }),
          (e.prototype.removeInput = function (e) {
            var t = this.getElementUID(e),
              n = this.inputEvents[t];
            (null == n ? void 0 : n.remove) && (n.remove(), delete n.remove),
              delete this.summary[t],
              delete this.inputEvents[t],
              delete this.validators[t],
              e.form && this.untrackFormInput(e.form, t);
          }),
          (e.prototype.scanInputs = function (e, t) {
            var n = Array.from(e.querySelectorAll(o('[data-val="true"]')));
            a(e) && "true" === e.getAttribute("data-val") && n.push(e);
            for (var r = 0; r < n.length; r++) {
              var i = n[r];
              t.call(this, i);
            }
          }),
          (e.prototype.createSummaryDOM = function () {
            if (!Object.keys(this.summary).length) return null;
            var e = [],
              t = document.createElement("ul");
            for (var n in this.summary) {
              var r = this.elementByUID[n];
              if (
                !(
                  (r instanceof HTMLInputElement &&
                    ("checkbox" === r.type || "radio" === r.type) &&
                    r.className === this.ValidationInputValidCssClassName) ||
                  e.indexOf(this.summary[n]) > -1
                )
              ) {
                var i = document.createElement("li");
                (i.innerHTML = this.summary[n]),
                  t.appendChild(i),
                  e.push(this.summary[n]);
              }
            }
            return t;
          }),
          (e.prototype.renderSummary = function () {
            ...
            if (e.length) {
              ...
              if (t !== this.renderedSummaryJSON) {
                this.renderedSummaryJSON = t;
                for (
                  var n = this.createSummaryDOM(), r = 0;
                  r < e.length;
                  r++
                ) {
                  for (
                    var i = e[r], a = i.querySelectorAll("ul"), s = 0;
                    s < a.length;
                    s++
                  )
                    a[s].remove();
          ...
          (e.prototype.removeError = function (e) {
            ...
            if (
              ...
              for (n = 0; n < r.length; n++) {
                ...
                var i = this.getElementUID(r[n]);
                delete this.summary[i];
              }
            }
            this.renderSummary();
          }),
          (e.prototype.createValidator = function (e, t) {
            var i = this;
            return function () {
              return n(i, void 0, void 0, function () {
                var n, i, a, s, o, l, u, d, c, f, h;
                return r(this, function (r) {
                  switch (r.label) {
                    case 0:
                      if (this.isHidden(e) || this.isDisabled(e)) return [3, 7];
                      for (a in ((i = []), (n = t))) i.push(a);
                      (s = 0), (r.label = 1);
                    case 1:
                      return s < i.length
                        ? (a = i[s]) in n
                          ? ((l = t[(o = a)]),
                            (u = this.providers[o])
                              ? (this.logger.log(
                                  "Running %s validator on element",
                                  o,
                                  e,
                                ),
                                (d = u(e.value, e, l.params)),
                                (c = !1),
                                (f = l.error),
                                "boolean" != typeof d
                                  ? [3, 2]
                                  : ((c = d), [3, 5]))
                              : (this.logger.log(
                                  "aspnet-validation provider not implemented: %s",
                                  o,
                                ),
                                [3, 6]))
                          : [3, 6]
                    ...
                    case 3:
                      return [4, d];
                    case 4:
                      "boolean" == typeof (h = r.sent())
                        ? (c = h)
                        : ((c = !1), (f = h)),
                        (r.label = 5);
                    case 5:
                      if (!c) return this.addError(e, f), [2, !1];
                      r.label = 6;
                    case 6:
                      return s++, [3, 1];
                    case 7:
          ...
          (e.prototype.swapClasses = function (e, t, n) {
            !t ||
              this.isDisabled(e) ||
          ...
          (e.prototype.bootstrap = function (e) {
            ...
            var n = window.document,
              r = this.options.root,
              i = function () {
                t.scan(r), t.options.watch && t.watch(r);
              };
          ...
          (e.prototype.scan = function (e) {
            null != e || (e = this.options.root),
              this.logger.log("Scanning", e),
              this.scanMessages(e, this.pushValidationMessageSpan),
              this.scanInputs(e, this.addInput);
          }),
          (e.prototype.remove = function (e) {
            null != e || (e = this.options.root),
              this.logger.log("Removing", e),
              this.scanMessages(e, this.removeValidationMessageSpan),
              this.scanInputs(e, this.removeInput);
          }),
          ...
          (e.prototype.observed = function (e) {
            var t, n, r;
            if ("childList" === e.type) {
              for (var i = 0; i < e.addedNodes.length; i++) {
                var a = e.addedNodes[i];
                this.logger.log("Added node", a),
                  a instanceof HTMLElement && this.scan(a);
              }
              for (i = 0; i < e.removedNodes.length; i++)
                (a = e.removedNodes[i]),
                  this.logger.log("Removed node", a),
                  a instanceof HTMLElement && this.remove(a);
            } else if (
              "attributes" === e.type &&
              ...
              if ("disabled" === e.attributeName) {
                ...
                var o = null !== (t = e.oldValue) && void 0 !== t ? t : "",
                  l =
                    null !==
                      (r =
                        null === (n = e.target.attributes[e.attributeName]) ||
                        void 0 === n
                          ? void 0
                          : n.value) && void 0 !== r
                      ? r
                ...
                this.logger.log(
                  ...
                  o !== l && this.scan(e.target);
              }
          }),
          (e.prototype.highlight = function (e, t, n) {
            this.swapClasses(e, t, n);
          }),
          (e.prototype.unhighlight = function (e, t, n) {
            this.swapClasses(e, n, t);
          }),
          e
        );
      })();
